...
const PAIR_CONFIGS: Record<string, PairConfig> = {
  btcusdt: { basePrice: 69000, volatility: 0.02, trendBias: 0.1, avgVolume: 5000000 },
  ...
  xrpusdt: { basePrice: 0.62, volatility: 0.03, trendBias: -0.02, avgVolume: 600000 },
  adausdt: { basePrice: 0.45, volatility: 0.028, trendBias: 0.01, avgVolume: 400000 },
  dogeusdt: { basePrice: 0.085, volatility: 0.04, trendBias: 0.0, avgVolume: 350000 },
  dotusdt: { basePrice: 7.5, volatility: 0.03, trendBias: -0.03, avgVolume: 300000 },
  maticusdt: { basePrice: 0.92, volatility: 0.032, trendBias: 0.04, avgVolume: 250000 },
  linkusdt: { basePrice: 18.5, volatility: 0.028, trendBias: 0.06, avgVolume: 350000 },
};
 ...
 */
export function generateIntradayData(basePrice: number, volatility: number): CandlestickData[] {
 ...
 */
export function addTrend(data: CandlestickData[], trendPerCandle: number): CandlestickData[] {

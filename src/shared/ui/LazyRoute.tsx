...
/* ═══════════════════════════════════════════════════════════
   ...
   - Offers a fresh lazy instance after automatic retries fail
...
function LazyRouteContent({ load }: LazyRouteProps) {
  const Comp = React.useMemo(() => React.lazy(() => retryImport(load, 3, 800)), [load]);
...
export function LazyRoute({ load }: LazyRouteProps) {

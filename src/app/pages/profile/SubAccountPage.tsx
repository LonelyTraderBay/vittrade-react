      ...
      <PageContent gap="relaxed">
          ...
          <div className="grid grid-cols-3 gap-3 mt-4">
            ...
            <div className="rounded-xl p-2.5" style={{ background: c.portfolioBtnGhost }}>
              ...
              <p style={{ color: '#F59E0B', fontSize: 16, fontWeight: 700 }}>
                {accounts.reduce((s, a) => s + a.apiKeyCount, 0)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          >
            ...
            <span style={{ color: c.primary, fontSize: 14, fontWeight: 600 }}>
          ...
          {accounts.map((account) => {
            ...
            return (
              <TrCard
                key={account.id}
                overflow
                // 'suspended' is not part of the current status union; widen for the (future) dimmed state
                style={{ opacity: (account.status as string) === 'suspended' ? 0.6 : 1 }}
              >
                <button
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    >
                      <span style={{ color: type.color, fontSize: 11, fontWeight: 700 }}>
                    ...
                    <div className="pt-3 mb-3" style={{ borderTop: `1px solid ${c.divider}` }}>
                      ...
                      <div className="grid grid-cols-3 gap-3 mb-3">
                        <div>
                          ...
                          >
                            {fmtCompact(account.tradingVolume30d, { prefix: '$' })}
                          </p>
                        </div>
                        <div>
                      ...
                      <p style={{ color: c.text3, fontSize: 10, marginBottom: 2 }}>
                        Email: <span style={{ color: c.text2 }}>{account.email}</span>
                      </p>
                    </div>
        ...
        >
          ...
          <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
            Mỗi tài khoản phụ có ví và API riêng biệt. Bạn có thể tạo tối đa 20 tài khoản phụ. Tài
            khoản phụ thừa hưởng mức VIP của tài khoản chính.
          </p>
        </div>
      </PageContent>
    </PageLayout>

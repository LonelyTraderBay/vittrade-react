        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            {otherDevices.length > 0 && (
              <button
                onClick={() => otherDevices.forEach((d) => handleRevoke(d.id))}
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            ...
            {isSuspicious && <AlertTriangle size={14} color="#F59E0B" />}
          </div>
      ...
      {showActions && (
        <div className="flex gap-2 mt-3 pt-3" style={{ borderTop: `1px solid ${c.divider}` }}>
          <button
            ...
            style={{
              background: device.isTrusted ? 'rgba(16,185,129,0.1)' : 'rgba(245,158,11,0.1)',
            }}
          >
            {device.isTrusted ? (
            ...
            <span
              style={{
                color: device.isTrusted ? '#10B981' : '#F59E0B',
                fontSize: 12,
                fontWeight: 600,
              }}
            >

    ...
    return (
      ...
      >
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <p style={{ color: c.text1, fontSize: 14, fontWeight: 600 }}>{typeConfig.label}</p>
              <span
            ...
            <p style={{ color: c.text2, fontSize: 12 }}>{log.description}</p>
          </div>
          {log.status === 'suspicious' && <AlertTriangle size={16} color="#F59E0B" />}
        </div>
        ...
        <div className="rounded-xl p-3" style={{ background: 'rgba(255,255,255,0.02)' }}>
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <p style={{ color: c.text1, fontSize: 12, fontWeight: 600 }}>{log.location}</p>
            </div>
            <div>
              <div className="flex items-center gap-1.5 mb-1">
              ...
              <p style={{ color: c.text1, fontSize: 12, fontWeight: 600 }}>{log.device}</p>
            </div>
        ...
        <div className="mt-2 pt-2" style={{ borderTop: `1px solid ${c.divider}` }}>
          <p style={{ color: c.text3, fontSize: 11 }}>{log.timestamp}</p>
        </div>
      </TrCard>
    );
  };
        ...
        <div className="py-4">
          {filteredLogs.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 gap-3">
              ...
              <p style={{ color: c.text3, fontSize: 14 }}>Không có hoạt động nào</p>
            </div>
          ) : (
        ...
        >
          <div className="flex items-start gap-2">
            ...
            <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.4 }}>
              Nhật ký hoạt động giúp bạn theo dõi tất cả thao tác trên tài khoản. Nếu phát hiện hoạt
              động đáng ngờ, vui lòng đổi mật khẩu ngay lập tức.
            </p>
          </div>
        </div>
      </PageContent>

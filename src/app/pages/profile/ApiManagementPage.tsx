  ...
  return (
    <PageLayout>
      ...
      <Header
        ...
        right={
          <button
            onClick={() => navigate(`${prefix}/profile/api/create`)}
          ...
          >
            <div className="flex items-start gap-3 mb-3">
              <div
                ...
                style={{
                  background: apiKey.isActive ? 'rgba(59,130,246,0.15)' : 'rgba(239,68,68,0.1)',
                  border: `1px solid ${apiKey.isActive ? 'rgba(59,130,246,0.2)' : 'rgba(239,68,68,0.2)'}`,
                }}
              >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    ...
                    style={{
                      background: apiKey.isActive ? 'rgba(16,185,129,0.12)' : 'rgba(239,68,68,0.1)',
                      color: apiKey.isActive ? '#10B981' : '#EF4444',
                    }}
                  >
                ...
                <p style={{ color: c.text3, fontSize: 11 }}>
                  Tạo: {apiKey.createdAt}
                  {apiKey.expiresAt ? ` • Hết hạn: ${apiKey.expiresAt}` : ' • Không hết hạn'}
                </p>
              </div>
            ...
            <div
              ...
              style={{ background: c.surface2, border: '1px solid rgba(239,68,68,0.1)' }}
            >

      ...
      <PageContent>
        <TrCard className="p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <span style={{ color: scoreColor, fontSize: 14, fontWeight: 700 }}>
              {scoreLabel} ({securityScore}/4)
            </span>
          </div>
          <div className="flex gap-2 mb-3">
            {[0, 1, 2, 3].map((i) => (
              <div
                ...
                style={{ background: i < securityScore ? scoreColor : c.borderSolid }}
              />
            ))}
          </div>
          {securityScore < 4 && (
        ...
        <TrCard overflow>
          <SecurityItem
            ...
            status={has2FA ? 'Đang bật' : 'Tắt'}
            statusColor={has2FA ? '#10B981' : '#EF4444'}
            action={() => navigate(`${prefix}/auth/2fa-setup`)}
          />
          <div style={{ borderTop: `1px solid ${c.divider}` }}>
            <SecurityItem
              ...
              action={() => navigate(`${prefix}/auth/forgot-password`)}
            />
          </div>
          <div style={{ borderTop: `1px solid ${c.divider}` }}>
            <SecurityItem
              ...
              description="Chỉ rút đến địa chỉ đã xác minh"
              status="Chưa cài đặt"
              statusColor="#F59E0B"
              action={() => {}}
            />
          ...
          <div style={{ borderTop: `1px solid ${c.divider}` }}>
            <SecurityItem
              ...
              description={`${DEVICES.length} thiết bị đang hoạt động`}
          ...
          <div style={{ borderTop: `1px solid ${c.divider}` }}>
            <SecurityItem
              ...
              description="Xem lịch sử đăng nhập & thao tác"
              action={() => navigate(`${prefix}/profile/activity`)}
            />
          </div>
        </TrCard>
        ...
        {showDevices && (
          <div>
            ...
            <button
              className="w-full mt-2 h-12 rounded-2xl flex items-center justify-center text-sm font-semibold"
              style={{
        ...
        <TrCard className="p-4">
          ...
          <p style={{ color: c.text2, fontSize: 12, marginBottom: 12, lineHeight: 1.6 }}>

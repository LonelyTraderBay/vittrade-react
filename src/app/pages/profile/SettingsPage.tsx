    ...
    <PageLayout>
      ...
      <PageContent gap="relaxed">
        ...
        <div>
          ...
          <TrCard overflow>
            <div
              className="flex items-center gap-4 px-4 py-4 transition-colors duration-150 cursor-pointer"
                ...
                <div className="flex gap-2 mt-2">
                  {CURRENCIES.map((curr) => (
                    <button
                      ...
                      style={{
                        background: currency === curr ? '#3B82F6' : c.surface2,
                        color: currency === curr ? '#fff' : c.text2,
                      }}
                    >
                      {curr}
                    </button>
        ...
        <div>
          ...
          <TrCard overflow>
            ...
            <div
              className="flex items-center gap-3 px-5 py-4 active:opacity-70"
              style={{ borderBottom: `1px solid ${c.divider}` }}
            >
              <div className="flex-1">
        ...
        <div>
          ...
          <TrCard overflow>
            {[
              ...
              <div
                key={notif.key}
                className="flex items-center gap-4 px-4 py-3.5 transition-colors duration-150 cursor-pointer"
        ...
        <TrCard className="p-4">
          ...
          {[
            ...
            <div
              key={row.label}
              className="flex justify-between items-center py-2 px-1 -mx-1 rounded-lg transition-colors duration-150"
            >

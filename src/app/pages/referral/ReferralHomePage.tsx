  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-0.5">
              <p style={{ color: '#FED7AA', fontSize: φ.body, fontWeight: 700 }}>
        ...
        <div
          className="relative z-10 flex items-center gap-2 rounded-lg mt-3"
          style={{
            padding: '6px 10px',
...
function SocialProofRow({ c }: { c: ReturnType<typeof useThemeColors> }) {
  const items = [
    {
      value: (REFERRAL_SOCIAL_PROOF.totalReferrers / 1000).toFixed(1) + 'K+',
      label: 'Người giới thiệu',
      IconComp: Users,
      color: '#3B82F6',
    },
    {
      value: '$' + (REFERRAL_SOCIAL_PROOF.totalEarnedAll / 1_000_000).toFixed(1) + 'M+',
      label: 'Tổng đã trả',
      IconComp: Gift,
      color: '#10B981',
    },
    {
      value: REFERRAL_SOCIAL_PROOF.successRate + '%',
      label: 'Tỷ lệ KYC',
      IconComp: UserCheck,
      color: '#8B5CF6',
    },
    {
      value: '$' + REFERRAL_SOCIAL_PROOF.avgMonthlyEarning,
      label: 'TB/tháng',
      IconComp: TrendingUp,
      color: '#F59E0B',
    },
    ...
    <div className="flex gap-2 -mx-5 px-5 overflow-x-auto" style={{ scrollbarWidth: 'none' }}>
      {items.map((s) => (
        ...
        >
          ...
          <div>
            <p style={{ color: s.color, fontSize: φ.sm, fontWeight: 700, fontFamily: 'monospace' }}>
              {s.value}
            </p>
...
function MilestoneRow({
  ...
  stats: ReturnType<typeof getReferralStats>;
}) {
  ...
  const handleClaim = (milestoneId: string, reward: string) => {
    ...
    setTimeout(() => {
      ...
      setClaimingId(null);
      actionToast.success(`Nhận thưởng thành công! +${reward} đã cộng vào ví USDT`);
    }, 1200);
  };
  ...
  return (
    <div>
      ...
      />
      <div
        className="flex gap-2 -mx-5 px-5 overflow-x-auto pb-1"
        ...
        {REFERRAL_MILESTONES.map((m, i) => {
          ...
          return (
            ...
            >
              ...
              <p
                style={{ color: c.text1, fontSize: φ.xs, fontWeight: 700, marginBottom: 2 }}
            ...
            <TrCard className="p-4" style={{ marginTop: S.itemGap }}>
              ...
              <div style={{ marginBottom: S.cardPad }}>
                ...
                <input
                  ...
                  style={{
                    background:
                      'linear-gradient(to right, #10B981 ' +
                      ((calcVolume - 500) / 49500) * 100 +
                      '%, ' +
                      c.surface2 +
                      ' ' +
                      ((calcVolume - 500) / 49500) * 100 +
              ...
              >
                ...
                >
                  Hạng ước tính:{' '}
                  <span style={{ color: estimate.tier.color, fontWeight: 700 }}>
                    {estimate.tier.icon} {estimate.tier.name} ({estimate.tier.commission}%)
                  </span>
                </p>
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="text-center">
                    ...
                    >
                      ${estimate.monthlyComm.toFixed(0)}
                    </p>
  ...
  return (
    <div>
      <SectionHeader
        ...
        mb={S.itemGap}
        right={
          <span style={{ color: '#8B5CF6', fontSize: φ.xs, fontWeight: 600 }}>Tháng 3/2026</span>
        }
      />
      <TrCard overflow>
        <div
        ...
        >
          ...
          <span style={{ color: c.text2, fontSize: φ.xs, fontFamily: 'monospace' }}>
            {stats.totalFriends} bạn
          </span>
          <span
            style={{
              color: '#10B981',
            ...
            >
              ...
              >
                {i < 3 ? (
                  ...
                  <span style={{ color: c.text3, fontSize: 9, fontWeight: 700 }}>
                    #{entry.rank}
                  </span>
                )}
              </div>
            ...
            >
              ...
              >
                ...
                <div className="shrink-0 px-6 pt-6">
                  ...
                  <div
                    className="rounded-2xl px-3 py-2.5 mb-3 flex items-center gap-2"
                    style={{
                  ...
                  >
                    ...
                    <span style={{ color: c.text2, fontSize: φ.xs, lineHeight: 1.4 }}>
                      Bạn bè nhận: <span style={{ color: '#10B981', fontWeight: 700 }}>5 USDT</span>{' '}
                      + giảm 10% phí GD 30 ngày
                    </span>
                  </div>
                </div>
                ...
                >
                  <div className="flex flex-col items-center mb-4">
                    <div
                      className="w-40 h-40 rounded-2xl flex items-center justify-center mb-3 p-2.5"
                  ...
                  >
                    <span
                      style={{ color: c.text2, fontSize: φ.sm, flex: 1, wordBreak: 'break-all' }}
                    >
                      {referralLink}
                    </span>
                    <button
                  ...
                  <div style={{ marginTop: 20 }}>
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span
                                style={{
                                  color: isSelected ? c.chipActiveText : c.text1,
                                  fontSize: φ.sm,
                                  fontWeight: 600,
                                }}
                              >
                              ...
                              <span
                                ...
                                style={{
                                  background: catColors[tpl.category] + '15',
                                  color: catColors[tpl.category],
                                  fontSize: 9,
                                  fontWeight: 600,
                                }}
                              >
                            ...
                            <p
                              style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.4 }}
                              className="truncate"
                            >
                              {tpl.preview}
                            </p>
                    ...
                    <div className="flex items-start gap-2 mt-3">
                      ...
                      <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.4 }}>
                        Chọn mẫu rồi bấm nút mạng xã hội ở trên. Tin nhắn sẽ tự động sao chép vào
                        clipboard.
                      </p>
                    </div>
                  </div>
      ...
      >
        <PageContent gap="default">
          ...
          <div className="flex flex-col" style={{ gap: S.notifyGap }}>
            ...
            >
              ...
              <p style={{ color: c.text2, fontSize: φ.xs, lineHeight: 1.5 }}>
                Nghiêm cấm tự giới thiệu, tạo tài khoản ảo, hoặc gian lận hoa hồng. Vi phạm sẽ bị
                khóa tài khoản và thu hồi thưởng.
              </p>
            </div>
          ...
          >
            ...
            >
              <motion.div
                ...
                animate={{
                  boxShadow: [
                    '0 0 0px ' + currentTier.color + '00',
                    '0 0 20px ' + currentTier.color + '40',
                    '0 0 0px ' + currentTier.color + '00',
                  ],
                }}
              ...
              <div>
                ...
                <p style={{ color: c.portfolioTextMuted, fontSize: φ.xs, opacity: 0.7 }}>
                  {currentTier.nameEn}
                </p>
            ...
            <div
              ...
              style={{ gap: S.itemGap, marginBottom: S.cardPad }}
            >
              {[
                {
                  label: 'Bạn bè',
                  value: stats.totalFriends.toString(),
                  sub: stats.activeFriends + ' hoạt động',
                  color: '#60A5FA',
                },
                {
                  label: 'Hoa hồng',
                  value: fmtUsd(stats.totalCommission),
                  sub: 'Tổng tích luỹ',
                  color: '#34D399',
                },
                {
            ...
            {stats.pendingCommission > 0 && (
              <div
                className="rounded-xl px-3 py-2 flex items-center gap-2 relative z-10"
                style={{
                  marginBottom: S.itemGap,
            ...
            <div
              className="rounded-2xl p-3 relative z-10"
              style={{
                marginBottom: S.itemGap,
                background: c.portfolioBtnGhost,
                border: '1px solid ' + c.portfolioBtnGhostBorder,
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  onClick={() => handleCopy(USER_PROFILE.referralCode)}
                ...
                >
                  ...
                  <span style={{ fontSize: φ.sm, fontWeight: 600 }}>
            ...
            <div
              className="rounded-xl p-2.5 relative z-10 flex items-center gap-3"
              style={{
                marginBottom: S.itemGap,
                background: 'rgba(16,185,129,0.08)',
                border: '1px solid rgba(16,185,129,0.15)',
            ...
            >
              <div className="flex-1 text-center">
                <p style={{ color: c.portfolioTextMuted, fontSize: 9, fontWeight: 500 }}>
                  Bạn nhận
                </p>
                <p style={{ color: '#34D399', fontSize: φ.sm, fontWeight: 700 }}>
                  {fmtUsd(currentTier.kycBonus)} + {currentTier.commission}%
                </p>
              </div>
            ...
            >
              <TrCard className="p-4">
                ...
                >
                  ...
                  <motion.span
                    style={{ color: nextTier.color, fontSize: φ.sm, fontWeight: 700 }}
                    animate={{ scale: [1, 1.05, 1] }}
                    transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
                  >
                    {nextTier.icon} {nextTier.name}{' '}
                    <span style={{ fontSize: φ.xs, opacity: 0.7 }}>({nextTier.nameEn})</span>
                  </motion.span>
                </div>
                <div
                  className="h-2.5 rounded-full relative overflow-hidden"
                  style={{ marginBottom: S.itemGap, background: c.surface2 }}
                >
                  <motion.div
                ...
                <div className="flex justify-between">
                  <span style={{ color: c.text3, fontSize: φ.xs }}>
                    {stats.totalFriends} / {nextTier.friends} bạn bè
                  </span>
                  <span style={{ color: c.text3, fontSize: φ.xs }}>
                    Hoa hồng {nextTier.commission}% + {fmtUsd(nextTier.kycBonus)}/KYC
                  </span>
                </div>
              </TrCard>
            </motion.div>
                  ...
                  >
                    <TrCard className="p-4" accentBorder="rgba(245,158,11,0.15)">
                      <div className="flex items-center gap-3" style={{ marginBottom: S.itemGap }}>
                        ...
                        >
                          <span style={{ color: '#F59E0B', fontSize: φ.base, fontWeight: 700 }}>
                            {pd.friendAvatar}
                          </span>
                        </div>
                        <div className="flex-1 min-w-0">
                      ...
                      <p
                        style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5, marginBottom: 6 }}
                      >
                        {pd.reasonDetail}
                      </p>
                      ...
                      <div
                        ...
                        style={{ background: 'rgba(245,158,11,0.06)', display: 'inline-flex' }}
                      >
                        <Clock size={φ.xs} color="#F59E0B" />
                        <span style={{ color: '#F59E0B', fontSize: φ.xs, fontWeight: 600 }}>
                          {pd.eta}
          ...
          <div>
            ...
            <div className="grid grid-cols-2" style={{ gap: S.itemGap }}>
              <TrCard className="p-4" accentBorder="rgba(16,185,129,0.15)">
                ...
                >
                  {fmtUsd(currentTier.kycBonus)}
                </p>
                <p style={{ color: c.text3, fontSize: φ.xs, marginTop: 2 }}>Mỗi bạn hoàn tất KYC</p>
                <div
                  className="flex items-center gap-1 mt-2 px-2 py-1 rounded-md"
                  style={{ background: 'rgba(251,146,60,0.1)' }}
                >
                  <Zap size={9} color="#FB923C" />
                  <span style={{ color: '#FB923C', fontSize: 9, fontWeight: 700 }}>
                    x{ACTIVE_CAMPAIGN.bonusMultiplier} đang áp dụng!
                  </span>
                </div>
              </TrCard>
          ...
          <TrCard className="px-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5 }}>
                Hoa hồng = Phí GD thực tế của bạn bè x {currentTier.commission}%. Cộng real-time vào
                ví USDT, không giới hạn thời gian.
              </p>
            </div>
          </TrCard>
          ...
          <div>
            ...
            <TrCard overflow>
              {[
                {
                  IconComp: Users,
                  label: 'Bạn bè đã mời (' + stats.totalFriends + ')',
                  sub: stats.kycCompleted + ' đã KYC',
                  color: '#8B5CF6',
                  route: prefix + '/referral/history',
                },
                {
                  IconComp: Gift,
                  label: 'Phần thưởng',
                  sub:
                    ...
                    ' tổng tích luỹ' +
                    (stats.pendingCommission > 0
                      ? ' · ' + fmtUsd(stats.pendingCommission) + ' đang chờ'
                      : ''),
                  color: '#10B981',
                  route: prefix + '/referral/rewards',
                },
                {
                  IconComp: Award,
                  label: 'Bảng hạng & Điều khoản',
                  sub: 'Hạng hiện tại: ' + currentTier.name + ' (' + currentTier.nameEn + ')',
                  color: '#F59E0B',
                  route: prefix + '/referral/rules',
                },
              ].map((item, i) => (
                <button
                  key={item.label}
              ...
              {[
                {
                  step: '1',
                  title: 'Chia sẻ link',
                  desc: 'Gửi link giới thiệu cho bạn bè qua Zalo, Facebook, Telegram',
                  IconComp: Share2,
                  color: '#3B82F6',
                },
                {
                  ...
                  desc: 'Cả hai nhận thưởng ' + fmtUsd(currentTier.kycBonus) + ' USDT',
                  IconComp: UserCheck,
                  color: '#8B5CF6',
                },
                {
                  ...
                  desc: 'Bạn bè bắt đầu trade trên VitTrade',
                  IconComp: TrendingUp,
                  color: '#F59E0B',
                },
                {
                  ...
                  desc: currentTier.commission + '% phí GD, real-time, không giới hạn',
                  IconComp: Gift,
                  color: '#10B981',
                },
              ].map((item, i) => (
                ...
                >
                  ...
                  >
                    <span style={{ color: c.text2, fontSize: φ.sm, fontWeight: 700 }}>
                      {item.step}
                    </span>
                  </div>
                </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2" style={{ gap: S.itemGap }}>
              <TrCard className="p-4">
                <p style={{ color: c.text3, fontSize: φ.xs, marginBottom: 4 }}>
                  Hoa hồng tháng này
                </p>
                <p
                  style={{
          ...
          <div>
            <SectionHeader
              ...
              right={
                <span style={{ color: c.text3, fontSize: φ.xs }}>
                  {CAMPAIGN_HISTORY.length} sự kiện
                </span>
              }
            />
            <div className="flex flex-col" style={{ gap: S.itemGap }}>
              {CAMPAIGN_HISTORY.map((camp, idx) => {
                ...
                return (
                  ...
                  >
                    <TrCard
                      className="p-4"
                      accentBorder={camp.status === 'active' ? 'rgba(16,185,129,0.2)' : undefined}
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          <p style={{ color: c.text1, fontSize: φ.body, fontWeight: 700 }}>
                      ...
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span style={{ color: c.text3, fontSize: φ.xs }}>
                            {camp.totalParticipants.toLocaleString()}
                          </span>
                        </div>
                        <span
                          className="px-2 py-0.5 rounded-md"
                        ...
                        <div className="rounded-xl p-2.5 mt-1" style={{ background: c.surface2 }}>
                          ...
                          <div className="flex items-center gap-4">
                            <div>
                              ...
                              <span style={{ color: c.text3, fontSize: φ.xs, marginLeft: 4 }}>
                                bạn mời
                              </span>
                            </div>
                            <div>

      ...
      <PageContent padding="relaxed" gap="relaxed">
        ...
        {step === 'reset' && (
          <div className="contents">
            ...
            {[
              ['Mật khẩu mới', newPw, setNewPw],
              ['Xác nhận mật khẩu', confirmPw, setConfirmPw],
            ].map(([label, val, setter]: any, i) => (
              <div key={label}>
                <InputField
                  label={label}
                  ...
                  error={
                    i === 1 && confirmPw && confirmPw !== newPw ? 'Mật khẩu không khớp' : undefined
                  }
                />
              </div>
            ))}
          ...
          <div className="flex flex-col items-center gap-6 py-8">
            ...
            <div className="text-center">
              ...
              <p style={{ color: c.text2, fontSize: 14, marginTop: 8, lineHeight: 1.6 }}>
                Mật khẩu của bạn đã được đặt lại thành công.{'\n'}Vui lòng đăng nhập với mật khẩu
                mới.
              </p>
            </div>
            <CTAButton

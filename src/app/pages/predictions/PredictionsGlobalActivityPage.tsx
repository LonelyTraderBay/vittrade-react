                ...
                {MIN_AMOUNTS.map((ma) => (
                  <button
                    ...
                    style={{
                      ...
                      fontSize: 11,
                      fontWeight: minAmount === ma.value ? 600 : 400,
              ...
              {filtered.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <p style={{ color: c.text3, fontSize: 11, marginTop: 4 }}>
                    Lower the minimum amount filter
                  </p>
                </div>
              ) : (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {event && (
                            <p
                              ...
                              style={{ color: c.text3, fontSize: 10, marginTop: 2 }}
                            >
                              {event.title}
                            </p>
                          )}
                        ...
                        <div className="text-right shrink-0">
                          ...
                          >
                            $
                            {act.amount >= 1000
                              ? `${(act.amount / 1000).toFixed(1)}K`
                              : act.amount.toFixed(0)}
                          </p>

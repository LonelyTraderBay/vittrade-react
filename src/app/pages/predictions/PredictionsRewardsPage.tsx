          ...
          <PageContent>
            ...
            <TrCard variant="hero" className="p-5 relative overflow-hidden">
              ...
              <div className="flex items-center gap-1.5 relative z-10">
                ...
                <span
                  style={{ color: c.warn, fontSize: 16, fontWeight: 700, fontFamily: 'monospace' }}
                >
                  ${totalDailyRewards}
                </span>
              </div>
            ...
            >
              ...
              <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
                <strong style={{ color: c.text1 }}>How it works:</strong> Place a{' '}
                <strong>limit order</strong> (not market order) within the{' '}
                <strong>Max Spread</strong> and hold at least <strong>Min Shares</strong>. Rewards
                are distributed daily in USDT at 00:00 UTC.
              </p>
            </div>
            ...
            <div className="flex gap-1.5 -mx-5 px-5 overflow-x-auto scrollbar-none pb-1">
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 11,
                  fontWeight: showFavOnly ? 600 : 400,
                  border: `1px solid ${showFavOnly ? 'rgba(239,68,68,0.25)' : 'transparent'}`,
                }}
              >
                <Heart
                  size={10}
                  fill={showFavOnly ? c.sell : 'transparent'}
                  color={showFavOnly ? c.sell : c.text3}
                />
                Favs
              </button>
            ...
            {filtered.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p style={{ color: c.text2, fontSize: 13, fontWeight: 600, marginTop: 12 }}>
                  No rewards found
                </p>

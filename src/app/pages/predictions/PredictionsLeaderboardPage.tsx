      ...
      {podiumOrder.map((t, idx) => {
        ...
        return (
          ...
          >
            ...
            <p
              className="text-truncate w-full text-center"
              style={{ color: c.text1, fontSize: 11, fontWeight: 700, marginTop: 4 }}
            >
              {t.user}
            </p>
            <p
            ...
            <div
              className="w-full rounded-t-xl flex items-end justify-center pb-2 mt-2"
              style={{
                height: heights[idx],
            ...
            >
              <div className="flex items-center gap-1">
                ...
                <span style={{ color: colors[idx], fontSize: 13, fontWeight: 700 }}>
                  {labels[idx]}
                </span>
              </div>
            </div>
          ...
          <PageContent>
            ...
            <div>
              ...
              <TrCard className="overflow-hidden">
                ...
                >
                  <span className="w-8" style={{ color: c.text3, fontSize: 10, fontWeight: 600 }}>
                    #
                  </span>
                  <span
                    className="flex-1"
                ...
                {traders.map((t, idx) => (
                  <motion.div
                    ...
                    style={{
                      borderBottom: idx < traders.length - 1 ? `1px solid ${c.border}` : 'none',
                    }}
                  >
                    <span
                      className="w-8"
                        ...
                        >
                          <span
                            style={{
                              ...
                              fontWeight: 700,
                              color:
                                t.rank === 1 ? '#FFD700' : t.rank === 2 ? '#C0C0C0' : '#CD7F32',
                            }}
                          >
                            {t.rank}
                          </span>
                    ...
                    <span
                      className="w-14 text-right"
                      style={{
                        color: t.winRate >= 70 ? c.buy : t.winRate >= 50 ? c.warn : c.sell,
                        fontSize: 11,
                        fontWeight: 600,
                      }}
                    >
                ...
                <div className="flex flex-col gap-2">
                  {biggestWins.map((t, idx) => {
                    const matchedEvent = t.biggestWinMarket
                      ? PREDICTION_EVENTS.find((e) =>
                          e.title
                            .toLowerCase()
                            .includes(
                              t.biggestWinMarket!.toLowerCase().split(' ').slice(0, 3).join(' '),
                            ),
                        )
                      : null;
                    return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p
                              className="text-truncate"
                              style={{
                                color: matchedEvent ? c.primary : c.text3,
                                fontSize: 10,
                                marginTop: 2,
                              }}
                            >
                          ...
                          >
                            +$
                            {t.biggestWin && t.biggestWin >= 1000
                              ? `${(t.biggestWin / 1000).toFixed(1)}K`
                              : t.biggestWin}
                          </span>
                        </TrCard>
                      </motion.div>

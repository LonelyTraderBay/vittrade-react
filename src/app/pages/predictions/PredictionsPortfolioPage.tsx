      ...
      <TrCard variant="hero" className="p-5 relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-2 relative z-10">
          ...
          <button onClick={() => setHidden(!hidden)} className="p-1 rounded-lg hover-ghost">
            {hidden ? (
              <EyeOff size={16} color={c.portfolioTextMuted} />
            ) : (
              <Eye size={16} color={c.portfolioTextDim} />
            )}
          </button>
        </div>
        ...
        {!hidden && (
          <motion.div
            className="flex items-center gap-2.5 mt-2 mb-4 relative z-10"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              {totalPnl >= 0 ? (
                <TrendingUp size={12} color="#34D399" strokeWidth={2.5} />
              ) : (
                <TrendingDown size={12} color="#EF4444" strokeWidth={2.5} />
              )}
              <span
                style={{ color: totalPnl >= 0 ? c.buy : c.sell, fontSize: 12, fontWeight: 600 }}
              >
        ...
        <div className="flex gap-2 relative z-10">
          {[
            {
              label: 'Positions',
              value: hidden ? '••' : `${openPositions.length}`,
              icon: PieChart,
            },
            {
              label: 'P/L',
              value: hidden ? '••' : `${totalPnl >= 0 ? '+' : ''}$${totalPnl.toFixed(0)}`,
              icon: TrendingUp,
            },
            {
              label: 'Open Orders',
              value: hidden ? '••' : `${openOrders.length}`,
              icon: ShoppingCart,
            },
          ].map((stat) => (
  ...
  return (
    ...
    >
      <TrCard
        ...
        onClick={() => {
          hapticSelection();
          navigate(`${prefix}/markets/predictions/event/${position.eventId}`);
        }}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mb-2 flex-wrap">
              <span
                ...
                style={{
                  background:
                    position.outcome === 'Yes' ? 'rgba(16,185,129,0.12)' : 'rgba(239,68,68,0.12)',
  ...
  return (
    ...
    >
      <TrCard className="p-3">
        <div
          onClick={() => {
            navigate(`${prefix}/markets/predictions/receipt/${order.id.replace('oo-', 'po-')}`);
            hapticSelection();
          }}
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1 flex-wrap">
              ...
              <span style={{ color: c.text3, fontSize: 10 }}>Filled: {fillPct}%</span>
            </div>
            {/* Fill progress */}
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p
              ...
              style={{ color: c.text1, fontSize: 12, fontWeight: 600, marginBottom: 3 }}
            >
              {receipt.eventTitle}
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <span
                style={{ color: c.text1, fontSize: 10, fontWeight: 600, fontFamily: 'monospace' }}
              >
                ${receipt.total.toFixed(2)}
              </span>
              <span style={{ color: c.text3, fontSize: 9 }}>{receipt.createdAt}</span>
            </div>
          </div>
          ...
          <PageContent>
            ...
            >
              ...
              <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
                <strong style={{ color: c.text1 }}>Shares</strong> represent your stake in a market
                outcome. Each share pays <strong>$1.00</strong> if correct, <strong>$0.00</strong>{' '}
                if wrong. <strong>P/L</strong> = current value minus amount invested.
              </p>
            </div>
            ...
            {activeTab === 'active' && openOrders.length > 0 && (
              <div>
                <SectionHeader
                  ...
                  right={
                    <div className="flex items-center gap-1">
                      <span style={{ color: c.warn, fontSize: 11, fontWeight: 700 }}>
                        {openOrders.length}
                      </span>

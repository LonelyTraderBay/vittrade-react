    ...
    <div className="flex flex-col gap-4" style={{ width: 340 }}>
        ...
        <div className="grid grid-cols-3 gap-3 mt-4">
          {[
            ...
            <div key={s.label}>
              ...
              <br />
              <span
                style={{ color: s.color, fontFamily: 'monospace', fontWeight: 600, fontSize: 13 }}
              >
                {s.value}
              </span>
            </div>
      ...
      <TrCard className="p-4">
        ...
        <div className="flex gap-3 mb-3">
          <button
            onClick={() => navigate(`${routePrefix}/trade/${pairId}?side=buy`)}
          ...
          <button
            onClick={() => navigate(`${routePrefix}/trade/${pairId}?side=sell`)}
            className="flex-1 h-12 rounded-2xl flex items-center justify-center font-semibold text-white"
            style={{
        ...
        <button
          onClick={() => navigate(`${routePrefix}/markets/alerts`)}
      ...
      {dcaBanner && <TrCard className="p-4">{dcaBanner}</TrCard>}
  ...
  const mainContent = (
    <PageLayout style={{ flex: 1 }}>
        ...
        <div className="px-5 py-3" style={{ borderBottom: `1px solid ${c.divider}` }}>
          <div className="flex items-end gap-3 mb-1">
            <span
              style={{
                color:
                  priceFlash === 'up' ? '#10B981' : priceFlash === 'down' ? '#EF4444' : c.text1,
                fontSize: 30,
                fontWeight: 700,
                fontFamily: 'monospace',
                transition: 'color 0.3s',
          ...
          <div className="flex gap-4 text-xs">
            {[
              ...
              <div key={stat.label}>
                <span style={{ color: c.text3 }}>{stat.label}</span>
                <br />
        ...
        <div>
          ...
          {recentTrades.slice(0, 20).map((trade) => (
            ...
            >
              ...
              <span style={{ color: c.text3, fontSize: 12, flex: 1, textAlign: 'right' }}>
                {trade.time}
              </span>
            </div>
          ))}
      ...
      {!isDesktop && pairDetailBannerTest.showBeforeRisk && dcaBanner && (
        <div className="mx-5 mb-3">{dcaBanner}</div>
      )}

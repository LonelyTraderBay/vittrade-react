...
export function LaunchpadPage() {
  ...
  const tabFiltered = statusFilter ? PROJECTS.filter((p) => p.status === statusFilter) : PROJECTS;
  ...
  const hasActiveFilters =
    ...
    filter.hasWhitelist !== null ||
    filter.auditPassed !== null ||
            ...
            >
              ...
              {hasActiveFilters && (
                <div
                  ...
                  style={{ background: '#3B82F6', border: `2px solid ${c.surface}` }}
                />
              )}
            </button>
            <button
      ...
      <PageContent gap="default">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-5 relative z-10">
            ...
            <div>
              <h2 style={{ color: '#fff', fontSize: 22, fontWeight: 800, letterSpacing: -0.3 }}>
                VitLaunch
              </h2>
        ...
        {/* Tab filter */}
        <TabBar variant="pill" tabs={TABS} active={tab} onChange={setTab} />
          ...
          <EmptyState
            ...
            description={
              hasActiveFilters
                ...
                : `Hiện không có dự án nào ${tab !== 'Tất cả' ? 'trong mục này' : ''}. Quay lại sau nhé!`
            }
            action={
              hasActiveFilters
                ? { label: 'Xóa bộ lọc', onClick: () => setFilter(DEFAULT_FILTER) }
                : tab !== 'Tất cả'
                  ? { label: 'Xem tất cả', onClick: () => setTab('Tất cả') }
                  : undefined
            }
          />
        ) : (
            ...
            {[
              {
                ...
                desc: 'Cài đặt âm thanh & rung',
                color: '#8B5CF6',
                route: `${prefix}/launchpad/notif-sound`,
              },
              {
                icon: ScrollText,
                label: 'Event Log',
                desc: 'Xuất log giao dịch',
                color: '#3B82F6',
                route: `${prefix}/launchpad/event-log`,
              },
              {
                icon: GitCompare,
                label: 'ABI Diff',
                desc: 'So sánh proxy upgrade',
                color: '#F59E0B',
                route: `${prefix}/launchpad/abi-diff/default`,
              },
              {
                icon: BookOpen,
                label: 'Sổ địa chỉ',
                desc: 'Quản lý ví đa mạng',
                color: '#10B981',
                route: `${prefix}/launchpad/address-book`,
              },
              {
                icon: Webhook,
                label: 'Webhooks',
                desc: 'Đăng ký event contract',
                color: '#EC4899',
                route: `${prefix}/launchpad/webhooks`,
              },
              {
                icon: Fuel,
                label: 'Gas Tracker',
                desc: 'Theo dõi gas đa mạng',
                color: '#F97316',
                route: `${prefix}/launchpad/gas-tracker`,
              },
              {
                icon: PieChart,
                label: 'Rebalance',
                desc: 'Cân bằng portfolio',
                color: '#06B6D4',
                route: `${prefix}/launchpad/rebalance`,
              },
              {
                icon: Lock,
                label: 'Multi-sig',
                desc: 'Giao dịch nhiều chữ ký',
                color: '#8B5CF6',
                route: `${prefix}/launchpad/multisig`,
              },
            ].map((tool) => (
              <button
                key={tool.label}
            ...
            {[
              {
                ...
                desc: 'So sánh giá DEX',
                color: '#3B82F6',
                route: `${prefix}/launchpad/swap-aggregator`,
              },
              {
                icon: Clock4,
                label: 'Limit Orders',
                desc: 'Lệnh tự động',
                color: '#10B981',
                route: `${prefix}/launchpad/limit-orders`,
              },
              {
                icon: DollarSign,
                label: 'DCA Builder',
                desc: 'Chiến lược DCA',
                color: '#F59E0B',
                route: `${prefix}/launchpad/dca-builder`,
              },
              {
                icon: Shield,
                label: 'Risk Analytics',
                desc: 'Phân tích rủi ro',
                color: '#EF4444',
                route: `${prefix}/launchpad/risk-analytics`,
              },
            ].map((tool) => (
              <button
                key={tool.label}
        ...
        >
          ...
          <div>
            ...
            <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
              Chỉ tham gia qua app chính thức. Không gửi token cho bất kỳ ai yêu cầu. Kiểm tra
              contract address trước khi tương tác.
            </p>
          </div>
        </div>

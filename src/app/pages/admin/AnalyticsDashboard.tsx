...
export default function AnalyticsDashboard() {
  ...
  const recentEvents = useMemo(() => {
    return [...analyticsData].sort((a, b) => b.timestamp - a.timestamp).slice(0, 20);
  }, [analyticsData]);
      ...
      <PageContent gap="default">
          ...
          <div className="flex gap-2 bg-[var(--surface-2)] p-1 rounded-xl">
            {(['7d', '30d', '90d'] as const).map((range) => (
              <button
                ...
                style={{
                  background: timeRange === range ? c.surface : 'transparent',
        ...
        <div className="grid grid-cols-2 gap-3">
          <TrCard className="p-4">
            ...
            <p style={{ color: c.text3, fontSize: 11 }}>~{metrics.eventsPerDay} sự kiện/ngày</p>
          </TrCard>
          ...
          <TrCard className="p-4">
            ...
            <p style={{ color: c.text3, fontSize: 11 }}>Unique users</p>
          </TrCard>
        </div>
        ...
        <TrCard className="p-4">
          ...
          <ResponsiveContainer width="100%" height={200}>
            ...
            >
              ...
              <XAxis key="x-axis" dataKey="date" stroke={c.text3} style={{ fontSize: 11 }} />
              <YAxis key="y-axis" stroke={c.text3} style={{ fontSize: 11 }} />
              <Tooltip
                key="tooltip"
                contentStyle={{
        ...
        <TrCard className="p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 style={{ color: c.text1, fontSize: φ.base, fontWeight: 600 }}>Top sự kiện</h2>
          </div>
            ...
            {metrics.topEvents.map((event, idx) => (
              <div key={event.eventName} className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p style={{ color: c.text1, fontSize: 13, fontWeight: 500 }} className="truncate">
                    {event.eventName}
                  </p>
                </div>
                ...
                <div className="text-right">
                  ...
                  <p style={{ color: c.text3, fontSize: 11 }}>{event.percentage.toFixed(1)}%</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <TrCard className="p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 style={{ color: c.text1, fontSize: φ.base, fontWeight: 600 }}>Phân bố sự kiện</h2>
          </div>
        ...
        <TrCard className="p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 style={{ color: c.text1, fontSize: φ.base, fontWeight: 600 }}>Sự kiện gần đây</h2>
          </div>
          ...
          <div className="space-y-2 max-h-[400px] overflow-y-auto">
            {recentEvents.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p style={{ color: c.text3, fontSize: 13 }}>Chưa có sự kiện nào</p>
              </div>
            ) : (
        ...
        <TrCard className="p-3">
          <p style={{ color: c.text3, fontSize: 11, textAlign: 'center' }}>
            Tổng {analyticsData.length} sự kiện trong queue • Cập nhật lần cuối:{' '}

...
export const UNIFIED_TASKS: UnifiedTask[] = [
  // ─── Hàng ngày ───
  {
    ...
    description: 'Đăng nhập mỗi ngày để nhận thưởng kép',
    icon: '📅',
    usdtReward: '0.5 USDT',
    pointsReward: 30,
    progress: 1,
  ...
  },
  {
    ...
    description: 'Hoàn thành 5 lệnh giao dịch Spot trong ngày',
    icon: '📊',
    usdtReward: '2 USDT',
    pointsReward: 50,
    progress: 3,
  ...
  },
  {
    id: 'u006',
    title: 'Streak 7 ngày',
    description: 'Đăng nhập 7 ngày liên tiếp để nhận bonus',
    icon: '⚡',
    usdtReward: '5 USDT',
    pointsReward: 100,
    progress: 5,
  ...
  // ─── Flash ⚡ ───
  {
    ...
    description: 'Mua tối thiểu $50 BTC trong 4 giờ tới',
    icon: '⚡',
    usdtReward: '8 USDT',
    pointsReward: 120,
    progress: 0,
  ...
  },
  {
    ...
    description: 'Hoàn thành 3 lệnh P2P trong 6 giờ',
    icon: '💥',
    usdtReward: '12 USDT',
    pointsReward: 200,
    progress: 1,
  ...
  {
    id: 'u016',
    title: 'Flash: Volume $5K nhanh',
    description: 'Đạt $5,000 volume trong 8 giờ tới',
    icon: '🚀',
    usdtReward: 'Giảm 70% phí 3 ngày',
    pointsReward: 180,
    progress: 2100,
    maxProgress: 5000,
    status: 'active',
  ...
  // ─── Học & Nhận thưởng ───
  {
    ...
    description: 'Trả lời đúng 5 câu hỏi về blockchain',
    icon: '📚',
    usdtReward: '2 USDT',
    pointsReward: 60,
    progress: 5,
  ...
  },
  {
    ...
    description: 'Xem video 3 phút và trả lời quiz',
    icon: '🎓',
    usdtReward: '3 USDT',
    pointsReward: 80,
    progress: 0,
  ...
  },
  {
    ...
    description: 'Hoàn thành bài kiểm tra an toàn P2P',
    icon: '🛡️',
    usdtReward: '1.5 USDT',
    pointsReward: 50,
    progress: 3,
  ...
  },
  {
    ...
    description: 'Tìm hiểu cách kiếm lợi nhuận thụ động',
    icon: '📖',
    usdtReward: '2.5 USDT',
    pointsReward: 70,
    progress: 0,
  ...
  // ─── Thêm daily/weekly bonuses ───
  {
    ...
    description: 'Share 1 kết quả giao dịch lên mạng xã hội',
    icon: '📱',
    usdtReward: '1 USDT',
    pointsReward: 25,
    progress: 0,
  ...
  },
  {
    ...
    description: 'Để lại đánh giá cho 3 người bán P2P',
    icon: '⭐',
    usdtReward: '1.5 USDT',
    pointsReward: 35,
    progress: 2,
  ...
  },
  {
    ...
    description: 'Duy trì số dư ≥ $500 trong 7 ngày',
    icon: '💎',
    usdtReward: '10 USDT',
    pointsReward: 200,
    progress: 5,
  ...
  },
  {
    ...
    description: 'Giao dịch ít nhất 10 cặp coin khác nhau',
    icon: '🌐',
    usdtReward: '8 USDT',
    pointsReward: 150,
    progress: 6,
...
export const TIER_CONFIG = [
  ...
  },
  {
    ...
    color: '#94A3B8',
    minPoints: 1000,
    perks: 'Giảm 5% phí, ưu tiên hỗ trợ',
  },
  {
    id: 'gold',
    label: 'Vàng',
...
export const REDEMPTION_ITEMS = [
  ...
  {
    id: 'rd2',
    title: 'Voucher 5 USDT',
    desc: 'Áp dụng cho giao dịch tiếp theo',
    cost: 1200,
    icon: '🎫',
    color: '#F59E0B',
    tag: null,
  ...
  {
    id: 'rd4',
    title: 'Ưu tiên hỗ trợ 30 ngày',
    desc: 'Chat trực tiếp với chuyên gia',
    cost: 800,
    icon: '🛡️',
    color: '#3B82F6',
    tag: null,
  ...
  {
    id: 'rd5',
    title: 'Giảm phí rút coin 25%',
    desc: '3 lần rút tiếp theo',
    cost: 600,
    icon: '💰',
    color: '#EC4899',
    tag: null,
...
export const MYSTERY_BOXES = [
  {
    ...
    color: '#CD7F32',
    requiredTasks: 3,
    prizes: ['1 USDT', '50 pts', 'Giảm 20% phí'],
    unlocked: true,
  },
  {
    id: 'mb2',
    ...
    color: '#94A3B8',
    requiredTasks: 7,
    prizes: ['3 USDT', '150 pts', 'Giảm 40% phí'],
    unlocked: true,
  },
  {
    id: 'mb3',
    ...
    color: '#F59E0B',
    requiredTasks: 12,
    prizes: ['8 USDT', '300 pts', 'VIP 7 ngày'],
    unlocked: false,
  },
  {
    id: 'mb4',
    ...
    color: '#8B5CF6',
    requiredTasks: 20,
    prizes: ['20 USDT', '500 pts', 'VIP 30 ngày'],
    unlocked: false,
  },
] as const;

...
const VIOLATION_PROCESS = [
  {
    step: 1,
    title: 'Gửi báo cáo',
    desc: 'Nhấn "Báo cáo" trên profile hoặc challenge và chọn lý do.',
  },
      ...
      <PageContent gap="relaxed">
          ...
          <div className="flex flex-col gap-2">
            <TrCard className="p-4 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p style={{ color: c.text2, fontSize: φ.xs, lineHeight: 1.5, marginTop: 2 }}>
                  Nhấn nút "Báo cáo" trên profile người dùng, challenge hoặc mode. Chn lý do và gửi.
                  Đội ngũ sẽ xem xét trong 24 – 48h.
                </p>
              </div>
            </TrCard>
            <TrCard className="p-4 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p style={{ color: c.text2, fontSize: φ.xs, lineHeight: 1.5, marginTop: 2 }}>
                  Nhấn "Chặn" trên profile người dùng. Sau khi chặn, bạn sẽ không thấy challenge
                  hoặc tin nhắn từ người này. Có thể bỏ chặn bất cứ lúc nào.
                </p>
              </div>
            </TrCard>
          </div>
                  ...
                  <div className="flex flex-col items-center" style={{ width: 28 }}>
                    ...
                    {i < VIOLATION_PROCESS.length - 1 && (
                      <div
                        ...
                        style={{ background: 'rgba(16,185,129,0.2)', minHeight: 20 }}
                      />
                    )}
                  </div>
            ...
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="flex-1">
                ...
                <p style={{ color: c.text2, fontSize: φ.xs, lineHeight: 1.5, marginTop: 4 }}>
                  Mỗi challenge có phương thức chốt riêng. Bạn luôn biết trước cách xác định kết
                  quả.
                </p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Người tham gia bỏ phiếu. Kết quả theo đa số.',
                },
                {
                  title: 'Trọng tài (Referee)',
                  desc: 'Một người được chỉ định xem xét bằng chứng và quyết định.',
                },
                {
                  title: 'Tự động (Auto)',
                  desc: 'Hệ thống tự chốt dựa trên dữ liệu từ nguồn đáng tin cậy (API giá, oracle).',
                },
              ].map((item) => (
                <div key={item.title}>
                  <p style={{ color: c.text1, fontSize: φ.sm, fontWeight: 600, lineHeight: 1.4 }}>
          ...
          <TrCard className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p style={{ color: c.text2, fontSize: φ.xs, lineHeight: 1.5, marginTop: 4 }}>
                  Không trao đổi tiền thật, crypto hoặc tài sản ngoài Arena. Mọi challenge chỉ sử
                  dụng Arena Points. Nếu ai đề nghị giao dịch ngoài nền tảng, hãy báo cáo ngay.
                </p>
              </div>
            </div>
            <div
            ...
            >
              {[
                ...
                <div key={item.text} className="flex items-center gap-2">
                  ...
                  <span
                    style={{ color: item.ok ? c.text1 : c.text2, fontSize: φ.xs, lineHeight: 1.4 }}
                  >
                    {item.text}
                  </span>
                </div>
          ...
          <TrCard className="p-4">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="flex-1">
                ...
                <p style={{ color: c.text2, fontSize: φ.xs, lineHeight: 1.5, marginTop: 4 }}>
                  Arena Points là phần thưởng hoạt động, không phải tài sản tài chính, không có giá
                  trị tiền tệ và không thể rút ra ngoài nền tảng.
                </p>
              </div>
            </div>
            <div
        ...
        <div className="flex flex-col gap-2">
          ...
          <TrCard
            ...
            as="button"
            onClick={() => {
              navigate(`${prefix}/profile/arena/reports/rpt001`);
              hapticSelection();
            }}
            className="flex items-center gap-3 p-4 w-full active:opacity-70"
            style={{ minHeight: 52 }}

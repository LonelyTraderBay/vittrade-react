...
export const SAFETY_TIPS = [
  {
    ...
    desc: 'Arena chỉ dùng Arena Points — không liên quan đến tài sản crypto hay fiat. Chơi thoải mái, không rủi ro tài chính.',
    color: '#3B82F6',
  },
  {
    icon: Lock,
    title: 'Pool Points được khóa an toàn',
    desc: 'Entry points được khóa trong pool cho đến khi challenge kết thúc và có kết quả. Không ai (kể cả creator) rút được.',
    color: '#8B5CF6',
  },
  {
    icon: AlertTriangle,
    title: 'Đọc kỹ luật trước khi join',
    desc: 'Luôn đọc hết luật chơi, điều kiện thắng/thua, và cách xác nhận kết quả trước khi tham gia.',
    color: '#F59E0B',
  },
  {
    icon: Eye,
    title: 'Kiểm tra Trust Score của creator',
    desc: 'Ưu tiên challenge từ creator có Trust Score cao (>80%) và Fair Play badge. Xem lịch sử tranh chấp.',
    color: '#10B981',
  },
  {
    icon: Users,
    title: 'Báo cáo nếu nghi ngờ',
    desc: 'Thấy challenge bất thường? Nhấn "Báo cáo" — đội ngũ sẽ kiểm tra trong 24h. Bảo vệ cộng đồng!',
    color: '#EF4444',
  },
  {
    icon: FileText,
    title: 'Tranh chấp có quy trình rõ ràng',
    desc: 'Nếu không đồng ý kết quả, mở tranh chấp trong Resolution Center. Bằng chứng + cộng đồng vote = công bằng.',
    color: '#06B6D4',
  },
];
...
export const FAQ_DATA = [
  {
    q: 'Arena Points là gì?',
    a: 'Arena Points là đơn vị dùng trong Open Arena để tham gia challenge. Points không phải tiền thật và không liên quan đến crypto/fiat. Bạn nhận Points từ hoạt động trên nền tảng, hoàn thành nhiệm vụ, hoặc thắng challenge.',
  },
  {
    q: 'Tạo challenge có mất phí không?',
    a: 'Không mất phí tạo. Tuy nhiên, nếu bạn đặt entry points, bạn cũng cần stake cùng số points vào pool (tuỳ cấu hình). Creator có thể đặt creator cut (tối đa 5%) từ pool.',
  },
  {
    q: 'Làm sao để challenge thu hút nhiều người?',
    a: 'Đặt tên rõ ràng, entry points vừa phải (50–200), luật chơi minh bạch, dùng Auto Resolution nếu có thể, và chia sẻ link cho bạn bè. Challenge có Fair Play badge thu hút gấp 2x.',
  },
  {
    q: 'Kết quả được xác nhận như thế nào?',
    a: '4 cách: (1) Auto — lấy từ nguồn dữ liệu tự động, (2) Mutual Confirm — cả 2 bên xác nhận, (3) Referee — trọng tài quyết định, (4) Community Vote — cộng đồng bình chọn. Auto ít tranh chấp nhất.',
  },
  {
    q: 'Nếu tôi không đồng ý kết quả thì sao?',
    a: 'Bạn có thể mở tranh chấp (dispute) trong Resolution Center. Cung cấp bằng chứng, đợi đánh giá. Quy trình minh bạch với timeline rõ ràng.',
  },
  {
    q: 'Rule Clarity Score là gì?',
    a: 'Điểm đánh giá mức độ rõ ràng của luật chơi (0–100%). Hệ thống tự động phân tích tên, mô tả, điều kiện thắng, luật hòa/hủy. Score >= 80% giúp giảm tranh chấp và tăng uy tín.',
  },
  {
    q: 'Tôi có thể chỉnh sửa challenge sau khi đăng?',
    a: 'Không thể chỉnh sửa sau khi có người tham gia. Bạn có thể hủy challenge (nếu chưa ai join) hoặc tạo challenge mới. Lưu thành Mode để tái sử dụng dễ dàng.',
  },
  {
    q: 'Trust Score được tính như thế nào?',
    a: 'Dựa trên: tỷ lệ hoàn thành challenge, số tranh chấp, đánh giá từ cộng đồng, tuổi tài khoản, và Fair Play history. Score cao = được ưu tiên hiển thị.',
  },
  {
    q: 'Tiền thưởng từ đâu mà có?',
    a: 'Pool thưởng = tổng entry points của tất cả người tham gia. Người thắng nhận pool theo tỷ lệ phân chia đã được cài đặt từ đầu (minh bạch 100%).',
  },
];
...
export const KEY_CONCEPTS = [
  {
    term: 'Arena Points',
    def: 'Đơn vị dùng trong Open Arena để tham gia challenge. Không phải tiền thật.',
  },
  { term: 'Template', def: 'Mẫu challenge có sẵn cấu trúc và luật — bạn chỉ cần điền nội dung.' },
  {
    term: 'Mode',
    def: 'Challenge template đã hoàn chỉnh, có thể chia sẻ và clone bởi người khác.',
  },
  { term: 'Resolution', def: 'Cách xác nhận kết quả: Auto, Mutual, Referee, hoặc Community Vote.' },
  {
    term: 'Trust Score',
    def: 'Điểm uy tín của creator dựa trên lịch sử tạo challenge và tỷ lệ tranh chấp.',
  },
  {
    term: 'Rule Clarity',
    def: 'Điểm đánh giá mức độ rõ ràng của luật chơi (0–100%). Càng cao càng ít tranh chấp.',
  },
  {
    term: 'Fair Play',
    def: 'Huy hiệu cho challenge/creator tuân thủ quy tắc cộng đồng. Tăng độ tin cậy.',
  },
];

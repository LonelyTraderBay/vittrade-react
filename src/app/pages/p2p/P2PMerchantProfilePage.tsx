      ...
      <PageContent>
        ...
        <div className="pt-5 pb-4">
          <div className="flex items-start gap-4">
            <div className="relative">
              ...
              >
                <span style={{ color: '#fff', fontSize: φ.lg, fontWeight: 700 }}>
                  {merchant.name.charAt(0)}
                </span>
              </div>
              <div
                className="absolute bottom-0 right-0 w-4 h-4 rounded-full border-2 flex items-center justify-center"
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <span style={{ color: c.text1, fontSize: φ.md, fontWeight: 700 }}>
                  {merchant.name}
                </span>
              ...
              <p style={{ color: c.text3, fontSize: 10 }}>
                ...
                Tham gia: {new Date(merchant.joinDate).toLocaleDateString('vi-VN')}
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-2 mt-4">
            ...
            <button
              onClick={() => navigate(`${prefix}/p2p/report/${merchantId}`)}
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          {[
            ...
            {
              label: 'Tổng GD',
              value: merchant.totalTrades.toLocaleString(),
              color: '#3B82F6',
              icon: TrendingUp,
            },
            {
              label: 'KL 30 ngày',
              value: fmtCompact(merchant.totalVolume30d, { prefix: '$' }),
              color: '#8B5CF6',
              icon: Zap,
            },
            {
          ...
          <TrCard rounded="sm" className="p-3">
            ...
            <div className="flex justify-between mt-1.5">
              <span style={{ color: c.text3, fontSize: 10 }}>
                <ThumbsUp size={9} className="inline mr-0.5" />
                {Math.round((merchant.totalTrades * merchant.positiveRate) / 100)} tích cực
              </span>
              <span style={{ color: c.text3, fontSize: 10 }}>
                <ThumbsDown size={9} className="inline mr-0.5" />
                {merchant.negativeCount} tiêu cực
              </span>
            </div>
          </TrCard>
        </div>
        ...
        <div key={tab} className="flex flex-col gap-3">
              ...
              <div key={ad.id}>
                <TrCard rounded="sm" className="p-3">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span
                        ...
                        style={{
                          background:
                            ad.type === 'sell' ? 'rgba(239,68,68,0.15)' : 'rgba(16,185,129,0.15)',
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span style={{ color: c.text3 }}>
                      Giới hạn: {fmtVnd(ad.minLimit)} - {fmtVnd(ad.maxLimit)}
                    </span>
                  </div>
                  <div className="flex items-center gap-1.5 mt-2">
                    {ad.paymentMethods.map((pm) => (
                      <span
                        ...
                        style={{ background: c.chipBg, color: c.chipText, fontSize: 9 }}
                      >
                        {pm}
                      </span>
                    ))}
                  ...
                  <button
                    ...
                    style={{
                      background:
                        ad.type === 'sell' ? 'rgba(16,185,129,0.1)' : 'rgba(239,68,68,0.1)',
                      color: ad.type === 'sell' ? '#10B981' : '#EF4444',
                      border: `1px solid ${ad.type === 'sell' ? 'rgba(16,185,129,0.2)' : 'rgba(239,68,68,0.2)'}`,
                    }}
                  >
          ...
          {tab === 'reviews' &&
            merchantReviews.map((review, idx) => (
              <div key={review.id}>
                <TrCard rounded="sm" className="p-3">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                        ...
                        style={{
                          background:
                            review.type === 'positive'
                              ? 'rgba(16,185,129,0.1)'
                              : 'rgba(239,68,68,0.1)',
                          color: review.type === 'positive' ? '#10B981' : '#EF4444',
                          fontSize: 9,
                        }}
                      >

...
const COMPLIANCE_ITEMS = [
  ...
  },
  {
    ...
    status: 'active',
    icon: DollarSign,
    path: '/p2p/compliance/source-of-funds',
  },
];
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: φ.xs }}>
                Tài khoản tuân thủ đầy đủ quy định
              </p>
            </div>
          </div>
        </TrCard>
          ...
          {COMPLIANCE_ITEMS.map((item, idx) => {
            ...
            return (
              <button
                ...
                style={{
                  borderBottom:
                    idx === COMPLIANCE_ITEMS.length - 1 ? 'none' : `1px solid ${c.borderSolid}`,
                }}
              >
                <div

...
const REQUIREMENTS = [
  {
    ...
    met: USER_STATS.accountAge >= 30,
    value: `${USER_STATS.accountAge} ngày`,
    icon: Clock,
  },
  {
    label: '>= 100 đơn hoàn thành',
    met: USER_STATS.totalTrades >= 100,
    value: `${USER_STATS.totalTrades} đơn`,
    icon: TrendingUp,
  },
  {
    label: 'Tỷ lệ HT >= 95%',
    met: USER_STATS.completionRate >= 95,
    value: `${USER_STATS.completionRate}%`,
    icon: Shield,
  },
  {
    label: 'KYC cấp 2+',
    met: USER_STATS.kycLevel >= 2,
    value: `Cấp ${USER_STATS.kycLevel}`,
    icon: BadgeCheck,
  },
  {
    label: '<= 2 tranh chấp',
    met: USER_STATS.disputes <= 2,
    value: `${USER_STATS.disputes} vụ`,
    icon: AlertTriangle,
  },
];
...
const BENEFITS = [
  {
    icon: Star,
    label: 'Huy hiệu Merchant',
    desc: 'Tăng uy tín & thứ hạng hiển thị',
    color: '#F59E0B',
  },
  { icon: Zap, label: 'Phí ưu đãi', desc: 'Giảm 50% phí giao dịch P2P', color: '#10B981' },
  {
    ...
    desc: 'Quảng cáo xuất hiện đầu danh sách',
    color: '#3B82F6',
  },
  ...
  return (
    <PageLayout>
      ...
      {!submitted && (
        <div
          className="px-5 py-3"
          style={{ background: c.surface, borderBottom: `1px solid ${c.divider}` }}
        >
          <div className="flex items-center justify-between mb-2">
            {STEPS.map((s, i) => (
              <div key={s} className="flex items-center">
                ...
                {i < STEPS.length - 1 && (
                  <div
                    className="w-4 h-0.5 mx-0.5 rounded-full -mt-4"
          ...
          {submitted ? (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p style={{ color: c.text2, fontSize: φ.sm, lineHeight: 1.6, maxWidth: 280 }}>
                  Đội ngũ VitTrade sẽ xem xét trong vòng 1-3 ngày làm việc. Bạn sẽ nhận thông báo
                  khi có kết quả.
                </p>
              </div>
              <TrCard className="w-full p-4">
                ...
                <div className="flex flex-col gap-2">
                  {['Nhận đơn đăng ký', 'Xác minh tài liệu', 'Đánh giá lịch sử', 'Phê duyệt'].map(
                    (s, i) => (
                      <div key={s} className="flex items-center gap-2.5">
                        ...
                        >
                          {i === 0 ? (
                            ...
                            <CircleDot size={10} color={c.text3} />
                          )}
                        </div>
                        <span
                          style={{
                            color: i === 0 ? '#10B981' : c.text3,
                            fontSize: 12,
                ...
                {BENEFITS.map((b, i) => (
                  ...
                  >
                    <TrCard className="p-3 h-full">
                      ...
                      <p style={{ color: c.text1, fontSize: 11, fontWeight: 700, marginBottom: 2 }}>
                        {b.label}
                      </p>
                  ...
                  {REQUIREMENTS.map((r, i) => (
                    ...
                    >
                      <div
                        ...
                        style={{
                          background: r.met ? 'rgba(16,185,129,0.12)' : 'rgba(239,68,68,0.12)',
                        }}
                      >
                        {r.met ? (
            ...
            >
              <div>
                ...
                <p style={{ color: c.text2, fontSize: φ.sm, lineHeight: 1.6 }}>
                  Cung cấp thông tin để xác minh tài khoản Merchant.
                </p>
              </div>
              ...
              <TrCard className="p-4 flex flex-col gap-4">
                <div>
                  <p style={{ color: c.text2, fontSize: 11, fontWeight: 600, marginBottom: 6 }}>
                    Tên doanh nghiệp / Tên hiển thị *
                  </p>
                  <InputField
                    placeholder="VD: CryptoTrader VN"
                    value={bizName}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Giới thiệu ngắn về hoạt động giao dịch của bạn..."
                    rows={3}
            ...
            >
              <div>
                ...
                <p style={{ color: c.text2, fontSize: φ.sm, lineHeight: 1.6 }}>
                  Tải lên các tài liệu cần thiết để xác minh.
                </p>
              </div>
              ...
              {[
                {
                  ...
                  desc: 'Ảnh 2 mặt rõ nét',
                  icon: FileText,
                  done: docId,
                  toggle: () => setDocId(!docId),
                  required: true,
                },
                {
                  label: 'Giấy phép kinh doanh',
                  desc: 'Bản scan hoặc ảnh chụp',
                  icon: Award,
                  done: docBiz,
                  toggle: () => setDocBiz(!docBiz),
                  required: false,
                },
                {
                  label: 'Ảnh selfie xác minh',
                  desc: 'Cầm CMND + giấy ghi ngày',
                  icon: Camera,
                  done: docSelfie,
                  toggle: () => setDocSelfie(!docSelfie),
                  required: true,
                },
              ].map((doc, i) => (
                <motion.div
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  <p style={{ color: '#3B82F6', fontSize: 10, lineHeight: 1.6 }}>
                    Tài liệu được mã hóa AES-256 và chỉ dùng cho mục đích xác minh. Tự động xóa sau
                    90 ngày.
                  </p>
                </div>
              </div>
            ...
            >
              <div>
                ...
                <p style={{ color: c.text2, fontSize: φ.sm, lineHeight: 1.6 }}>
                  Hệ thống tự động kiểm tra lịch sử giao dịch.
                </p>
              </div>
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    },
                    {
                      ...
                      value: `${(USER_STATS.volume30d / 1e6).toFixed(1)}M VND`,
                      color: '#3B82F6',
                      icon: TrendingUp,
                    },
                    {
                      label: 'Tranh chấp',
                      value: `${USER_STATS.disputes}`,
                      color: USER_STATS.disputes <= 2 ? '#10B981' : '#EF4444',
                      icon: AlertTriangle,
                    },
                  ].map((stat, i) => (
                    <motion.div
                    ...
                    >
                      ...
                      <span className="flex-1" style={{ color: c.text2, fontSize: 12 }}>
                        {stat.label}
                      </span>
                      <span
                        style={{
            ...
            >
              <div>
                ...
                <p style={{ color: c.text2, fontSize: φ.sm, lineHeight: 1.6 }}>
                  Kiểm tra lại thông tin trước khi nộp đơn đăng ký.
                </p>
              </div>
              ...
              <TrCard className="p-4">
                ...
                {[
                  ...
                  {
                    label: 'Tài liệu',
                    value: `${[docId, docBiz, docSelfie].filter(Boolean).length}/3 đã tải`,
                  },
                ].map((r) => (
                  <div
                    key={r.label}
              ...
              <button
                ...
                style={{
                  background: agreed ? 'rgba(16,185,129,0.06)' : c.surface2,
                  border: `1.5px solid ${agreed ? 'rgba(16,185,129,0.3)' : c.borderSolid}`,
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${agreed ? '#10B981' : c.text3}`,
                  }}
                >
                  {agreed && <CheckCircle size={11} color="#fff" />}
                </div>
                <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.6, textAlign: 'left' }}>
                  Tôi xác nhận thông tin là chính xác, đồng ý với{' '}
                  <span style={{ color: '#3B82F6', fontWeight: 600 }}>Điều khoản Merchant</span> và{' '}
                  <span style={{ color: '#3B82F6', fontWeight: 600 }}>Chính sách P2P</span> của
                  VitTrade. Tôi hiểu rằng vi phạm có thể dẫn đến thu hồi tư cách Merchant.
                </p>
              </button>
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  <p style={{ color: '#F59E0B', fontSize: 10, lineHeight: 1.6 }}>
                    Quá trình xét duyệt thường mất 1-3 ngày làm việc. Trong thời gian chờ, bạn vẫn

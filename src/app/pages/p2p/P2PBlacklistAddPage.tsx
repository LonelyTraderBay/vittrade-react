...
import { UserX, Ban, AlertTriangle, Clock, MessageSquare, Info } from 'lucide-react';
      ...
      <TrCard className="p-3" accentBorder="rgba(245,158,11,0.2)">
        <div className="flex items-start gap-2">
          ...
          <p style={{ color: '#F59E0B', fontSize: 11, lineHeight: 1.6 }}>
            Người bị chặn sẽ không thể giao dịch với bạn, gửi tin nhắn, hoặc xem quảng cáo của bạn.
            Bạn có thể bỏ chặn bất kỳ lúc nào.
          </p>
        </div>
      </TrCard>

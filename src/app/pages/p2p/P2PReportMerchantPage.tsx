...
const REPORT_REASONS = [
  {
    ...
    icon: AlertTriangle,
    color: '#EF4444',
    desc: 'Cố gắng lừa đảo hoặc chiếm đoạt tài sản',
  },
  {
    id: 'fake_payment',
    ...
    icon: Ban,
    color: '#EF4444',
    desc: 'Gửi biên lai giả hoặc thanh toán không hợp lệ',
  },
  {
    id: 'harassment',
    ...
    icon: MessageSquare,
    color: '#8B5CF6',
    desc: 'Ngôn ngữ xúc phạm, đe dọa trong giao tiếp',
  },
  {
    ...
    icon: DollarSign,
    color: '#F59E0B',
    desc: 'Cố tình đặt giá bất hợp lý để thao túng',
  },
  {
    id: 'identity',
    ...
    icon: Eye,
    color: '#3B82F6',
    desc: 'Sử dụng tài khoản người khác hoặc thông tin giả',
  },
  {
    id: 'other',
    label: 'Lý do khác',
    icon: Flag,
    color: '#6B7280',
    desc: 'Hành vi vi phạm quy định khác',
  },
] as const;
  ...
  return (
    <PageLayout>
      ...
      <div className="flex flex-col gap-2">
        ...
        <button
          onClick={() => {
            navigate(`${prefix}/p2p/merchant/${merchantId}`);
            hapticSelection();
          }}
          className="w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl"
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <p
                    style={{
                      color: selected ? reason.color : c.text1,
                      fontSize: 13,
                      fontWeight: 700,
                    }}
                  >
      ...
      <TrCard className="p-3">
        <div className="flex items-start gap-2">
          ...
          <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.6 }}>
            Báo cáo sẽ được đội ngũ VitTrade xem xét nghiêm túc. Báo cáo sai sự thật có thể ảnh
            hưởng đến tài khoản của bạn.
          </p>
        </div>
      </TrCard>

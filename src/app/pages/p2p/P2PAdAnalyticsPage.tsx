  ...
  return (
    ...
    >
      <TrCard className="p-3">
        ...
        {sub && <p style={{ color: c.text3, fontSize: 9, marginTop: 2 }}>{sub}</p>}
      </TrCard>
    </motion.div>
  );
}
        ...
        return (
          <div key={d.hour} className="flex flex-col items-center gap-0.5">
            <div
              ...
              style={{
                background:
                  intensity > 0 ? `rgba(16,185,129,${0.1 + intensity * 0.7})` : c.surface2,
                minHeight: 16,
              }}
              title={`${d.hour}:00 — ${d.orders} đơn`}
            />
            {d.hour % 3 === 0 && <span style={{ color: c.text3, fontSize: 7 }}>{d.hour}h</span>}
          </div>
        );
      })}
    </div>
        ...
        <div key={s.label}>
          <div className="flex items-center justify-between mb-1">
            ...
            <div className="flex items-center gap-2">
              <span
                style={{ color: c.text1, fontSize: 10, fontWeight: 700, fontFamily: 'monospace' }}
              >
  ...
  const funnelStages = useMemo(() => {
    ...
    return [
      { label: 'Lượt xem', value: analytics.impressions, color: '#3B82F6', pct: 100 },
      {
        ...
        color: '#8B5CF6',
        pct: (analytics.clicks / base) * 100,
      },
      {
        label: 'Đơn tạo',
        value: analytics.ordersCreated,
        color: '#F59E0B',
        pct: (analytics.ordersCreated / base) * 100,
      },
      {
        label: 'Hoàn thành',
        value: analytics.ordersCompleted,
        color: '#10B981',
        pct: (analytics.ordersCompleted / base) * 100,
      },
    ];
  }, [analytics]);
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <span
                    ...
                    style={{
                      background:
                        ad.type === 'sell' ? 'rgba(239,68,68,0.12)' : 'rgba(16,185,129,0.12)',
              ...
              <div className="flex items-center gap-1">
                {[0.2, 0.4, 0.6, 0.8].map((o) => (
                  <div
                    key={o}
                    className="w-3 h-3 rounded-sm"
                    style={{ background: `rgba(16,185,129,${0.1 + o * 0.7})` }}
                  />
                ))}
              </div>
              <div className="flex items-center gap-1.5">
            ...
            >
              <div className="grid grid-cols-4 px-3 py-2" style={{ background: c.surface2 }}>
                ...
                <span
                  ...
                  style={{ color: '#3B82F6', fontSize: 9, fontWeight: 600 }}
                >
                  Bạn
                </span>
                <span
                  className="text-center"
                  style={{ color: c.text3, fontSize: 9, fontWeight: 600 }}
                >
                  TB
                </span>
                <span
                  className="text-center"
                  style={{ color: '#10B981', fontSize: 9, fontWeight: 600 }}
                >
                  Top
                </span>
              </div>
              {analytics.competitorComparison.map((row, i) => (
                ...
                >
                  ...
                  <span
                    className="text-center"
                    style={{ color: '#10B981', fontSize: 9, fontFamily: 'monospace' }}
                  >
        ...
        >
          <TrCard className="p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span style={{ color: c.text1, fontSize: φ.sm, fontWeight: 700 }}>Gợi ý tối ưu</span>
            </div>
            <div className="flex flex-col gap-2.5">
              {[
                {

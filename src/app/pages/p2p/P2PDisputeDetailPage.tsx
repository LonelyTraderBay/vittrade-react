...
export function P2PDisputeDetailPage() {
  ...
  const dispute =
    P2P_DISPUTES.find((d) => d.orderId === disputeId || d.id === disputeId) || P2P_DISPUTES[0];
  ...
  const canEscalate =
    currentLevel < 4 && dispute.status !== 'resolved' && dispute.status !== 'rejected';
      ...
      <div className="flex-1 px-5 py-4 flex flex-col gap-4 pb-6">
        ...
        >
          ...
          <div className="flex-1">
            <p style={{ color: statusInfo.color, fontSize: φ.base, fontWeight: 700 }}>
              {statusInfo.label}
            </p>
        ...
        <TrCard className="p-4">
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        border: isActive
                          ? 'none'
                          : `1.5px solid ${isCompleted ? level.color : c.borderSolid}`,
                        minWidth: 36,
                        minHeight: 36,
                      }}
                    >
                      {isCompleted ? (
                        ...
                        <LevelIcon
                          size={14}
                          color={isActive ? '#fff' : isPending ? c.text3 : level.color}
                        />
                      )}
                    </div>
                    <span
          ...
          <div
            ...
            style={{
              background: `${currentLevelData.color}08`,
              border: `1px solid ${currentLevelData.color}15`,
            }}
          >
        ...
        <TrCard className="p-4">
          ...
          <div className="mt-3 pt-3" style={{ borderTop: `1px solid ${c.divider}` }}>
            <h4 style={{ color: c.text2, fontSize: φ.xs, fontWeight: 600, marginBottom: 4 }}>
              Mô tả chi tiết
            </h4>
          ...
          <div className="flex flex-wrap gap-2">
            {uploadedFiles.map((file, i) => (
              ...
              >
                ...
                <span
                  className="absolute bottom-1 left-1 right-1 text-center truncate"
              ...
              <div key={i} className="flex gap-3">
                <div className="flex flex-col items-center">
                  <div
                    ...
                    style={{
                      background: i === dispute.timeline.length - 1 ? '#3B82F6' : '#10B981',
                      border: `2px solid ${i === dispute.timeline.length - 1 ? 'rgba(59,130,246,0.3)' : 'rgba(16,185,129,0.3)'}`,
                    }}
                  />
        ...
        <TrCard overflow>
          ...
          <div
            className="px-4 py-3 flex flex-col gap-3 max-h-64 overflow-y-auto"
            ...
            {messages.map((msg, i) => (
              ...
              >
                ...
                >
                  ...
                  <p
                    style={{
                      color: msg.sender === 'user' ? '#fff' : c.text1,
                      fontSize: φ.sm,
                      lineHeight: 1.5,
                    }}
                  >
                  ...
                  <p
                    style={{
                      color: msg.sender === 'user' ? 'rgba(255,255,255,0.6)' : c.text3,
                      fontSize: 9,
                      marginTop: 2,
          ...
          >
            ...
            <button
              ...
              className="w-9 h-9 rounded-xl flex items-center justify-center"
              style={{
                background: supportMsg.trim() ? c.primary : c.surface2,
                minWidth: 36,
                minHeight: 36,
              }}
            >
        ...
        {dispute.resolution && (
          ...
          >
            <h3 style={{ color: '#10B981', fontSize: φ.sm, fontWeight: 700, marginBottom: 4 }}>
              Kết quả giải quyết
            </h3>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p style={{ color: c.text3, fontSize: 10 }}>
                      Chi tiết quyết định & quyền kháng cáo
                    </p>
                  </div>
                </div>
                <ChevronRight size={16} color={c.text3} />
        ...
        >
          <div
            className="rounded-2xl p-8 flex flex-col items-center gap-3 mb-4"
          ...
          <CTAButton onClick={handleUploadProof}>Tải lên (Demo)</CTAButton>
        </BottomSheetV2>
          ...
          {nextLevelData && (
            <div>
              <div className="flex flex-col items-center gap-3 mb-5">
                ...
                <h3
                  style={{ color: c.text1, fontSize: φ.base, fontWeight: 700, textAlign: 'center' }}
                >
              ...
              <div className="rounded-xl p-3 mb-4" style={{ background: c.surface2 }}>
                {[
                  {
                    label: 'Cấp hiện tại',
                    value: `Cấp ${currentLevel}: ${currentLevelData.labelVi}`,
                  },
                  {
                    label: 'Chuyển đến',
                    value: `Cấp ${currentLevel + 1}: ${nextLevelData.labelVi}`,
                    bold: true,
                  },
                  ...
                  >
                    ...
                    <span
                      style={{ color: c.text1, fontSize: φ.sm, fontWeight: row.bold ? 700 : 400 }}
                    >
                      {row.value}
                    </span>
                  </div>
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  <p style={{ color: '#D97706', fontSize: 11, lineHeight: 1.6 }}>
                    Sau khi chuyển cấp, bạn không thể quay lại cấp thấp hơn. Vui lòng cung cấp đầy
                    đủ bằng chứng để quá trình xử lý nhanh hơn.
                  </p>
                </div>
              </div>

              <CTAButton onClick={handleEscalate} variant="primary" disabled={isEscalating}>
                {isEscalating
                  ? 'Đang chuyển cấp...'
                  : `Xác nhận chuyển lên Cấp ${currentLevel + 1}`}
              </CTAButton>

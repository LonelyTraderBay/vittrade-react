...
export function P2PChatPage() {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setMessages((m) =>
        m.map((msg) => (msg.id === newMsg.id ? { ...msg, isRead: true, readAt: time } : msg)),
      );
    }, 1500);
  ...
  const handleSendImage = () => {
    ...
    setMessages((m) => [
      ...m,
      {
        id: `cm${Date.now()}`,
        sender: 'me',
        text: 'Ảnh chụp giao dịch',
        time,
        type: 'image',
        imageUrl: 'payment_proof.jpg',
        isRead: false,
      },
    ]);
    ...
    <PageLayout variant="flush">
      ...
      >
        ...
        <p style={{ color: '#EF4444', fontSize: 11 }}>
          Không chia sẻ thông tin cá nhân hay mật khẩu trong chat.
        </p>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-1">
                ...
                <span
                  style={{ color: '#10B981', fontSize: 8, fontWeight: 700, letterSpacing: 0.5 }}
                >
                  AES-256
                </span>
              </div>
        ...
        {messages.map((msg) => {
          ...
          return (
            <div key={msg.id} className={`flex ${isMe ? 'justify-end' : 'justify-start'} gap-2`}>
              {!isMe && (
                <div
                  className="w-7 h-7 rounded-full flex items-center justify-center shrink-0 self-end"
              ...
              <div style={{ maxWidth: '75%' }}>
                {msg.type === 'image' ? (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: isMe ? 'linear-gradient(135deg, #3B82F6, #1d4ed8)' : c.surface2,
                      }}
                    >
                      <div className="flex flex-col items-center gap-1">
                        <Camera size={24} color={isMe ? '#fff' : c.text3} />
                        <span
                          style={{ color: isMe ? 'rgba(255,255,255,0.8)' : c.text3, fontSize: 11 }}
                        >
                          Ảnh giao dịch
                        </span>
                      </div>
                  ...
                  >
                    <p style={{ color: isMe ? '#FFFFFF' : c.text1, fontSize: 14, lineHeight: 1.5 }}>
                      {msg.text}
                    </p>
                  </div>
                )}
                ...
                >
                  ...
                  {isMe && <CheckCheck size={12} color={msg.isRead ? '#3B82F6' : c.text3} />}
                </div>
              </div>
            </div>
          );
        ...
        {isTyping && (
          <div className="flex items-end gap-2">
            ...
            <div
              ...
              style={{ background: c.surface2, borderRadius: '20px 20px 20px 4px' }}
            >
      ...
      <div className="sticky bottom-0 z-10" style={{ background: c.bg }}>
        ...
        >
          ...
          <div className="flex-1 flex flex-col gap-0">
            ...
            <div
              className="flex items-end rounded-2xl px-4 py-2 min-h-[44px]"

  ...
  return (
    <PageLayout>
      <Header
        ...
        right={
          <button
            onClick={() => navigate(`${routePrefix}/p2p/dashboard`)}
            ...
            emptyState={
              <div className="flex flex-col items-center py-16 gap-4">
                ...
                <div className="text-center">
                  <p style={{ color: c.text2, fontSize: 15, fontWeight: 600, marginBottom: 4 }}>
                    Chưa có đơn hàng nào
                  </p>
                  <p style={{ color: c.text3, fontSize: 13 }}>
                    {activeTab === 'processing'
                      ? 'Bạn không có đơn đang xử lý'
                      : activeTab === 'disputed'
                        ? 'Không có đơn tranh chấp'
                        : 'Chưa có đơn hoàn tất'}
                  </p>
                </div>
                <button
                  onClick={() => navigate(`${routePrefix}/p2p`)}
                  ...
                  <TrCard
                    ...
                    onClick={() => {
                      if (order.status === 'disputed')
                        navigate(`${routePrefix}/p2p/dispute/detail/${order.id}`);

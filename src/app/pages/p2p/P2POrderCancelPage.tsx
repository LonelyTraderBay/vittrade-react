  ...
  return (
    <PageLayout>
      ...
      <div className="flex-1 px-5 py-5 flex flex-col gap-5">
        ...
        {/* Reason Selection */}
        <div>
          <p style={{ color: c.text1, fontSize: φ.base, fontWeight: 700, marginBottom: 12 }}>
            Lý do hủy
          </p>
        ...
        <TrCard className="p-3" accentBorder="rgba(245,158,11,0.2)">
          <div className="flex items-start gap-2">
            ...
            <div>
              <p style={{ color: '#D97706', fontSize: 11, fontWeight: 600, marginBottom: 2 }}>
                Lưu ý quan trọng
              </p>
              <p style={{ color: '#D97706', fontSize: 10, lineHeight: 1.6 }}>
                Hủy đơn sẽ giải phóng {fmtAmount(order.escrowAmount)} {order.asset} từ Escrow trả về
                merchant. Tỷ lệ hủy cao có thể bị giới hạn giao dịch.
              </p>
            </div>
          </div>
        </TrCard>

        ...
        >
          ...
          <div>
            ...
            <p style={{ color: c.text3, fontSize: 11, lineHeight: 1.5 }}>
              Mọi tranh chấp được xử lý qua hệ thống 4 cấp: AI tự động → Nhân viên hỗ trợ → Trọng
              tài → Ban giám đốc. Trung bình giải quyết trong 2-24 giờ.
            </p>
          </div>
        </div>
          ...
          {disputes.length === 0 ? (
            <TrCard className="p-8 flex flex-col items-center gap-2">
              ...
              <p style={{ color: c.text3, fontSize: 11 }}>
                Tất cả giao dịch P2P của bạn đều suôn sẻ
              </p>
            </TrCard>
          ) : (
              ...
              {disputes.map((dispute) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Reason */}
                    <p
                      style={{ color: c.text2, fontSize: 12, lineHeight: 1.5, marginBottom: 8 }}
        ...
        <TrCard variant="inner" className="p-4">
          ...
          <ol className="flex flex-col gap-1.5 pl-4" style={{ listStyleType: 'decimal' }}>
            {[
              ...
              <li key={i} style={{ color: c.text3, fontSize: 11, lineHeight: 1.5 }}>
                {step}
              </li>
            ))}
          </ol>

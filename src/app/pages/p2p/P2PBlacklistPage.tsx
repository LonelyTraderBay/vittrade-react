...
import {
  P2P_BLACKLIST,
  P2PBlacklistEntry,
  P2P_BLACKLIST_REASON_LABELS,
  P2P_BLACKLIST_REASON_COLORS,
} from '../../data/mockData';
...
export function P2PBlacklistPage() {
  ...
  const stats = useMemo(() => {
    ...
    const recent30d = entries.filter(
      (e) => Date.now() - new Date(e.blockedAt).getTime() < 30 * 86_400_000,
    ).length;
    ...
    <PageLayout>
      <Header
        ...
        right={
          <button
            onClick={() => {
              navigate(`${prefix}/p2p/blacklist/add`);
              hapticSelection();
            }}
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p style={{ color: c.text3, fontSize: 10 }}>
                {stats.recent30d} chặn trong 30 ngày qua
              </p>
            </div>
          </div>
          <div className="flex flex-wrap gap-2">
            {(Object.entries(stats.byReason) as [P2PBlacklistEntry['reason'], number][]).map(
              ([reason, count]) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span style={{ color, fontSize: 10, fontWeight: 600 }}>
                      {P2P_BLACKLIST_REASON_LABELS[reason]}
                    </span>
                    <span
                      className="px-1 rounded"
                      style={{ background: color + '1A', color, fontSize: 9, fontWeight: 700 }}
                    >
                      {count}
                    </span>
                  </div>
      ...
      >
        ...
        <div className="flex gap-1.5 overflow-x-auto pb-1" style={{ scrollbarWidth: 'none' }}>
          <button
            ...
            style={{
              background: reasonFilter === 'all' ? c.chipActiveBg : c.chipBg,
              color: reasonFilter === 'all' ? c.chipActiveText : c.chipText,
              border: `1px solid ${reasonFilter === 'all' ? c.chipActiveBorder : c.chipBorder}`,
              fontWeight: 700,
            }}
          >
            Tất cả ({entries.length})
          </button>
          {(Object.keys(P2P_BLACKLIST_REASON_LABELS) as P2PBlacklistEntry['reason'][]).map(
            (reason) => {
              const color = P2P_BLACKLIST_REASON_COLORS[reason];
              ...
              return (
                <button
                  ...
                  className="shrink-0 px-3 py-1.5 rounded-xl text-xs"
                  style={{
                    background: reasonFilter === reason ? color + '18' : c.chipBg,
                    color: reasonFilter === reason ? color : c.chipText,
                    border: `1px solid ${reasonFilter === reason ? color + '40' : c.chipBorder}`,
                    fontWeight: 700,
                  }}
                >
      ...
      {filtered.length === 0 ? (
        ...
        >
          ...
          <p style={{ color: c.text3, fontSize: 11, textAlign: 'center', maxWidth: 240 }}>
            {searchText
              ? `Không có người dùng nào khớp "${searchText}"`
          ...
          {!searchText && (
            ...
            >
              <div className="flex items-center gap-1.5 px-4">
                <Plus size={14} /> Thêm vào blacklist
              </div>
            </CTAButton>
          )}
        </motion.div>
            ...
            return (
              ...
              >
                <TrCard
                  ...
                  accentBorder={isExpanded ? reasonColor + '30' : undefined}
                >
                  <button
                    onClick={() => {
                  ...
                  >
                    ...
                    <div className="flex-1 text-left min-w-0">
                      <div className="flex items-center gap-1.5 mb-0.5">
                        ...
                        {entry.isVerified && (
                          <Shield size={10} color="#3B82F6" fill="rgba(59,130,246,0.2)" />
                        )}
                        {entry.badge && (
                          <span
                            ...
                            style={{
                              ...
                              color: entry.badge === 'elite' ? '#F59E0B' : '#8B5CF6',
                              fontSize: 8,
                              fontWeight: 700,
                            }}
                          >
                            {entry.badge === 'elite' ? 'Elite' : 'Pro'}
                          </span>
                        )}
                      </div>
                        ...
                        >
                          {entry.reasonText && (
                            <div
                              ...
                              style={{ background: reasonColor + '08' }}
                            >
                          ...
                          <div className="grid grid-cols-3 gap-2 mt-3">
                            ...
                            <div
                              ...
                              style={{ background: c.surface2 }}
                            >
                              <p style={{ color: c.text2, fontSize: 10, fontWeight: 600 }}>
                                {new Date(entry.blockedAt).toLocaleDateString('vi')}
                              </p>
                          ...
                          <div className="flex gap-2 mt-3">
                            ...
                            >
                              ...
                              <span style={{ color: c.text2, fontSize: 11, fontWeight: 700 }}>
                                Báo cáo
                              </span>
                            </button>
                          </div>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.6 }}>
                Người dùng bị chặn sẽ không thể tạo đơn với bạn, gửi tin nhắn, hoặc xem quảng cáo
                của bạn.
              </p>
            </div>
          </div>
        ...
        description={
          unblockTarget ? (
            <span>
              ...
              <span style={{ fontWeight: 700 }}>"{unblockTarget.username}"</span>?
            </span>
          ) : (
            ''
          )

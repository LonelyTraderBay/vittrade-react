        ...
        <div className="flex flex-col gap-4">
          <div className="rounded-2xl p-4 flex flex-col gap-1" style={{ background: c.surface2 }}>
            ...
            <BottomSheetRow
              ...
              value={`${fmtUsd(conversionFee)} (${CONVERSION_FEE_PCT}%)`}
            />
            <BottomSheetRow
              label="Nhận được"
      ...
      <PageContent grow gap="default">
        ...
        {selectedIds.size > 0 && (
          <TrCard className="p-4">
            ...
            <div className="flex justify-between text-xs" style={{ color: c.text3 }}>
              ...
              <span>
                Phí: {fmtUsd(conversionFee)} ({CONVERSION_FEE_PCT}%)
              </span>
            </div>
          </TrCard>
        )}
        ...
        >
          ...
          <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.6 }}>
            Số dư nhỏ dưới {fmtUsd(DUST_THRESHOLD)} có thể được chuyển đổi. Phí chuyển đổi:{' '}
            {CONVERSION_FEE_PCT}%. Giá dựa trên tỷ giá thị trường. Tài sản đang đóng băng hoặc trong
            lệnh không thể chuyển đổi.
          </p>
        </div>
      </PageContent>

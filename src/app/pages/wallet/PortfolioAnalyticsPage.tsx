...
function generatePortfolioHistory(period: string): { time: string; value: number; pnl: number }[] {
  ...
  for (let i = n; i >= 0; i--) {
    ...
    data.push({
      ...
      pnl: parseFloat((v - totalNow * 0.82).toFixed(2)),
    });
  }
  return data;
}
  ...
  if (active && payload && payload.length) {
    ...
    return (
      ...
      >
        ...
        <p style={{ color: c.text1, fontWeight: 700, fontFamily: 'monospace' }}>{fmtUsd(val)}</p>
      </div>
    );
  }
  return null;
      ...
      <PageContent gap="default">
        ...
        >
          ...
          <div className="flex items-end gap-3 mt-1">
            <span
              style={{ color: c.text1, fontSize: 28, fontWeight: 700, fontFamily: 'monospace' }}
            >
              {fmtUsd(totalUSD)}
            </span>
          </div>
          <div className="flex items-center gap-2 mt-1">
            ...
            >
              ...
              >
                {isPositive ? '+' : ''}
                {fmtUsd(Math.abs(totalReturn), { prefix: false })}
              </span>
          ...
          <div className="flex gap-3 mt-4">
            {[
              ...
              >
                ...
                <p
                  style={{ color: s.color, fontSize: 14, fontWeight: 700, fontFamily: 'monospace' }}
                >
                  {s.value}
                </p>
        ...
        <div className="flex rounded-2xl p-1 gap-1" style={{ background: c.surface2 }}>
          {[
            ...
            <button
              ...
              style={{
                background: view === v.id ? c.chipActiveBg : 'transparent',
                color: view === v.id ? c.chipActiveText : c.chipText,
              }}
            >
              <v.icon size={13} />
              {v.label}
            ...
            <TrCard className="p-4">
              ...
              {[
                ...
                },
                {
                  ...
                  value: fmtSignedUsd(totalReturn),
                  color: isPositive ? '#10B981' : '#EF4444',
                },
                {
                  label: 'Giá trị cao nhất',
                  value: fmtUsd(Math.max(...historyData.map((d) => d.value))),
                  color: c.text1,
                },
                {
                  label: 'Giá trị thấp nhất',
                  value: fmtUsd(Math.min(...historyData.map((d) => d.value))),
                  color: c.text1,
                },
              ...
              {USER_ASSETS.map((asset, i) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      borderBottom: i < USER_ASSETS.length - 1 ? `1px solid ${c.divider}` : 'none',
                    }}
                  >
                    <div
            ...
            <TrCard overflow>
              ...
              {pieData.map((d, i) => (
                <div
                  ...
                  style={{
                    borderBottom: i < pieData.length - 1 ? `1px solid ${c.divider}` : 'none',
                  }}
                >
                  ...
                  <span
                    style={{
                      color: USER_ASSETS[i]?.change24h >= 0 ? '#10B981' : '#EF4444',
                      fontSize: 12,
                      fontWeight: 600,
                    }}
                  >
                ...
                <div>
                  ...
                  <p style={{ color: c.text2, fontSize: 12, marginTop: 2, lineHeight: 1.5 }}>
                    ...
                    {pieData
                      ...
                      .toFixed(1)}
                    % danh mục. Cân nhắc đa dạng hóa để giảm rủi ro.
                  </p>
                </div>
              </div>
            </TrCard>
            ...
            <TrCard className="p-4">
              ...
              {TOP_PERFORMERS.map((p, i) => (
                <div
                  ...
                  style={{
                    borderBottom: i < TOP_PERFORMERS.length - 1 ? `1px solid ${c.divider}` : 'none',
                  }}
                >
                  <div
                  ...
                  >
                    <span style={{ color: p.color, fontSize: 9, fontWeight: 700 }}>
                      {p.symbol.slice(0, 3)}
                    </span>
                  </div>
                  <div className="flex-1">
            ...
            <TrCard className="p-4">
              ...
              {WORST_PERFORMERS.map((p, i) => (
                <div
                  ...
                  style={{
                    borderBottom:
                      i < WORST_PERFORMERS.length - 1 ? `1px solid ${c.divider}` : 'none',
                  }}
                >
                  <div
                    className="w-8 h-8 rounded-full flex items-center justify-center"

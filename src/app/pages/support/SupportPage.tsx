...
const FAQ_ITEMS = [
  {
    ...
    answer:
      'Vào mục Ví → Nạp tiền → Chọn loại coin và mạng → Copy địa chỉ ví → Chuyển coin vào địa chỉ đó',
  },
  {
  ...
  const renderTicket = (ticket: SupportTicket) => {
    ...
    return (
      <TrCard
        ...
        as="button"
        hover
        className="w-full p-4 mb-3 text-left"
      ...
      >
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            ...
            <h3 style={{ color: c.text1, fontSize: 14, fontWeight: 700 }}>{ticket.subject}</h3>
          </div>
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span style={{ color: c.text3, fontSize: 11 }}>Tạo lúc {ticket.createdAt}</span>
        </div>
        ...
        <div className="rounded-lg p-3" style={{ background: 'rgba(255,255,255,0.02)' }}>
          ...
          <p style={{ color: c.text1, fontSize: 12, lineHeight: 1.4 }}>{lastMessage.text}</p>
        </div>
      </TrCard>
    );
  };
      ...
      <PageContent gap="default" padding="none">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 mb-3">
            <button
              onClick={() => navigate(`${prefix}/support/help`)}
            ...
            <button
              onClick={() => navigate(`${prefix}/support/announcements`)}
              className="flex items-center gap-2 p-3 rounded-xl"
              style={{
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              href="mailto:support@vittrade.vn"
              className="flex items-center gap-2 p-3 rounded-xl"
              style={{
            ...
            <div className="contents">
              ...
              {tickets.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 gap-3">
                  ...
                  <p style={{ color: c.text3, fontSize: 14 }}>Chưa có ticket nào</p>
                </div>
              ) : (
                <div className="contents">
              ...
              {FAQ_ITEMS.map((item, index) => (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div
                      className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 transition-transform ${expandedFAQ === index ? 'rotate-180' : ''}`}

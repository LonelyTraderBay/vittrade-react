...
import { Search, Star, X, ArrowUpDown, BarChart3 } from 'lucide-react';
...
function MoversSidebar() {
  ...
  return (
    <div className="flex flex-col gap-4" style={{ width: 320 }}>
      ...
      >
        <div
          className="flex items-center gap-0 px-1 py-1 mx-4 mt-3 rounded-lg"
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div className="text-left">
                  ...
                  <span style={{ color: c.text3, fontSize: WEB_FONT.xs, marginLeft: 3 }}>
                    /{p.quoteAsset}
                  </span>
                </div>
              </div>
      ...
      <div
        ...
        style={{ background: c.surface, border: `1px solid ${c.border}` }}
      >
        <p style={{ color: c.text1, fontSize: WEB_FONT.base, fontWeight: 700, marginBottom: 12 }}>
          Thống kê thị trường
        </p>
        {[
          ...
          {
            label: 'Tăng / Giảm',
            value: `${CRYPTO_PAIRS.filter((p) => p.change24h > 0).length} / ${CRYPTO_PAIRS.filter((p) => p.change24h < 0).length}`,
          },
        ].map((s, i) => (
          <div
            key={s.label}
...
export function WebMarketListPage() {
  ...
  const filtered = useMemo(() => {
    ...
    list = [...list].sort((a, b) => {
      ...
      switch (sortKey) {
        case 'name':
          diff = a.baseAsset.localeCompare(b.baseAsset);
          break;
        case 'price':
      ...
      <Header
        ...
        right={
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate('/w/markets/watchlist')}
            ...
            <button
              onClick={() => navigate('/w/markets/heatmap')}
              className="web-cmd-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg transition-colors"
              style={{
                border: `1px solid ${c.border}`,
                fontSize: WEB_FONT.sm,
        ...
        <div className="flex-1 min-w-0">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      >
                        <span
                          style={{ color: pair.logoColor, fontSize: WEB_FONT.xs, fontWeight: 700 }}
                        >
          ...
          <div className="flex items-center justify-between mt-3 px-2">
            <span style={{ color: c.text3, fontSize: WEB_FONT.xs }}>
              Hiển thị {filtered.length} / {CRYPTO_PAIRS.length} cặp giao dịch
            </span>
          </div>
        </div>

...
export function WebPasskeySetupPage() {
  ...
  const handleBiometric = async () => {
    if (!newName.trim()) {
      setError('Vui lòng đặt tên cho passkey');
      return;
    }
    setError('');
  ...
  const handleDelete = async (id: string) => {
    if (!password) {
      setError('Nhập mật khẩu để xóa passkey');
      return;
    }
    setIsLoading(true);
            ...
            <>
                ...
                <div className="flex items-center gap-3" style={{ marginBottom: 14 }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: c.text3, fontSize: WEB_FONT.sm }}>
                      Sử dụng vân tay, khuôn mặt hoặc PIN thiết bị
                    </p>
                  </div>
                </div>
              ...
              <div style={card()}>
                ...
                {passkeys.length === 0 ? (
                  <div className="flex flex-col items-center" style={{ padding: '32px 0' }}>
                    ...
                    <p style={{ color: c.text2, fontSize: WEB_FONT.sm, marginBottom: 4 }}>
                      Chưa có passkey nào
                    </p>
                    <p style={{ color: c.text3, fontSize: WEB_FONT.xs }}>
                      Thêm passkey để đăng nhập nhanh hơn và an toàn hơn
                    </p>
                  </div>
                ) : (
                        ...
                        <div key={pk.id}>
                          ...
                          {isDeleting && (
                            ...
                            >
                              ...
                              >
                                Bạn sẽ không thể dùng passkey này để đăng nhập nữa. Nhập mật khẩu để
                                xác nhận.
                              </p>
                              <div
                                className="flex items-center"
              ...
              >
                ...
                <p style={{ color: c.text2, fontSize: WEB_FONT.xs, lineHeight: 1.5 }}>
                  ...
                  <span style={{ color: c.text1, fontWeight: 500 }}>FIDO2 / WebAuthn</span>. Khóa
                  riêng không bao giờ rời khỏi thiết bị của bạn — VitTrade chỉ lưu trữ khóa công
                  khai.
                </p>
              </div>
            </>
          ...
          {setupStep === 'naming' && (
            <div style={card()}>
              ...
              <div className="flex flex-col items-center" style={{ marginBottom: 24 }}>
                ...
                >
                  Đặt tên dễ nhận diện cho passkey này (ví dụ: "MacBook văn phòng" hoặc "Desktop
                  nhà")
                </p>
              </div>
              ...
              >
                ...
                <p style={{ color: c.text2, fontSize: WEB_FONT.xs, lineHeight: 1.5 }}>
                  Ở bước tiếp theo, trình duyệt sẽ yêu cầu xác nhận sinh trắc học (Touch ID /
                  Windows Hello / PIN). Đảm bảo thiết bị của bạn đã bật tính năng này.
                </p>
              </div>
          ...
          {setupStep === 'biometric' && (
            <div style={card()}>
              ...
              >
                ...
                >
                  Hãy xác nhận danh tính bằng Touch ID, Face ID, Windows Hello, hoặc PIN thiết bị
          ...
          {setupStep === 'success' && (
            <div style={card()}>
              <div className="flex flex-col items-center" style={{ paddingTop: 24 }}>
                ...
                >
                  Passkey <span style={{ fontWeight: 600, color: c.text1 }}>"{newName}"</span> đã
                  được thêm thành công. Bạn có thể sử dụng sinh trắc học để đăng nhập từ thiết bị
                  này.
                </p>
                ...
                >
                  ...
                  />
                  <p style={{ color: c.text2, fontSize: WEB_FONT.xs, lineHeight: 1.5 }}>
                    Giữ 2FA (Authenticator) luôn bật như lớp bảo vệ phụ. Passkey bổ sung cho 2FA,
                    không thay thế.
                  </p>
                </div>

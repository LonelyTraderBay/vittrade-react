...
const MOCK_ADDRESSES: WhitelistAddress[] = [
  ...
  {
    id: 'w5',
    label: 'Cold wallet BNB',
    coin: 'BNB',
    coinIcon: 'B',
    network: 'BEP-20',
    networkFull: 'BNB Chain (BEP-20)',
...
export function WebWithdrawalWhitelistPage() {
  ...
  const handleAdd = async () => {
    if (!newLabel.trim()) {
      setAddError('Nhập tên gợi nhớ');
      return;
    }
    if (!newAddress.trim()) {
      setAddError('Nhập địa chỉ ví');
      return;
    }
    if (newAddress.trim().length < 20) {
      setAddError('Địa chỉ ví không hợp lệ');
      return;
    }
    setAddError('');
    setAddLoading(true);
  ...
  const handleDelete = async () => {
    if (!delPassword) {
      setDelError('Nhập mật khẩu');
      return;
    }
    if (delOtp.length < 6) {
      setDelError('Nhập mã 2FA 6 chữ số');
      return;
    }
    setDelError('');
    setDelLoading(true);
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p style={{ color: c.text3, fontSize: WEB_FONT.xs }}>
              Bảo mật &gt; Whitelist địa chỉ rút tiền
            </p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div
            ...
            style={{
              padding: '4px 12px',
              borderRadius: 16,
              background: whitelistEnabled ? 'rgba(16,185,129,0.06)' : 'rgba(245,158,11,0.06)',
              border: `1px solid ${whitelistEnabled ? 'rgba(16,185,129,0.15)' : 'rgba(245,158,11,0.15)'}`,
            }}
          >
            {whitelistEnabled ? (
              <>
              ...
              <>
                ...
                <span style={{ color: '#F59E0B', fontSize: WEB_FONT.xs, fontWeight: 600 }}>
                  Đã tắt
                </span>
              </>
            )}
        ...
        <div className="flex flex-col" style={{ gap: 24 }}>
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.5 }}>
                  Bạn có thể rút tiền đến bất kỳ địa chỉ nào. Bật whitelist để chỉ cho phép rút đến
                  các địa chỉ đã xác minh, giảm rủi ro mất tài sản.
                </p>
              </div>
            </div>
          )}
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span style={{ color: c.text1, fontSize: WEB_FONT.md, fontWeight: 600 }}>
                  Whitelist rút tiền hoạt động thế nào?
                </span>
              </div>
              {expandedInfo ? (
              ...
              <div style={{ marginTop: 14 }}>
                <div className="flex flex-col" style={{ gap: 8 }}>
                  {[
                    {
                      icon: ShieldCheck,
                      text: 'Khi whitelist bật, bạn chỉ rút tiền đến các địa chỉ đã được phê duyệt',
                      color: '#10B981',
                    },
                    {
                      icon: Clock,
                      text: 'Địa chỉ mới thêm cần 24 giờ để kích hoạt (delay bảo mật)',
                      color: '#F59E0B',
                    },
                    { icon: Lock, text: 'Xóa địa chỉ yêu cầu mật khẩu + mã 2FA', color: '#EF4444' },
                    {
                      icon: AlertTriangle,
                      text: 'Nếu tắt whitelist, bất kỳ ai truy cập tài khoản đều có thể rút tài sản',
                      color: '#EF4444',
                    },
                  ].map((item, i) => (
            ...
            <>
              ...
              <div className="flex items-center" style={{ gap: 10 }}>
                ...
                >
                  ...
                  <input
                    type="text"
                    placeholder="Tìm theo tên, coin, địa chỉ..."
                    value={search}
                ...
                {filtered.length === 0 ? (
                  <div className="flex flex-col items-center" style={{ padding: '32px 0' }}>
                    ...
                    <p style={{ color: c.text3, fontSize: WEB_FONT.xs, marginTop: 4 }}>
                      Thêm địa chỉ rút tiền để bảo vệ tài sản
                    </p>
                  </div>
                ) : (
                          ...
                          <div className="flex items-center" style={{ padding: '14px 0', gap: 14 }}>
                            ...
                            <div
                              ...
                              style={{
                                ...
                                border: `1px solid ${coinColor}20`,
                              }}
                            >
                              <span style={{ color: coinColor, fontSize: 16, fontWeight: 700 }}>
                                {addr.coinIcon}
                              </span>
                            </div>
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2" style={{ marginBottom: 3 }}>
                                <p
                                  style={{ color: c.text1, fontSize: WEB_FONT.md, fontWeight: 500 }}
                                >
                                  {addr.label}
                                </p>
                                <span
          ...
          {viewMode === 'add' && !addSuccess && (
            <div style={card()}>
              ...
              >
                Thêm địa chỉ rút tiền
              </h2>
              <p
                style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.5, marginBottom: 24 }}
              >
                Địa chỉ mới sẽ cần <span style={{ color: '#F59E0B', fontWeight: 600 }}>24 giờ</span>{' '}
                để kích hoạt. Đây là biện pháp bảo mật để bảo vệ tài sản.
              </p>
              ...
              <div className="flex flex-col" style={{ gap: 18 }}>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="VD: Ledger chính, Metamask ETH..."
                    value={newLabel}
                    onChange={(e) => {
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ color: c.text2, fontSize: WEB_FONT.xs, lineHeight: 1.5 }}>
                      Đảm bảo địa chỉ đúng coin và đúng network. Gửi nhầm coin hoặc sai network có
                      thể làm <strong>mất vĩnh viễn</strong> tài sản.
                    </p>
                  </div>
                </div>
          ...
          {viewMode === 'add' && addSuccess && (
            <div style={card()}>
              <div className="flex flex-col items-center" style={{ padding: '24px 0' }}>
                ...
                >
                  Địa chỉ mới sẽ được kích hoạt sau{' '}
                  <span style={{ color: '#F59E0B', fontWeight: 600 }}>24 giờ</span>. Bạn sẽ nhận
                  thông báo khi địa chỉ sẵn sàng sử dụng.
                </p>
          ...
          {viewMode === 'delete-confirm' && deleteTarget && (
            <div style={card()}>
              ...
              <div className="flex flex-col items-center" style={{ marginBottom: 24 }}>
                ...
                >
                  Bạn sắp xóa địa chỉ{' '}
                  <span style={{ fontWeight: 600, color: c.text1 }}>"{deleteTarget.label}"</span>.
              ...
              >
                <div className="flex flex-col" style={{ gap: 6 }}>
                  <div className="flex justify-between">
                    <span style={{ color: c.text3, fontSize: WEB_FONT.sm }}>Coin / Network:</span>
                    <span style={{ color: c.text1, fontSize: WEB_FONT.sm, fontWeight: 500 }}>
                      {deleteTarget.coin} / {deleteTarget.network}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span style={{ color: c.text3, fontSize: WEB_FONT.sm }}>Địa chỉ:</span>
                    <code
                      style={{ color: c.text1, fontSize: WEB_FONT.xs, fontFamily: 'monospace' }}
                    >
                      {maskAddr(deleteTarget.address)}
                    </code>
                  </div>
                </div>
              </div>
              ...
              <div style={{ marginBottom: 14 }}>
                ...
                <input
                  ...
                  value={delOtp}
                  onChange={(e) => {
                    setDelOtp(e.target.value.replace(/\D/g, ''));
                    setDelError('');
                  }}
                  className="outline-none"
                  style={{
              ...
              {delError && (
                <div className="flex items-center gap-1.5" style={{ marginBottom: 12 }}>
                  <AlertTriangle size={13} color="#EF4444" />
                  <span style={{ color: '#EF4444', fontSize: WEB_FONT.sm }}>{delError}</span>
                </div>
              )}
              ...
              >
                Demo: nhập bất kỳ mật khẩu + 6 số bất kỳ
              </p>
            </div>
          )}
        </div>

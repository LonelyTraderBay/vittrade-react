...
type OrderStatus =
  'pending_payment' | 'payment_made' | 'pending_release' | 'completed' | 'cancelled' | 'disputed';
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          {order.merchantRating >= 4.5 && <Shield size={12} color="#10B981" />}
        </div>
      ...
      >
        <div style={{ color: c.text3, fontSize: WEB_FONT.SIZE.CAPTION }}>Phương thức</div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div
          ...
          style={{ color: '#3B82F6', fontSize: WEB_FONT.SIZE.CAPTION, fontWeight: 600 }}
        >
          Xem chi tiết
          ...
          <div className="p-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <div style={{ color: '#F59E0B', fontSize: 20, fontWeight: 800 }}>{activeCount}</div>
              </div>
              <div
                className="p-3 rounded-lg"
                style={{

...
import {
  ShieldCheck, ShieldAlert, Eye, EyeOff, CheckCircle,
  AlertTriangle, Info, ArrowLeft, Mail, Lock,
...
const SUGGESTED_CODES = [
  'VitSafe2024', 'MyTradeOK', 'SecureMe!', 'TrustVT#1',
];
  ...
  return (
    <PageLayout>
      ...
      >
        ...
        >
          {isEnabled
            ? <><CheckCircle size={13} color="#10B981" /><span style={{ color: '#10B981', fontSize: WEB_FONT.sm, fontWeight: 600 }}>Đã bật</span></>
            : <><ShieldAlert size={13} color="#F59E0B" /><span style={{ color: '#F59E0B', fontSize: WEB_FONT.sm, fontWeight: 600 }}>Chưa bật</span></>}
        </div>
      </div>
          ...
          <div className="flex flex-col" style={{ gap: 24 }}>
            ...
            <div style={card()}>
              <div className="flex items-center gap-3" style={{ marginBottom: 14 }}>
                <div
                  className="flex items-center justify-center"
                  style={{ width: 44, height: 44, borderRadius: 12, background: 'rgba(59,130,246,0.06)' }}
                >
                ...
                <div>
                  ...
                  <p style={{ color: c.text3, fontSize: WEB_FONT.sm }}>Thêm một lớp bảo vệ cho email từ VitTrade</p>
                </div>
              </div>
              <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.7 }}>
                Mã chống giả mạo (Anti-Phishing Code) là một chuỗi ký tự do bạn tự đặt.
                Mã này sẽ xuất hiện trong{' '}
                <span style={{ fontWeight: 600, color: c.text1 }}>mọi email chính thức</span>{' '}
                từ VitTrade. Nếu email không chứa mã này → đó là email giả mạo, không nên nhấn vào bất kỳ link nào.
              </p>

              <div className="flex flex-col" style={{ gap: 8, marginTop: 14, paddingTop: 14, borderTop: `1px solid ${c.borderSolid}` }}>
                {[
            ...
            {/* Input code */}
            <div style={card()}>
              <h3 style={{ color: c.text1, fontSize: WEB_FONT.md, fontWeight: 600, marginBottom: 4 }}>
              ...
              <div className="flex items-center" style={{ gap: 8, marginBottom: 8 }}>
                ...
                >
                  ...
                  >
                    {showCode ? <EyeOff size={15} color={c.text3} /> : <Eye size={15} color={c.text3} />}
                  </button>
                </div>
                <button
                  ...
                  style={{
                    width: WEB_BUTTON.lg, height: WEB_BUTTON.lg, borderRadius: 10,
                    background: c.bg, border: `1.5px solid ${c.borderSolid}`,
                    cursor: 'pointer',
                  }}
                >
              ...
              {code && !codeError && (
                <div style={{ marginBottom: 8 }}>
                    ...
                    {[0, 1, 2, 3].map(i => (
                      <div
                        ...
                        style={{
                          ...
                          background: i < codeStrength ? strengthColors[codeStrength] : c.borderSolid,
                  ...
                  {codeStrength > 0 && (
                    <span style={{ color: strengthColors[codeStrength], fontSize: WEB_FONT.xs, fontWeight: 500 }}>
              ...
              <div className="flex items-center justify-between" style={{ marginTop: 4 }}>
                ...
                {code && (
                  <button
                    ...
                    style={{ color: '#3B82F6', fontSize: WEB_FONT.xs, fontWeight: 500, background: 'none', border: 'none', cursor: 'pointer' }}
                  >
                    {copied ? <><Check size={11} /> Đã sao chép</> : <><Copy size={11} /> Sao chép</>}
                  </button>
                )}
              </div>
            </div>
            ...
            <button
              ...
              style={{
                ...
                background: (!code || !!codeError) ? c.surface2 : 'linear-gradient(135deg, #3B82F6 0%, #1d4ed8 100%)',
        ...
        {state === 'preview' && (
          <div className="flex flex-col" style={{ gap: 24 }}>
            <button
              ...
              style={{ gap: 6, color: c.text2, fontSize: WEB_FONT.sm, background: 'none', border: 'none', cursor: 'pointer' }}
            >
            ...
            >
              ...
              >
                <div
                  className="flex items-center justify-center shrink-0"
                  style={{ width: 40, height: 40, borderRadius: 10, background: 'linear-gradient(135deg, #3B82F6, #1d4ed8)' }}
                >
                  <Mail size={18} color="#fff" />
                </div>
                <div className="flex-1 min-w-0">
                  <p style={{ color: c.text1, fontSize: WEB_FONT.md, fontWeight: 600 }}>VitTrade Security</p>
              ...
              >
                ...
                <span style={{ color: '#10B981', fontSize: WEB_FONT.sm, fontWeight: 600 }}>
                  Mã chống giả mạo:{' '}
                  <span style={{
                    background: 'rgba(16,185,129,0.1)', padding: '2px 10px', borderRadius: 6,
              ...
              <div style={{ padding: '24px 20px', background: c.bg }}>
                <h3 style={{ color: c.text1, fontSize: WEB_FONT.lg, fontWeight: 700, marginBottom: 12 }}>
                  Đăng nhập mới được phát hiện
                </h3>
                <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.7, marginBottom: 16 }}>
                  Xin chào,<br /><br />
                  Chúng tôi phát hiện một lần đăng nhập mới vào tài khoản VitTrade của bạn từ thiết bị:
                </p>
                <div
                  style={{
                ...
                >
                  <div className="flex flex-col" style={{ gap: 6 }}>
                    <div className="flex justify-between">
                      ...
                      <span style={{ color: c.text1, fontSize: WEB_FONT.sm, fontWeight: 500 }}>Chrome trên macOS</span>
                    </div>
                    <div className="flex justify-between">
                      <span style={{ color: c.text3, fontSize: WEB_FONT.sm }}>Thời gian:</span>
                      <span style={{ color: c.text1, fontSize: WEB_FONT.sm, fontWeight: 500 }}>{new Date().toLocaleString('vi-VN')}</span>
                    </div>
                    <div className="flex justify-between">
                      <span style={{ color: c.text3, fontSize: WEB_FONT.sm }}>Vị trí:</span>
                      <span style={{ color: c.text1, fontSize: WEB_FONT.sm, fontWeight: 500 }}>Hà Nội, Việt Nam</span>
                    </div>
                  </div>
                </div>
                <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.7 }}>
              ...
              >
                <p style={{ color: c.text3, fontSize: WEB_FONT.xs, lineHeight: 1.5, textAlign: 'center' }}>
            ...
            >
              ...
              <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.5 }}>
                <span style={{ fontWeight: 600, color: c.text1 }}>Quan trọng:</span> Nếu nhận email từ VitTrade mà{' '}
                <strong>không có mã này</strong>, đó có thể là email giả mạo. Không nhấn vào bất kỳ link nào.
              </p>
            </div>
        ...
        {state === 'confirm' && (
          <div className="flex flex-col" style={{ gap: 24 }}>
            ...
            <div className="flex flex-col items-center" style={{ marginBottom: 8 }}>
              <div
                className="flex items-center justify-center"
                style={{ width: 64, height: 64, borderRadius: 18, background: 'rgba(59,130,246,0.06)', marginBottom: 16 }}
              >
              ...
              <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.5, textAlign: 'center', maxWidth: 380 }}>
            ...
            >
              ...
              <div>
                <p style={{ color: c.text2, fontSize: WEB_FONT.xs, marginBottom: 2 }}>Mã chống giả mạo</p>
                <p style={{ color: c.text1, fontSize: WEB_FONT.md, fontWeight: 600, fontFamily: 'monospace', letterSpacing: 1 }}>
                  {code}
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              >
                ...
                <button
                  ...
                  style={{ width: 28, height: 28, borderRadius: 6, background: 'none', border: 'none', cursor: 'pointer' }}
                >
                  {showPw ? <EyeOff size={15} color={c.text3} /> : <Eye size={15} color={c.text3} />}
                </button>
              </div>
              {error && (
            ...
            <button
              ...
              style={{
                height: WEB_BUTTON.lg, borderRadius: 10, width: '100%',
                background: (isLoading || !password) ? c.surface2 : 'linear-gradient(135deg, #3B82F6 0%, #1d4ed8 100%)',
                color: '#fff', fontSize: WEB_FONT.md, fontWeight: 600,
            ...
            {/* Demo hint */}
            <div className="flex items-center justify-center" style={{ padding: '6px 12px', borderRadius: 8, background: 'rgba(59,130,246,0.04)', border: '1px dashed rgba(59,130,246,0.2)' }}>
              <span style={{ color: c.text3, fontSize: WEB_FONT.xs }}>
          ...
          <div className="flex flex-col items-center" style={{ paddingTop: 32, gap: 24 }}>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: c.text2, fontSize: WEB_FONT.md, lineHeight: 1.5, maxWidth: 400 }}>
                ...
                <span style={{
                  ...
                  background: 'rgba(16,185,129,0.06)', padding: '2px 8px', borderRadius: 4,
                }}>
                  {code}
                </span>
            ...
            >
              ...
              <div className="flex flex-col" style={{ gap: 8 }}>
                {[
                  ...
                  <div key={i} className="flex items-start gap-2">
                    <CheckCircle size={13} color="#10B981" style={{ marginTop: 2, flexShrink: 0 }} />
                    <span style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.4 }}>{t}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex" style={{ gap: 12, width: '100%', maxWidth: 420 }}>
              ...
              <button
                ...
                className="flex items-center justify-center"
                style={{
                  height: WEB_BUTTON.lg, borderRadius: 10, padding: '0 24px',
                  background: c.surface, color: c.text1,
                  fontSize: WEB_FONT.md, fontWeight: 500,
                  cursor: 'pointer', border: `1.5px solid ${c.borderSolid}`,
                }}
              >
                Trang chủ
              </button>

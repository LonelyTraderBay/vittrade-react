...
function MarketInfoPanel({ pair }: { pair: (typeof CRYPTO_PAIRS)[0] }) {
  ...
  const stats: Array<{ label: string; value: string; color?: string }> = [
    ...
    { label: 'Vốn hóa FDV', value: fmtCompact(pair.marketCap * 1.15, { prefix: '$' }) },
    {
      ...
      value: `${fmtCompact(pair.marketCap / pair.price)} ${pair.baseAsset}`,
    },
    ...
    { label: 'Lowest 24h', value: `$${fmtPrice(pair.low24h)}` },
    {
      ...
      value:
        pair.baseAsset === 'BTC'
          ...
          : pair.baseAsset === 'ETH'
            ? '$4,891.70'
            : `$${fmtPrice(pair.price * 1.8)}`,
    },
    {
      label: 'From ATH',
      value: pair.baseAsset === 'BTC' ? '-8.4%' : pair.baseAsset === 'ETH' ? '-28.0%' : '-44.4%',
    },
  ];
      ...
      <div className="grid grid-cols-2 gap-0">
        {stats.map((s, i) => (
          <div
            ...
            style={{
              borderBottom: i < stats.length - 2 ? `1px solid ${c.divider}` : 'none',
    ...
    <div className="rounded-xl" style={{ background: c.surface, border: `1px solid ${c.border}` }}>
      ...
      <div className="px-5 py-4">
        <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.7 }}>
          {descriptions[pair.baseAsset] ||
            `${pair.baseAsset} là một tài sản kỹ thuật số trên thị trường cryptocurrency. Xem thông tin chi tiết trên trang token info.`}
        </p>
...
export function WebPairDetailPage() {
  ...
  const relatedPairs = CRYPTO_PAIRS.filter(
      ...
      <div className="flex gap-6 py-6 px-6" style={{ maxWidth: 1200 }}>
            ...
            <div className="flex items-center gap-4">
              <div
                ...
                style={{
                  ...
                  border: `1px solid ${pair.logoColor}30`,
                }}
              >
                <span style={{ color: pair.logoColor, fontSize: 14, fontWeight: 700 }}>
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span
                    ...
                    style={{ background: c.hoverBg, color: c.text3 }}
                  >
                    {pair.category}
                  </span>
                </div>
        ...
        <div className="flex flex-col gap-4" style={{ width: 320, flexShrink: 0 }}>
          ...
          <div
            ...
            style={{ background: c.surface, border: `1px solid ${c.border}` }}
          >
            <p style={{ color: c.text1, fontSize: WEB_FONT.md, fontWeight: 700, marginBottom: 12 }}>
              Giao dịch {pair.baseAsset}
            </p>
            <div className="flex gap-3 mb-3">
              <button
                onClick={() => navigate(`${prefix}/trade/${pairId}?side=buy`)}
              ...
              {relatedPairs.map((p, i) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      borderBottom: i < relatedPairs.length - 1 ? `1px solid ${c.divider}` : 'none',
                    }}
                  >
                    <div
                    ...
                    >
                      <span style={{ color: p.logoColor, fontSize: 10, fontWeight: 700 }}>
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <span style={{ color: c.text3, fontSize: 10, marginLeft: 3 }}>
                        /{p.quoteAsset}
                      </span>
                    </div>
          ...
          {/* Token info link */}
          <button
            onClick={() => navigate(`${prefix}/pair/${pair.id}/info`)}

        ...
        {step === 0 && (
          <div>
            ...
            <div className="flex flex-col items-center" style={{ marginBottom: 28 }}>
              ...
              >
                Mở ứng dụng{' '}
                <span style={{ fontWeight: 600, color: c.text1 }}>Google Authenticator</span> hoặc{' '}
        ...
        {step === 2 && (
          <div>
            ...
            >
              ...
              />
              <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.5 }}>
                Mỗi mã chỉ dùng được{' '}
                <span style={{ fontWeight: 600, color: '#EF4444' }}>1 lần</span>. Không chia sẻ mã
                với bất kỳ ai. Lưu ở nơi an toàn ngoại tuyến.
              </p>
            </div>

...
const DRAWDOWN_DATA = [
  { date: '2025-09-01', dd: 0 },
  { date: '2025-09-15', dd: -2.1 },
  { date: '2025-10-01', dd: 0 },
  { date: '2025-10-15', dd: -4.5 },
  { date: '2025-11-01', dd: 0 },
  { date: '2025-11-15', dd: -1.8 },
  { date: '2025-12-01', dd: 0 },
  { date: '2025-12-15', dd: -3.2 },
  { date: '2026-01-01', dd: 0 },
  { date: '2026-01-15', dd: -2.7 },
  { date: '2026-02-01', dd: 0 },
  { date: '2026-02-15', dd: -1.4 },
  { date: '2026-03-01', dd: 0 },
  { date: '2026-03-08', dd: -0.8 },
];
const MONTHLY_DATA = [
  { month: 'Sep', ret: 4.5 },
  { month: 'Oct', ret: 7.2 },
...
function MetricBox({
  ...
  return (
    <div style={{ background: c.surface2, borderRadius: 10, padding: '12px 14px' }}>
      ...
      {sub && (
        <p style={{ color: c.text3, fontSize: WEB_FONT.xs, margin: 0, marginTop: 2 }}>{sub}</p>
      )}
    </div>
  );
}
    ...
    return (
      <PageLayout>
        ...
        <div className="flex flex-col items-center justify-center" style={{ padding: '80px 0' }}>
          ...
          <p
            style={{ color: c.text1, fontSize: WEB_FONT['2xl'], fontWeight: 700, marginBottom: 8 }}
          >
            {progress}%
          </p>
    ...
    return (
      <PageLayout>
        <Header
          ...
          subtitle="Backtesting · Trading Bots"
          back
          action={{ icon: Download, onClick: () => toast.success('Đang xuất báo cáo...') }}
        />
        ...
        <div style={{ padding: '24px 0 40px' }}>
          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => {
                  toast.success('Chuyển đến tạo bot...');
                  navigate(-1);
                }}
                style={{
                  height: WEB_BUTTON.md,
                  ...
                  cursor: 'pointer',
                  border: 'none',
                  background: recommendation ? '#10B981' : c.primary,
                  color: '#fff',
                }}
              >
          ...
          >
            ...
            <MetricBox
              ...
              color="#10B981"
              sub={`${METRICS.totalTrades} giao dịch`}
            />
          </div>
              ...
              <ResponsiveContainer width="100%" height={220}>
                <AreaChart data={EQUITY_DATA}>
                  ...
                  <XAxis
                    ...
                    style={{ fontSize: 10 }}
                    tickLine={false}
                    tickFormatter={(v) => new Date(v).toLocaleDateString('vi', { month: 'short' })}
                  />
                  <YAxis
                    stroke={c.text3}
                    style={{ fontSize: 10 }}
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  {
                    label: 'Profit Factor',
                    value: METRICS.profitFactor.toString(),
                    color: '#10B981',
                  },
          ...
          >
            ...
            <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.6, margin: 0 }}>
              <span style={{ color: '#F59E0B', fontWeight: 700 }}>Lưu ý:</span> Hiệu suất quá khứ
              không đảm bảo kết quả tương lai. Giao dịch thực tế sẽ có slippage, phí và độ trễ không
              phản ánh trong backtest này. Dùng kết quả này làm tham khảo, không phải cam kết.
            </p>
          </div>
        </div>
      </PageLayout>
          ...
          <div className="flex flex-col" style={{ gap: 24 }}>
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        fontSize: WEB_FONT.md,
                        fontWeight: strategy === s.id ? 700 : 500,
                      }}
                    >
                      {s.name}
                    </span>
            ...
            >
              ...
              <div
                ...
                style={{
                  background: c.surface2,
                  border: `1.5px solid ${stratColor}33`,
          ...
          <div className="flex flex-col" style={{ gap: 16, position: 'sticky', top: 24 }}>
            ...
            >
              ...
              <div className="flex flex-col" style={{ gap: 12 }}>
                {[
                  {
                    label: 'Chiến lược',
                    value: STRATEGIES.find((s) => s.id === strategy)?.name || '',
                  },
                  { label: 'Cặp giao dịch', value: pair },
                  {
                    label: 'Khoảng thời gian',
                    value: DATE_RANGES.find((d) => d.id === range)?.label || '',
                  },
            ...
            <button
              ...
              style={{
                ...
                color: '#fff',
                boxShadow: `0 4px 16px ${stratColor}30`,
              }}
            >
            ...
            >
              <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.6, margin: 0 }}>
                Backtest sẽ mô phỏng chiến lược trên dữ liệu lịch sử. Thời gian xử lý phụ thuộc vào
                khoảng thời gian và độ phức tạp chiến lược.
              </p>
            </div>
          </div>
        </div>

...
function InputField({
  ...
  return (
    <div className="mb-4">
      <label style={{ color: c.text2, fontSize: WEB_FONT.SIZE.CAPTION, fontWeight: 600, marginBottom: 8, display: 'block' }}>
        {label}
      </label>
          ...
          >
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <ul style={{ margin: 0, paddingLeft: 16, color: c.text3, fontSize: 11, lineHeight: 1.6 }}>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul style={{ margin: 0, paddingLeft: 16, color: c.text2, fontSize: WEB_FONT.SIZE.CAPTION, lineHeight: 1.6 }}>

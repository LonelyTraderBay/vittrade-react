  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span style={{ color: c.text3, fontSize: WEB_FONT.sm, fontWeight: 500 }}>
      ...
      <div className="flex items-center gap-3 mt-5">
        {[
          ...
          return (
            ...
            >
              ...
              <span style={{ color: c.text2, fontSize: WEB_FONT.sm, fontWeight: 600 }}>
                {btn.label}
              </span>
            </button>
          );
        ...
        <button
          onClick={() => navigate('/w/wallet/portfolio-analytics')}
          className="web-cmd-btn flex items-center gap-2 px-4 py-2 rounded-lg transition-colors"
          style={{ border: `1px solid ${c.border}` }}
        >
        ...
        <button
          onClick={() => navigate('/w/wallet/address-book')}
          className="web-cmd-btn flex items-center gap-2 px-4 py-2 rounded-lg transition-colors"
          style={{ border: `1px solid ${c.border}` }}
        >
        ...
        <div className="grid gap-6" style={{ gridTemplateColumns: '1fr 360px' }}>
          ...
          >
            ...
            {filteredAssets.map((asset, i) => (
              <button
                key={asset.id}
                onClick={() => navigate(`/w/wallet/asset/${asset.id}`)}
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{
                      background: asset.logoColor + '15',
                      border: `1px solid ${asset.logoColor}25`,
                    }}
                  >
                    <span
                      style={{ color: asset.logoColor, fontSize: WEB_FONT.xs, fontWeight: 700 }}
                    >
                ...
                <div style={{ textAlign: 'right' }}>
                  <span
                    ...
                    style={{
                      background:
                        asset.change24h >= 0 ? 'rgba(16,185,129,0.1)' : 'rgba(239,68,68,0.1)',
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span style={{ color: c.text3, fontSize: WEB_FONT.sm, marginLeft: 4 }}>
                      {tx.asset}
                    </span>
                  </div>
                  <span

...
export function WebRegisterPage() {
  ...
  const validate = () => {
    ...
    else if (regType === 'email' && !EMAIL_RE.test(contact))
      e.contact = 'Định dạng email không hợp lệ';
        ...
        <div className="flex flex-col" style={{ gap: 18 }}>
              ...
              <div className="flex items-center gap-1.5" style={{ marginTop: 4 }}>
                {confirm === password ? (
                  ...
                  <>
                    ...
                    <span style={{ color: '#F59E0B', fontSize: WEB_FONT.xs }}>Chưa khớp...</span>
                  </>
                )}
              </div>
            )}
          ...
          >
            ...
            <span style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.5 }}>
              ...
              <span style={{ color: '#3B82F6', fontWeight: 500 }}>Chính sách bảo mật</span> của
              VitTrade.
            </span>
          </button>
          {errors.agreed && (

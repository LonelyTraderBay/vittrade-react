...
export function TradePage() {
  ...
  const orderTypeLabel =
    [...ORDER_TYPE_BASIC, ...ORDER_TYPE_ADVANCED].find((t) => t.id === orderTypeId)?.label ??
    'Giới hạn';
  ...
  return (
    <PageLayout>
      ...
      <BottomSheetV2 open={!!modifyOrderId} onClose={() => setModifyOrderId(null)} title="Sửa lệnh">
        {modifyOrderId &&
          (() => {
            ...
            return (
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <label
                    style={{ color: c.text2, fontSize: 12, marginBottom: 4, display: 'block' }}
                  >
                    Giá mới (USDT)
                  </label>
                  <div
                  ...
                  {modifyPrice !== order.price.toString() && (
                    <p style={{ color: '#F59E0B', fontSize: 11, marginTop: 2 }}>
                      Thay đổi: {fmtUsd(parseFloat(modifyPrice || '0') - order.price)} (
                      {(
                        ((parseFloat(modifyPrice || '0') - order.price) / order.price) *
                        100
                      ).toFixed(2)}
                      %)
                    </p>
      ...
      <div className="flex items-center justify-between px-5 pt-3 pb-2">
        <button
          onClick={() => setShowPairSwitcher(true)}
      ...
      {activeTab === 'order' && (
        <PageContent gap="default">
          ...
          <div className="flex items-center justify-between">
            ...
            <span
              style={{ color: c.text1, fontSize: 13, fontFamily: 'monospace', fontWeight: 600 }}
            >
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-2">
                      {SLIPPAGE_PRESETS.map((preset) => (
                        <button
                          ...
                          style={{
                            background:
                              slippage === preset.value ? preset.color + '15' : c.surface2,
                  ...
                  {amountNum > 0 && estimatedImpact > 0.5 && (
                    <div
                      ...
                      style={{
                        background:
                          estimatedImpact > 1 ? 'rgba(239,68,68,0.06)' : 'rgba(245,158,11,0.06)',
                      }}
                    >
                      <AlertTriangle
                        size={11}

                ...
                return (
                  <TrCard key={product.id} className="p-4">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <p
                          style={{ color: c.text1, fontSize: 14, fontWeight: 600, marginBottom: 2 }}
                        >
                          {product.name}
                        </p>
                      ...
                      <button
                        onClick={() =>
                          navigate(
                            `${prefix}/trade/copy-trading/target-market-definition/${product.id}`,
                          )
                        }
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {product.negativeTarget.map((target, idx) => (
                          <span
                            key={idx}
                            className="px-2 py-1 rounded text-[9px]"
                            style={{ background: c.sellAlpha10, color: c.error }}
                          >
                            {target}
                          </span>
                        ))}
                  ...
                  <TrCard key={channel} className="p-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p style={{ color: c.text1, fontSize: 13, fontWeight: 600 }}>{channel}</p>
                          <p style={{ color: c.text3, fontSize: 10, marginTop: 1 }}>

...
export function CopyConfirmationPage() {
  ...
  const pessimisticReturn = -0.1; // -10%
      ...
      <PageContent grow padding="default" gap="relaxed">
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: '#991B1B', fontSize: 12, lineHeight: 1.5 }}>
                Copy Trading là hoạt động đầu tư có rủi ro cao. Bạn có thể{' '}
                <strong>mất toàn bộ</strong> số tiền ${config.copyCapital.toFixed(0)} đã cam kết.
                Hiệu suất quá khứ của provider không đảm bảo kết quả tương lai. Chỉ đầu tư số tiền
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            >
              <span style={{ color: c.primary, fontSize: 18, fontWeight: 700 }}>
                {provider.avatar}
              </span>
            </div>
          ...
          <div className="p-4 rounded-xl" style={{ background: c.surface2 }}>
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span style={{ color: c.text1, fontSize: 13, fontWeight: 600 }}>
                  {config.copyMode === 'mirror'
                    ? 'Mirror Copy'
                    : config.copyMode === 'fixed'
                      ? `Fixed ${config.copyRatio}%`
                      : 'Smart Copy'}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  style={{
                    color: config.useCustomStopLoss ? '#EF4444' : c.text2,
                    fontSize: 13,
                    fontWeight: 600,
                  }}
                >
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  style={{
                    color: config.useCustomTakeProfit ? '#10B981' : c.text2,
                    fontSize: 13,
                    fontWeight: 600,
                  }}
                >
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  style={{
                    color: config.useTrailingStop ? c.primary : c.text2,
                    fontSize: 13,
                    fontWeight: 600,
                  }}
                >
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    <span style={{ color: c.text3, fontSize: 11 }}>
                      Trading fees (est. {estimatedMonthlyTrades} trades/month)
                    </span>
                    <span style={{ color: c.text2, fontSize: 12, fontWeight: 600 }}>
                      ${estimatedMonthlyTradingFees.toFixed(2)}
                    </span>
                  </div>
                  <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.3 }}>
        ...
        >
          ...
          >
            ...
            <ChevronDown
              ...
              className="transition-transform"
              style={{
                transform: expandedSection === 'scenarios' ? 'rotate(180deg)' : 'rotate(0deg)',
              }}
            />
          </button>
            ...
            <div className="px-4 pb-4" style={{ borderTop: `1px solid ${c.border}` }}>
              <div className="pt-4 space-y-3">
                ...
                >
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between items-center">
                      ...
                      <span style={{ color: '#166534', fontSize: 11, fontWeight: 600 }}>
                        +${optimistic.grossPnL.toFixed(0)}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span style={{ color: '#166534', fontSize: 10 }}>- Performance fee</span>
                      <span style={{ color: '#166534', fontSize: 11 }}>
                        -${optimistic.performanceFee.toFixed(0)}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span style={{ color: '#166534', fontSize: 10 }}>- Slippage</span>
                      <span style={{ color: '#166534', fontSize: 11 }}>
                        -${optimistic.slippageLoss.toFixed(0)}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span style={{ color: '#166534', fontSize: 10 }}>- Fixed fees</span>
                      <span style={{ color: '#166534', fontSize: 11 }}>
                        -${optimistic.fixedFees.toFixed(0)}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span style={{ color: '#10B981', fontSize: 14, fontWeight: 700 }}>
                        +${optimistic.netPnL.toFixed(0)} ({optimistic.netReturnPct.toFixed(1)}%)
                      </span>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span
                        style={{
                          color: realistic.netPnL >= 0 ? '#10B981' : '#EF4444',
                          fontSize: 14,
                          fontWeight: 700,
                        }}
                      >
                        {realistic.netPnL >= 0 ? '+' : ''}${realistic.netPnL.toFixed(0)} (
                        {realistic.netReturnPct.toFixed(1)}%)
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between items-center">
                      ...
                      <span style={{ color: '#991B1B', fontSize: 11, fontWeight: 600 }}>
                        ${pessimistic.grossPnL.toFixed(0)}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span style={{ color: '#991B1B', fontSize: 11 }}>
                        -${pessimistic.slippageLoss.toFixed(0)}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span style={{ color: '#991B1B', fontSize: 10 }}>- Fixed fees</span>
                      <span style={{ color: '#991B1B', fontSize: 11 }}>
                        -${pessimistic.fixedFees.toFixed(0)}
                      </span>
                    </div>
                    <div className="h-px my-1" style={{ background: '#EF4444' }} />
                    <div className="flex justify-between items-center">
                      <span style={{ color: '#991B1B', fontSize: 11, fontWeight: 700 }}>
                        P/L net
                      </span>
                ...
                <div className="p-2 rounded-lg" style={{ background: c.warningBg }}>
                  ...
                  >
                    <strong>Disclaimer:</strong> Đây chỉ là ước tính. Kết quả thực tế có thể tốt hơn
                    hoặc tệ hơn đáng kể.
                  </p>
                </div>
              </div>
        ...
        >
          ...
          <p style={{ color: '#991B1B', fontSize: 12, lineHeight: 1.5, marginBottom: 8 }}>
            {config.useCustomStopLoss ? (
              <>
                Với stop-loss {config.customStopLoss}%, bạn có thể mất tối đa{' '}
                <strong style={{ fontSize: 16 }}>${maxLossScenario.toFixed(0)}</strong>.
              </>
            ) : (
              <>
                Không có stop-loss riêng, bạn có thể{' '}
                <strong style={{ fontSize: 16 }}>
                  mất toàn bộ ${config.copyCapital.toFixed(0)}
                </strong>{' '}
                nếu provider có drawdown 100%.
              </>
            )}
          </p>
          {!config.useCustomStopLoss && (
            <div className="p-2 rounded-lg" style={{ background: '#FEE2E2' }}>
              <p style={{ color: '#991B1B', fontSize: 10, lineHeight: 1.4 }}>
                ⚠️ Bạn chưa đặt stop-loss riêng. Provider có Max DD{' '}
                {provider.maxDrawdown.toFixed(1)}%, nghĩa là trong quá khứ tài khoản đã giảm tối đa{' '}
                {provider.maxDrawdown.toFixed(1)}%.
              </p>
            </div>
          )}
        ...
        <PageSection label="Xác nhận & Đồng ý" accentColor="#EF4444">
          <div className="space-y-3">
            ...
            >
              ...
              <div className="flex-1">
                <p style={{ color: c.text1, fontSize: 12, lineHeight: 1.5 }}>
                  Tôi hiểu rằng Copy Trading có rủi ro cao và tôi có thể{' '}
                  <strong>mất toàn bộ vốn đầu tư</strong>. Hiệu suất quá khứ của provider không đảm
                  bảo lợi nhuận tương lai.
                </p>
              </div>
            </button>
            ...
            >
              ...
              <div className="flex-1">
                <p style={{ color: c.text1, fontSize: 12, lineHeight: 1.5 }}>
                  Tôi đã đọc và hiểu <strong>tất cả các khoản phí</strong> (platform fee, trading
                  fee, performance fee, slippage). Chi phí thực tế có thể cao hơn ước tính.
                </p>
              </div>
            </button>
            ...
            >
              ...
              <div className="flex-1">
                <p style={{ color: c.text1, fontSize: 12, lineHeight: 1.5 }}>
                  Tôi xác nhận rằng số tiền <strong>${config.copyCapital.toFixed(0)}</strong> là số
                  tiền tôi
                  <strong> có thể chấp nhận mất hoàn toàn</strong> mà không ảnh hưởng đến cuộc sống
                  tài chính của tôi.
                </p>
              </div>
            </button>
            ...
            >
              ...
              <div className="flex-1">
                <p style={{ color: c.text1, fontSize: 12, lineHeight: 1.5 }}>
                  ...
                  <span className="underline cursor-pointer" style={{ color: c.primary }}>
                    Điều khoản sử dụng
                  </span>{' '}
                  và{' '}
                  <span className="underline cursor-pointer" style={{ color: c.primary }}>
                    Chính sách Copy Trading
                  </span>
                  .
                </p>
              </div>
          ...
          <div className="flex gap-2 items-start">
            ...
            <div>
              ...
              <p style={{ color: c.primary, fontSize: 10, lineHeight: 1.4 }}>
                Đây là lần đầu bạn copy. Sau khi xác nhận, bạn có <strong>24 giờ</strong> để review
                lại quyết định trước khi copy chính thức kích hoạt.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                step: 1,
                title: 'Khóa vốn',
                desc: `$${config.copyCapital.toFixed(0)} sẽ được khóa trong tài khoản copy`,
                icon: Shield,
              },
              {
                step: 2,
                title: 'Thời gian chờ',
                desc: '24h cooling-off period (chỉ lần đầu)',
                icon: Clock,
              },
              {
                step: 3,
                title: 'Kích hoạt',
                desc: 'Sau 24h, copy tự động bắt đầu sao chép lệnh của provider',
                icon: Zap,
              },
              {
                step: 4,
                title: 'Theo dõi',
                desc: 'Bạn có thể xem real-time P/L và dừng copy bất cứ lúc nào',
                icon: Eye,
              },
            ].map((item) => {

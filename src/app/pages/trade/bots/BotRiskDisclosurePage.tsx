...
const RISK_CATEGORIES = [
  {
    ...
    color: '#EF4444',
    description:
      'Cryptocurrency markets are extremely volatile and can move rapidly against your positions.',
    examples: [
    ...
    mitigation:
      'Use stop-loss orders, diversify across assets, and never invest more than you can afford to lose.',
  },
  {
    id: 'leverage',
    icon: Zap,
    ...
    color: '#F59E0B',
    description:
      'Strategies that increase position size (like Martingale) can amplify losses exponentially.',
    examples: [
    ...
    mitigation:
      'Set strict maximum position size limits, use conservative multipliers, and monitor drawdown closely.',
  },
  {
    id: 'liquidity',
    icon: DollarSign,
    ...
    mitigation:
      'Trade liquid pairs (BTC/USDT, ETH/USDT), use limit orders, and split large orders into smaller chunks.',
  },
  {
    id: 'technical',
    icon: AlertTriangle,
    ...
    color: '#EF4444',
    description:
      'System bugs, network issues, or exchange downtime can cause unexpected bot behavior.',
    examples: [
    ...
    mitigation:
      'Enable emergency stop alerts, monitor bot activity regularly, and test strategies in demo mode first.',
  },
  {
    id: 'timing',
    icon: Clock,
    ...
    mitigation:
      'Account for realistic execution delays in backtests, avoid over-optimized strategies, and use VPS for stable connectivity.',
  },
  {
    id: 'regulatory',
    icon: Shield,
    ...
    mitigation:
      'Ensure compliance with local laws, keep detailed trade records, and consult a tax professional.',
  },
];
      ...
      <PageContent>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: c.text1, fontSize: 13, lineHeight: 1.7 }}>
                Trading Bots are <strong>complex financial products</strong> involving significant
                risk of loss. You may lose your entire investment. Only use capital you can afford
                to lose completely.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                ...
                <strong>do not guarantee future results</strong>. Market conditions change, and
                strategies that worked in the past may fail in the future. Always assume actual
                performance will be worse than backtests due to slippage, fees, and execution
                delays.
              </p>
            </div>
          </div>
              ...
              <TrCard key={risk.id} className="p-4">
                <div className="flex gap-3 mb-3">
                  ...
                  <div className="flex-1">
                    <p
                      style={{ color: risk.color, fontSize: 14, fontWeight: 700, marginBottom: 4 }}
                    >
                      {risk.title}
                    </p>
                    <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                ...
                <div className="rounded-xl p-3" style={{ background: c.surface2 }}>
                  ...
                  <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.5 }}>{risk.mitigation}</p>
                </div>
              </TrCard>
            ))}
          </div>
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  ...
                  <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>{warning.text}</p>
                </div>
              ))}
            </div>
          </TrCard>
        ...
        <PageSection label="Regulatory Notice">
          <TrCard className="p-4">
            ...
            <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6, marginBottom: 12 }}>
              Trading Bots are classified as <strong>complex financial products</strong> under
              European (MiFID II) and US (SEC) regulations. You must complete an appropriateness
              assessment to ensure you understand the risks before using this service.
            </p>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p style={{ color: c.text3, fontSize: 12, lineHeight: 1.5 }}>
                I understand that Trading Bots are high-risk, I may lose my entire investment, and
                past performance does not guarantee future results. I accept full responsibility for
        ...
        <div className="rounded-2xl p-4" style={{ background: c.surface2 }}>
          ...
          <p style={{ color: c.text3, fontSize: 12, lineHeight: 1.6, marginBottom: 8 }}>
            If you don't fully understand these risks, we recommend consulting a financial advisor
            before proceeding.
          </p>

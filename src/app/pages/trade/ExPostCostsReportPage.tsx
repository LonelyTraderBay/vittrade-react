...
export function ExPostCostsReportPage() {
  ...
  const totalEstimated =
    REPORT_2025.estimated.oneOff +
    REPORT_2025.estimated.recurring +
    REPORT_2025.estimated.incidental;
        ...
        >
          ...
          <div>
            ...
            <p style={{ color: c.success, fontSize: 10, lineHeight: 1.4, opacity: 0.9 }}>
              This report shows the actual costs you paid in {REPORT_2025.year}. Required by PRIIPs
              regulation.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            <TrCard className="p-4">
              ...
              {REPORT_2025.recurring < REPORT_2025.estimated.recurring && (
                <div className="rounded-lg p-2" style={{ background: c.buyAlpha10 }}>
                  <p style={{ color: c.success, fontSize: 9 }}>
                    ✓ €{REPORT_2025.estimated.recurring - REPORT_2025.recurring} lower than
                    estimated
                  </p>
                </div>
              )}
              ...
              {REPORT_2025.incidental > REPORT_2025.estimated.incidental && (
                <div className="rounded-lg p-2" style={{ background: c.warningBg }}>
                  <p style={{ color: c.warningText, fontSize: 9 }}>
                    ⚠ €{REPORT_2025.incidental - REPORT_2025.estimated.incidental} higher (better
                    performance)
                  </p>
                </div>
              )}

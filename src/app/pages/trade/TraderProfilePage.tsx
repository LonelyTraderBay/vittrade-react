          ...
          <div className="grid grid-cols-4 gap-3 mb-4">
            {[
              ...
              >
                ...
                <p
                  style={{ color: m.color, fontSize: 14, fontWeight: 700, fontFamily: 'monospace' }}
                >
                  {m.value}
                </p>
              </div>
            ...
            <div className="h-2 rounded-full" style={{ background: 'rgba(255,255,255,0.1)' }}>
              <div
                ...
                style={{
                  ...
                  width: `${(trader.copiers / trader.maxCopiers) * 100}%`,
                }}
              />
            </div>
          </div>
                ...
                <TrCard key={trade.id} className="p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="text-right">
                      ...
                      <p style={{ color: isProfit ? '#10B981' : '#EF4444', fontSize: 10 }}>
                        {fmtPct(trade.pnlPct)}
                      </p>
                    </div>
                  </div>
          ...
          <div className="mx-5 mt-4 flex flex-col gap-3">
            ...
            <TrCard className="p-4">
              ...
              <div className="flex items-center gap-3 mt-3">
                ...
                >
                  <div
                    style={{ width: `${trader.winRate}%`, background: '#10B981', height: '100%' }}
                  />
                  <div
                    style={{
              ...
              <div className="flex justify-between mt-2">
                <div className="flex items-center gap-1">
                  ...
                  <span style={{ color: c.text3, fontSize: 10 }}>
                    Thắng: {Math.round((trader.totalTrades * trader.winRate) / 100)}
                  </span>
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-2 h-2 rounded-full" style={{ background: '#EF4444' }} />
                  <span style={{ color: c.text3, fontSize: 10 }}>
                    Thua: {Math.round((trader.totalTrades * (100 - trader.winRate)) / 100)}
                  </span>
                </div>
              </div>
            </TrCard>
            ...
            <TrCard className="p-4">
              ...
              {[
                ...
                {
                  label: 'Copiers',
                  value: `${trader.copiers} / ${trader.maxCopiers}`,
                  color: c.primary,
                },
              ].map((row) => (
                <div

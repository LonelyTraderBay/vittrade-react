...
/** Leaderboard view of a provider — the shared mock dataset doesn't model verification yet. */
type LeaderboardTrader = (typeof COPY_TRADERS)[0] & { verified?: boolean };
...
export function ProviderLeaderboardPage() {
  ...
  const filteredProviders = useMemo(() => {
    let providers: LeaderboardTrader[] = [...COPY_TRADERS];
      ...
      <PageContent gap="relaxed">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {provider.verified && <CheckCircle size={12} color={c.primary} />}
                      <span
                    ...
                    <div className="flex items-center gap-1 mb-2">
                      ...
                      <span style={{ color: c.text3, fontSize: 10 }}>
                        {provider.copiers.toLocaleString()} followers
                      </span>
                    </div>
        ...
        <div className="p-3 rounded-xl" style={{ background: c.surface2 }}>
          <p style={{ color: c.text3, fontSize: 9, lineHeight: 1.5, textAlign: 'center' }}>
            Rankings dựa trên hiệu suất lịch sử và không đảm bảo kết quả tương lai. Provider xếp
            hạng cao vẫn có thể thua lỗ trong tương lai. Luôn đọc kỹ risk disclosure trước khi copy.
          </p>
        </div>
      </PageContent>
    </PageLayout>

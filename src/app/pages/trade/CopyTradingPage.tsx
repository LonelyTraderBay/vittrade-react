      ...
      <PageContent gap="relaxed">
        ...
        <div className="mt-2 mb-4">
          <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.5, textAlign: 'center' }}>
            Hiệu suất quá khứ không đảm bảo kết quả tương lai. Tất cả chỉ số mang tính tham khảo.
            Copy Trading có rủi ro cao, chỉ đầu tư với số tiền bạn có thể chấp nhận mất.
          </p>
        </div>
      </PageContent>
    </PageLayout>

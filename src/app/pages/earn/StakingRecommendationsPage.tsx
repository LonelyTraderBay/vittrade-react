...
const RECOMMENDATIONS: Recommendation[] = [
  {
    ...
    cons: ['APY thấp hơn chiến lược khác', 'Phụ thuộc stablecoin (USDT risk)'],
    bestFor: [
  ...
  },
  {
    ...
    cons: ['Rủi ro giá altcoin (ETH, SOL)', 'Liquid staking có depegging risk'],
    bestFor: [
  ...
  },
  {
    ...
    cons: ['Rủi ro smart contract (DeFi)', 'Chỉ 15% thanh khoản tức thì', 'Rủi ro giá altcoin cao'],
    bestFor: [
      'Experienced traders',
      'Số lượng nhỏ (&lt;$5,000)',
              ...
              {selectedStrategy.allocation.map((item, idx) => (
                <div key={idx} className="flex items-center justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <p style={{ color: c.text3, fontSize: 11 }}>APY: {item.apy}%</p>
                  </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                Dựa trên risk tolerance, investment horizon, và portfolio size của bạn, chúng tôi đề
                xuất chiến lược tối ưu.
              </p>
            </div>
          </div>
        </div>
                ...
                <TrCard key={idx} className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p style={{ color: c.text3, fontSize: 12, lineHeight: 1.5 }}>{tip.desc}</p>
                    </div>
                  </div>
                </TrCard>
              );
        ...
        >
          <div className="flex gap-2">
            ...
            <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
              <strong>Disclaimer:</strong> Đây chỉ là gợi ý dựa trên profile. Không phải tư vấn tài
              chính. Bạn nên tự nghiên cứu (DYOR) và chịu trách nhiệm cho quyết định đầu tư. APY có

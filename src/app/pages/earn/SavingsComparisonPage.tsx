...
function ProductChip({ product, onRemove }: { product: SavingsProduct; onRemove: () => void }) {
  const c = useThemeColors();
  return (
    <div
      ...
      <PageContent gap="default">
        ...
        {selectedProducts.length >= 2 && (
          <PageSection label="So sánh chi tiết" accentColor="#10B981">
            <TrCard className="overflow-hidden">
              ...
              <ComparisonRow
                ...
                values={selectedProducts.map((p) => (
                  <span
                    ...
                    style={{
                      color:
                        p.minAmount === lowestMin && selectedProducts.length > 1
                          ? '#10B981'
                          : c.text1,
                      fontWeight:
                        p.minAmount === lowestMin && selectedProducts.length > 1 ? 700 : 500,
              ...
              <ComparisonRow
                label="Trả lãi"
                values={selectedProducts.map((p) => PRODUCT_DETAILS[p.id]?.interestPayout ?? '—')}
              />
        ...
        {selectedProducts.length < 2 && (
          <TrCard className="p-6 text-center">
            ...
            <p style={{ color: c.text1, fontSize: 14, fontWeight: 600 }}>Chọn ít nhất 2 sản phẩm</p>
        ...
        >
          ...
          <span style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
            ...
            không phải cam kết lợi nhuận. Vui lòng đọc kỹ điều khoản từng sản phẩm trước khi đăng
            ký.
          </span>
        </div>
      </PageContent>

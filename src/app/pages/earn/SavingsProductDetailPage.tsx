      ...
      >
        <div className="flex flex-col gap-5">
          ...
          <div
            ...
            style={{
              background: `linear-gradient(145deg, ${product.color}${ALPHA.muted} 0%, ${product.color}${ALPHA.ghost} 100%)`,
              border: `1px solid ${product.color}${ALPHA.soft}`,
            }}
          >
            <div className="flex items-center gap-3 p-4 pb-3">
              <div
                ...
                style={{
                  background: product.color + ALPHA.soft,
                  border: `2px solid ${product.color}${ALPHA.border}`,
                  boxShadow: `0 0 16px ${product.color}${ALPHA.muted}`,
                }}
              >
                <span
                  style={{
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label
                style={{ color: c.text1, fontSize: FONT_SCALE.sm, fontWeight: FONT_WEIGHT.medium }}
              >
                Số lượng
              </label>
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `${product.color}${ALPHA.muted}`,
                  border: `1px solid ${product.color}${ALPHA.soft}`,
                }}
              >
                <div
                ...
                >
                  <span style={{ color: product.color, fontSize: 7, fontWeight: FONT_WEIGHT.bold }}>
                    {product.asset[0]}
                  </span>
                </div>
                <span
            ...
            {amountNum > 0 && amountNum < product.minAmount && (
              ...
              >
                ...
                {fmtAmount(product.minAmount)} {product.asset}
              </p>
            )}
            {amountNum > balance && (
              <p
                ...
                style={{ color: c.error, fontSize: FONT_SCALE.xs }}
              >
                <AlertTriangle size={12} strokeWidth={ICON_STROKE.emphasis} /> Vượt quá số dư khả
                dụng
              </p>
            )}
            {/* Quick amount chips */}
          ...
          {product.type === 'locked' && (
            ...
            >
              ...
              <span style={{ color: c.text2, fontSize: FONT_SCALE.xs, lineHeight: 1.6 }}>
                ...
                hoặc sẽ mất lãi nếu rút trước hạn. Vui lòng đảm bảo bạn không cần sử dụng khoản tiền
                này trong{' '}
                <span style={{ fontWeight: FONT_WEIGHT.semibold }}>{product.lockDays} ngày</span>.
              </span>
            </div>
          )}
      ...
      <PageContent gap="relaxed" grow>
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            >
              <span style={{ color: product.color, fontSize: 9, fontWeight: FONT_WEIGHT.bold }}>
                {product.asset.slice(0, 3)}
              </span>
            </div>
            <span
          ...
          <p style={{ color: '#10B981', fontSize: 44, fontWeight: 800, lineHeight: 1 }}>
            {product.apy}%
          </p>
          ...
          <PageSection label="Dung lượng sản phẩm">
            <div className="flex justify-between mb-2">
              <span style={{ color: c.text3, fontSize: FONT_SCALE.xs }}>
                Đã đăng ký: {product.totalSubscribed}
              </span>
              <span
                style={{
                  color: c.text2,
            ...
            <div className="flex justify-between">
              <span style={{ color: c.text3, fontSize: FONT_SCALE.xs }}>
                Còn lại: {product.remainingQuota}
              </span>
              {capacity > 85 && (
                <span
                  style={{
          ...
          <PageSection label="Điều khoản & Rủi ro">
            <div className="flex flex-col gap-2">
              {[
                ...
                {
                  label: 'Phí rút',
                  value: product.type === 'flexible' ? 'Miễn phí' : 'Mất lãi nếu rút sớm',
                },
                {
                  label: 'Thời gian xử lý rút',
                  value: product.type === 'flexible' ? 'Tức thì' : 'T+1 (1 ngày làm việc)',
                },
        ...
        {/* Risk disclaimer */}
        <div
          className="flex items-start gap-2 rounded-xl p-3 mx-0"
          style={{ background: 'rgba(59,130,246,0.06)', border: '1px solid rgba(59,130,246,0.15)' }}
        >
          <Info size={ICON_SIZE.sm} color="#3B82F6" className="mt-0.5 shrink-0" />
          <span style={{ color: c.text2, fontSize: FONT_SCALE.xs, lineHeight: 1.6 }}>
            APY được tính dựa trên lãi suất hiện tại và có thể thay đổi. Sản phẩm tiết kiệm không
            phải là khoản đầu tư. Tài sản được bảo vệ bởi quỹ bảo hiểm nền tảng nhưng không được đảm
            bảo bởi chính phủ.
          </span>
        </div>

      ...
      <PageContent>
        ...
        >
          ...
          <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
            Download complete records for accounting, tax reporting, or personal analysis. All
          ...
          <div className="grid grid-cols-2 gap-3">
            {EXPORT_TYPES.map((type, idx) => (
              <TrCard
                ...
                hover
                className="p-3"
                onClick={() => toast.success(`Exporting ${type.name}...`)}
              >
        ...
        <div className="rounded-2xl p-4" style={{ background: c.surface2 }}>
          <p style={{ color: c.text3, fontSize: 11, lineHeight: 1.6, textAlign: 'center' }}>
            Exports are generated on-demand and available for download for 7 days. Large exports may
            take up to 5 minutes to process.
          </p>
        </div>
      </PageContent>
    </PageLayout>

...
const INITIAL_ALERTS: AlertSetting[] = [
  ...
  },
  {
    ...
    title: 'Sắp đáo hạn',
    description: 'Thông báo 7 ngày, 3 ngày và 24h trước khi sản phẩm Cố định đáo hạn',
    icon: Calendar,
    enabled: true,
    category: 'product',
    severity: 'critical',
  ...
  },
  {
    ...
    description: 'Thông báo khi có sản phẩm APY vượt trên 5% phù hợp hồ sơ rủi ro của bạn',
    icon: Zap,
    enabled: false,
    category: 'product',
    severity: 'info',
  ...
  // Transaction alerts
  {
    ...
    description: 'Thông báo khi lệnh đăng ký tiết kiệm được xử lý thành công',
  ...
  },
  {
    id: 'redeem-confirm',
    title: 'Xác nhận rút',
    description: 'Thông báo khi lệnh rút tiết kiệm được xử lý và tiền về ví',
  ...
  },
  {
    ...
    description: 'Thông báo khi lãi kép tự động được thực hiện thành công',
    icon: RefreshCw,
    enabled: true,
    category: 'transaction',
    severity: 'info',
  },
  {
    ...
    description: 'Thông báo khi bạn đạt milestone tiết kiệm (25%, 50%, 75%, 100%)',
    icon: Target,
    enabled: true,
    category: 'transaction',
    severity: 'important',
  ...
  // System alerts
  {
    ...
    description: 'Thông báo trước khi hệ thống bảo trì ảnh hưởng đến tiết kiệm',
    icon: Settings,
    enabled: true,
    category: 'system',
    severity: 'critical',
  ...
  },
  {
    ...
    description: 'Thông báo về chương trình khuyến mãi, APY boost, và ưu đãi đặc biệt',
    icon: Megaphone,
    enabled: false,
    category: 'system',
    severity: 'info',
...
const PRODUCT_ALERT_LABELS: Record<string, { label: string; icon: LucideIcon }> = {
...
export function SavingsNotificationPreferencesPage() {
  ...
  const toggleProductAlert = useCallback(
  ...
  const categoryAlerts = (cat: AlertSetting['category']) =>
  ...
  return (
    <PageLayout>
      ...
      <BottomSheetV2
        open={showDigestSheet}
        onClose={() => setShowDigestSheet(false)}
        ...
        <div className="flex flex-col gap-2">
          {DIGEST_OPTIONS.map((opt) => (
            <button
              key={opt.id}
              onClick={() => {
                setDigestFrequency(opt.id);
                hapticSelection();
                setShowDigestSheet(false);
              }}
      ...
      <BottomSheetV2
        open={showQuietSheet}
        onClose={() => setShowQuietSheet(false)}
        title="Giờ im lặng"
      >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p style={{ color: c.text3, fontSize: FONT_SCALE.xs }}>
                Tạm dừng thông báo trong khung giờ chỉ định
              </p>
            </div>
            <Toggle
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    >
                      Vẫn gửi cảnh báo quan trọng
                    </p>
                    <p style={{ color: c.text3, fontSize: FONT_SCALE.xs }}>
                      Bảo mật, bảo trì, đáo hạn
                    </p>
                  </div>
                </div>
                <Toggle
                  on={quietHours.allowCritical}
                  size="sm"
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p style={{ color: c.text2, fontSize: FONT_SCALE.xs }}>
              Thông báo sẽ áp dụng từ bây giờ.
            </p>
          </div>
      ...
      <TrCard variant="hero" rounded="lg" className="mx-5 mt-4 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            >
              {masterToggle ? (
                <Bell size={ICON_SIZE.md} color="#10B981" />
              ) : (
                <BellOff size={ICON_SIZE.md} color="#EF4444" />
              )}
            </div>
            <div>
              <p style={{ color: c.text1, fontSize: FONT_SCALE.sm, fontWeight: FONT_WEIGHT.bold }}>
        ...
        {!masterToggle && (
          ...
          >
            ...
            <p style={{ color: '#EF4444', fontSize: FONT_SCALE.xs, lineHeight: 1.5 }}>
              Tắt thông báo có thể khiến bạn bỏ lỡ cảnh báo đáo hạn, thay đổi APY và các sự kiện
              quan trọng.
            </p>
          </div>
        )}
      ...
      <div className="flex gap-2 mx-5 mt-3">
        ...
        <div className="flex-1 p-3 rounded-xl" style={{ background: c.surface2 }}>
          ...
          <p
            style={{
              color: quietHours.enabled ? '#8B5CF6' : c.text3,
              fontSize: FONT_SCALE.xs,
              fontWeight: FONT_WEIGHT.semibold,
            }}
          >
        ...
        <PageContent padding="compact" gap="default">
          ...
          >
            ...
            <p style={{ color: c.text2, fontSize: FONT_SCALE.xs, lineHeight: 1.5 }}>
              Tùy chỉnh thông báo cho từng sản phẩm đang ký. Chỉ áp dụng cho sản phẩm bạn đang có vị
              thế hoạt động.
            </p>
          </div>
            ...
            {productAlerts.map((prod) => {
              ...
              return (
                <TrCard key={prod.productId} className="overflow-hidden">
                  ...
                  <button
                    onClick={() => {
                      setExpandedProduct(isExpanded ? null : prod.productId);
                      hapticSelection();
                    }}
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: prod.color + '22',
                        border: `1.5px solid ${prod.color}44`,
                      }}
                    >
                      <span
                        style={{
      ...
      {tab === 'delivery' && (
        <PageContent padding="compact" gap="default">
          ...
          {/* Save CTA */}
          <CTAButton onClick={handleSave}>Lưu tất cả cài đặt</CTAButton>
        </PageContent>
      )}
    </PageLayout>
  );

...
const EARNINGS_TREND = [
  ...
  { date: '15/01', total: 2.1, cumulative: 2.1 },
  { date: '01/02', total: 5.8, cumulative: 7.9 },
  { date: '15/02', total: 9.45, cumulative: 17.35 },
  { date: '01/03', total: 18.2, cumulative: 35.55 },
...
export function SavingsPortfolioPage() {
  ...
  const weightedAPY =
    totalDeposited > 0 ? POSITIONS.reduce((s, p) => s + p.apy * p.usdValue, 0) / totalDeposited : 0;
  ...
  const flexibleTotal = POSITIONS.filter((p) => p.type === 'flexible').reduce(
    (s, p) => s + p.usdValue,
    0,
  );
  const lockedTotal = POSITIONS.filter((p) => p.type === 'locked').reduce(
    (s, p) => s + p.usdValue,
    0,
  );
          ...
          return (
            <PageSection label="Lịch đáo hạn" accentColor="#F59E0B">
              ...
              >
                ...
                >
                  Khi đáo hạn, bạn có thể gia hạn để tiếp tục nhận lãi hoặc rút về ví. Rút trước hạn
                  có thể mất lãi tích lũy.
                </span>
              </div>
            </PageSection>
          );
  ...
  const filteredPositions =
    posFilter === 'all' ? POSITIONS : POSITIONS.filter((p) => p.type === posFilter);
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: φRadius.lg,
          background:
            'linear-gradient(135deg, rgba(99,102,241,0.08) 0%, rgba(59,130,246,0.05) 50%, rgba(139,92,246,0.03) 100%)',
      ...
      >
        ...
        <div className="flex gap-2.5 relative z-10 mb-3">
          ...
          >
            <span
              style={{ color: c.text3, fontSize: FONT_SCALE.micro, fontWeight: FONT_WEIGHT.medium }}
            >
              Tổng vị thế
            </span>
            <span style={{ color: c.text, fontSize: FONT_SCALE.sm, fontWeight: FONT_WEIGHT.bold }}>
          ...
          >
            ...
            <span
              style={{ color: c.success, fontSize: FONT_SCALE.sm, fontWeight: FONT_WEIGHT.bold }}
            >
          ...
          >
            ...
            <span
              style={{ color: c.warning, fontSize: FONT_SCALE.sm, fontWeight: FONT_WEIGHT.bold }}
            >
            ...
            return (
              <TrCard key={pos.id} className="p-4">
                ...
                <div className="flex gap-2.5 pt-3" style={{ borderTop: `1px solid ${c.divider}` }}>
                  <button
                    onClick={() => {
                      navigate(`${prefix}/earn/savings/product/${pos.id}`);
                      hapticSelection();
                    }}
      ...
      {filteredPositions.length === 0 && (
        <div className="flex flex-col items-center gap-4 py-16">
          ...
          <div className="text-center">
            ...
            >
              Không có vị thế{' '}
              {posFilter === 'flexible' ? 'linh hoạt' : posFilter === 'locked' ? 'cố định' : ''} nào
            </p>
            <p
              style={{
                color: c.text3,
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: φRadius.lg,
          background:
            'linear-gradient(135deg, rgba(16,185,129,0.08) 0%, rgba(5,150,105,0.05) 50%, rgba(4,120,87,0.03) 100%)',
      ...
      >
        ...
        <p
          className="relative z-10"
          style={{ color: c.text3, fontSize: FONT_SCALE.micro, marginBottom: 2 }}
        >
      ...
      <PageSection label="Xu hướng lãi" accentColor="#10B981">
        <TrCard className="p-4">
          ...
          <div style={{ width: '100%', height: 160, marginBottom: 8 }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={EARNINGS_TREND} margin={{ top: 8, right: 8, bottom: 4, left: -20 }}>
                <ChartGradientDefs gradients={[CHART_GRADIENTS.green('savingsEarningsGrad')]} />
          ...
          >
            <span
              style={{ color: c.text3, fontSize: FONT_SCALE.xs, fontWeight: FONT_WEIGHT.medium }}
            >
              Lãi tích lũy
            </span>
            <span
      ...
      <PageSection label="Lãi hàng ngày (7 ngày gần nhất)" accentColor="#3B82F6">
        <TrCard className="p-4">
          ...
          >
            <span
              style={{ color: c.text, fontSize: FONT_SCALE.sm, fontWeight: FONT_WEIGHT.semibold }}
            >
              Tổng 7 ngày
            </span>
            <span
      ...
      >
        ...
        >
          Lãi suất APY là ước tính và có thể thay đổi tùy theo điều kiện thị trường. Số liệu hiển
          thị không bao gồm phí và thuế. Hiệu suất quá khứ không đảm bảo kết quả tương lai.
        </span>
      </div>
    </>
  );

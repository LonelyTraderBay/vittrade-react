...
export function SavingsNotificationsPage() {
  ...
  return (
    <PageLayout>
      ...
      <TabBar
        tabs={[
          { id: 'history', label: `Thông báo${unreadCount > 0 ? ` (${unreadCount})` : ''}` },
          ...
          <>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div style={{ color: c.text2, fontSize: FONT_SCALE.xs, lineHeight: 1.6 }}>
                    Tùy chỉnh thông báo để không bỏ lỡ sự kiện quan trọng. Đang bật {enabledCount}/
                    {settings.length} loại thông báo.
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <TrCard key={setting.id}>
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div
                                style={{ color: c.text3, fontSize: FONT_SCALE.xs, lineHeight: 1.4 }}
                              >
                                {setting.description}
                              </div>
                            </div>
            ...
            >
              ...
              <span style={{ color: '#3B82F6', fontSize: FONT_SCALE.micro, lineHeight: 1.4 }}>
                Thông báo quan trọng (đáo hạn, cảnh báo rủi ro) được khuyến nghị luôn bật. Bạn có
                thể quản lý thông báo push chung trong Cài đặt hệ thống.
              </span>
            </div>
          </>
        )}

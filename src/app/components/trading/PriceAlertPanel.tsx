    ...
    >
      ...
      {showForm ? (
        ...
        <div className="px-3.5 py-2" style={{ borderBottom: `1px solid ${panelBorder}` }}>
          <button
            onClick={() => {
              setShowForm(true);
              setTargetPrice(livePrice.toFixed(2));
            }}
      ...
      <div className="flex-1 overflow-y-auto scrollbar-none">
        {alerts.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 gap-2">
            ...
            <span style={{ color: c.text3, fontSize: 10, opacity: 0.6 }}>
              Tạo cảnh báo để được thông báo khi giá đạt mục tiêu
            </span>
          </div>
        ) : (
          <div>
            {triggeredCount > 0 && (
              ...
              >
                <span style={{ color: '#F59E0B', fontSize: 10, fontWeight: 600 }}>
                  Đã kích hoạt ({triggeredCount})
                </span>
                <button onClick={handleClearTriggered} style={{ color: c.text3, fontSize: 10 }}>
                  Xóa tất cả
                </button>
              </div>
            )}
                ...
                >
                  ...
                  >
                    {isTriggered ? (
                      ...
                      <ChevronUp size={11} color={dirColor} />
                    ) : (
                      <ChevronDown size={11} color={dirColor} />
                    )}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5">
                      <span
                        style={{
                          color: isTriggered ? '#F59E0B' : c.text1,
                          fontSize: 12,
                          fontWeight: 700,
                          fontVariantNumeric: 'tabular-nums',
                        }}
                    ...
                    {a.note && (
                      <span
                        style={{ color: c.text3, fontSize: 10, display: 'block', marginTop: 1 }}
                        className="truncate"
                      >
                        {a.note}
                      </span>
      ...
      {!showForm && alerts.length > 0 && (
        <div
          ...
          style={{ borderTop: `1px solid ${panelBorder}`, background: inputBg }}
        >

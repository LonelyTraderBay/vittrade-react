  ...
  return (
    <BottomSheetV2 open={open} onClose={handleClose} title="Chia sẻ & Mời bạn">
      ...
      <TrCard className="p-3 mb-4">
        <p style={{ color: c.text1, fontSize: φ.sm, fontWeight: 600 }} className="truncate mb-1">
          {challengeTitle}
        </p>
        <div className="flex items-center gap-3">
          <span
            style={{ color: '#F59E0B', fontSize: φ.xs, fontWeight: 600, fontFamily: 'monospace' }}
          >
            {entryPoints} pts
          </span>
          ...
          <span
            style={{
              color: openSlots > 0 ? '#10B981' : '#EF4444',
              fontSize: φ.xs,
              fontWeight: 600,
            }}
          >
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <span
              ...
              style={{ color: c.text1, fontSize: 11, fontFamily: 'monospace' }}
            >
              {deepLink}
            </span>
            <button
          ...
          {/* Share options grid */}
          <p style={{ color: c.text2, fontSize: φ.xs, fontWeight: 600, marginTop: 4 }}>
            Chia sẻ qua
          </p>
          <div className="grid grid-cols-4 gap-2">
            {[
              ...
              <button
                ...
                onClick={() => {
                  hapticSelection();
                  actionToast.success(`Đang mở ${app.label}...`);
                }}
          ...
          <TrCard className="p-3">
            ...
            <p style={{ color: c.text2, fontSize: φ.xs, lineHeight: 1.5, fontStyle: 'italic' }}>
              "Tham gia challenge "{challengeTitle}" trên Arena! 🎯 Entry: {entryPoints} pts. Còn{' '}
              {openSlots} slot. {deepLink}"
            </p>
          </TrCard>
        </div>
      )}
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.4 }}>
          {lastUpdated
            ? `Dữ liệu cập nhật lần cuối: ${lastUpdated}`
...
const DEFAULT_ARENA_NOTIF_PREFS: ArenaNotifPref[] = [
  {
    ...
    label: 'Cập nhật challenge',
    desc: 'Khi challenge bắt đầu, kết thúc, kết quả',
    icon: Trophy,
    color: '#F59E0B',
    enabled: true,
  },
  {
    key: 'your_turn',
    label: 'Đến lượt bạn',
    desc: 'Nhắc khi cần xác nhận kết quả',
    icon: Zap,
    color: '#8B5CF6',
    enabled: true,
  },
  {
    key: 'chat_messages',
    label: 'Tin nhắn chat',
    desc: 'Tin nhắn mới trong challenge',
    icon: MessageCircle,
    color: '#3B82F6',
    enabled: true,
  },
  {
    key: 'invites',
    label: 'Lời mời',
    desc: 'Khi bạn bè mời tham gia challenge',
    icon: Users,
    color: '#10B981',
    enabled: true,
  },
  {
    key: 'points_earned',
    label: 'Arena Points',
    desc: 'Khi nhận/mất Arena Points',
    icon: Trophy,
    color: '#F59E0B',
    enabled: false,
  },
  {
    ...
    desc: 'Tranh chấp, void, moderation',
    icon: Shield,
    color: '#EF4444',
    enabled: true,
  },
  ...
  return (
    <BottomSheetV2 open={open} onClose={onClose} title="Thông báo Arena">
      ...
      <TrCard className="p-2.5 flex items-start gap-2 mt-3 mb-4">
        ...
        <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.4 }}>
          Cảnh báo an toàn (tranh chấp, void) luôn được gửi bất kể cài đặt, theo chính sách bảo vệ
          người dùng.
        </p>
      </TrCard>

      <CTAButton onClick={handleSave}>Lưu cài đặt</CTAButton>
    </BottomSheetV2>
  );
}

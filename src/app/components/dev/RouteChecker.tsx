    ...
    <div className="min-h-screen p-5" style={{ background: c.bg }}>
      <div className="max-w-3xl mx-auto">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <span
                    className="px-2 py-1 rounded-md text-xs shrink-0"
        ...
        <div className="flex gap-3">
          ...
          {testedCount === totalRoutes && (
            <div
              className="flex-1 py-3 rounded-[14px] text-sm font-semibold text-center"
              ...
              return (
                ...
                >
                  ...
                  <div className="h-1 rounded-full overflow-hidden" style={{ background: c.bg }}>
                    <div
                      className="h-full"
                      style={{ background: '#10B981', width: `${phaseProgress}%` }}
                    />
                  </div>
                </div>
              );

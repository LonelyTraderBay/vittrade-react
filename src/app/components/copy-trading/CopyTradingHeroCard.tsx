  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex items-center justify-center relative z-10">
        <span className="text-[10px] font-medium" style={{ color: c.text3, opacity: 0.6 }}>
          Updated {lastUpdated}
        </span>
      </div>
    </div>
...
function LegacyCleanVariant({
  tradersCount,
  copiersCount,
  totalAUM,
}: Omit<CopyTradingHeroCardProps, 'variant' | 'aumTrend' | 'lastUpdated'>) {
  const c = useThemeColors();
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-3">
        <LegacyStatCard icon={Users} label="Traders" value={String(tradersCount)} color={c.text1} />
        <LegacyStatCard
          icon={UserCheck}
          label="Copiers"
...
function LegacyStatCard({
  ...
  return (
    <div className="rounded-[14px] p-3 text-center" style={{ background: c.surface2 }}>
    ...
    >
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <span style={{ color: '#fff', fontSize: 11, fontWeight: 700 }}>COPY TRADING</span>
        </div>
...
function LegacyBoldStatCard({
  ...
  return (
    <div className="flex-1 rounded-[14px] p-3 text-center" style={{ background: gradient }}>
      <p
        style={{
...
function LegacyGlassStatCard({
  ...
  return (
    ...
    >
      <div
        className="w-7 h-7 rounded-full mx-auto mb-2 flex items-center justify-center"

  ...
  return (
    <TrCard className="p-4">
      ...
      <div className="flex items-start gap-3 mb-3">
        {/* Avatar skeleton */}
        <div className="w-12 h-12 rounded-full animate-pulse" style={{ background: c.surface2 }} />

        <div className="flex-1">
          {/* Name */}
          <div className="h-4 w-32 rounded animate-pulse mb-2" style={{ background: c.surface2 }} />
          {/* Tags */}
      ...
      <div className="grid grid-cols-4 gap-2.5 mt-3">
        {[1, 2, 3, 4].map((i) => (
          <div key={i}>
            <div
              className="h-3 w-12 rounded animate-pulse mb-1"
      ...
      {/* CTA skeleton */}
      <div
        className="h-10 w-full rounded-xl animate-pulse mt-3"
        style={{ background: c.surface2 }}
      />
    </TrCard>
  );
  ...
  return (
    <TrCard className="p-4">
      <div className="flex items-center gap-3 mb-4">
        <div
          className="w-10 h-10 rounded-[14px] animate-pulse"
          style={{ background: c.surface2 }}
        />
        <div className="flex-1">
...
export function ChartSkeleton({ height = 200 }: { height?: number }) {
  ...
  return (
    <TrCard className="p-4">
      ...
      <div className="w-full rounded-lg animate-pulse" style={{ background: c.surface2, height }} />
    </TrCard>
  );
}

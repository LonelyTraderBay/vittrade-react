...
export const MARKET_SECTORS: MarketSector[] = [
  {
    ...
    color: '#3B82F6',
    icon: '🔷',
    totalMarketCap: 1_856_234_567_000,
    change24h: 2.87,
    change7d: 5.43,
    change30d: 12.1,
    volume24h: 45_678_901_000,
  ...
  },
  {
    ...
    color: '#8B5CF6',
    icon: '🏦',
    totalMarketCap: 89_234_567_000,
    change24h: -1.23,
    change7d: 3.21,
    change30d: 8.7,
    volume24h: 12_345_678_000,
  ...
  },
  {
    ...
    color: '#06B6D4',
    icon: '🔗',
    totalMarketCap: 34_567_890_000,
    change24h: 4.56,
    change7d: 9.87,
    change30d: 18.3,
    volume24h: 5_678_901_000,
  ...
  },
  {
    ...
    color: '#F59E0B',
    icon: '🤖',
    totalMarketCap: 23_456_789_000,
    change24h: 6.78,
    change7d: 15.43,
    change30d: 34.2,
    volume24h: 4_567_890_000,
  ...
  },
  {
    ...
    color: '#EF4444',
    icon: '🐕',
    totalMarketCap: 56_789_012_000,
    change24h: -3.45,
    change7d: -2.1,
    change30d: 5.6,
    volume24h: 8_901_234_000,
  ...
  },
  {
    ...
    color: '#10B981',
    icon: '💳',
    totalMarketCap: 45_678_901_000,
    change24h: -0.87,
    change7d: 1.23,
    change30d: 3.4,
    volume24h: 6_789_012_000,
  ...
  },
  {
    ...
    color: '#EC4899',
    icon: '🎮',
    totalMarketCap: 12_345_678_000,
    change24h: 3.21,
    change7d: 7.89,
    change30d: 15.2,
    volume24h: 2_345_678_000,
  ...
  },
  {
    ...
    color: '#6366F1',
    icon: '🔒',
    totalMarketCap: 5_678_901_000,
    change24h: 1.45,
    change7d: 4.56,
    change30d: 9.8,
    volume24h: 890_123_000,
...
export const MARKET_MOVERS: MarketMover[] = [
  ...
  },
  {
    ...
    change24h: 7.23,
    change7d: 15.67,
    volume24h: 345_678_000,
    volumeChange24h: 67.8,
    marketCap: 2_876_543_000,
    category: 'DeFi',
    color: '#00F2FE',
  ...
  },
  {
    ...
    change24h: 6.89,
    change7d: 14.56,
    volume24h: 456_789_000,
    volumeChange24h: 52.3,
    marketCap: 5_890_123_000,
    category: 'Layer 1',
    color: '#00C1DE',
  ...
  },
  {
    ...
    change24h: 5.6,
    change7d: 11.2,
    volume24h: 789_012_000,
    volumeChange24h: 38.9,
    marketCap: 8_912_345_000,
    category: 'Layer 2',
    color: '#8247E5',
  ...
  },
  {
    ...
    change24h: 4.73,
    change7d: 9.15,
    volume24h: 567_890_000,
    volumeChange24h: 28.4,
    marketCap: 15_678_901_000,
    category: 'Layer 1',
    color: '#E84142',
  ...
  },
  {
    ...
    marketCap: 4_321_098_000,
    category: 'Layer 2',
    color: '#28A0F0',
    sparkline: [1.12, 1.15, 1.18, 1.2, 1.22, 1.23],
  },
  {
    id: 'bnb',
    symbol: 'BNB',
    ...
    change24h: 3.61,
    change7d: 7.82,
    volume24h: 1_234_567_000,
    volumeChange24h: 15.6,
    marketCap: 63_456_789_000,
    category: 'Layer 1',
    color: '#F3BA2F',
  ...
  },
  {
    ...
    change24h: 3.45,
    change7d: 7.89,
    volume24h: 234_567_000,
    volumeChange24h: 22.3,
    marketCap: 3_210_987_000,
    category: 'Layer 1',
    color: '#2A2A2A',
  ...
  },
  {
    ...
    change24h: 3.22,
    change7d: 6.78,
    volume24h: 654_321_000,
    volumeChange24h: 18.7,
    marketCap: 16_234_567_000,
    category: 'Layer 1',
    color: '#0033AD',
  ...
  },
  {
    ...
    change24h: -4.56,
    change7d: -2.34,
    volume24h: 189_012_000,
    volumeChange24h: 42.1,
    marketCap: 1_234_567_000,
    category: 'Layer 1',
    color: '#9B1C1C',
  ...
  },
  {
    ...
    change24h: -3.55,
    change7d: -1.23,
    volume24h: 432_109_000,
    volumeChange24h: 25.3,
    marketCap: 10_345_678_000,
    category: 'DeFi',
    color: '#E6007A',
  ...
  },
  {
    ...
    change24h: -2.59,
    change7d: -4.21,
    volume24h: 1_876_543_000,
    volumeChange24h: 32.6,
    marketCap: 34_567_890_000,
    category: 'Payment',
    color: '#00AAE4',
  ...
  },
  {
    ...
    change7d: 2.34,
    volume24h: 189_012_000,
    volumeChange24h: 14.5,
    marketCap: 3_456_789_000,
    category: 'Layer 1',
    color: '#2E3148',
    sparkline: [9.5, 9.4, 9.3, 9.2, 9.15, 9.12],
  },
  {
    id: 'eth',
    symbol: 'ETH',
  ...
  },
  {
    ...
    change24h: -0.89,
    change7d: 5.67,
    volume24h: 321_098_000,
    volumeChange24h: 11.2,
    marketCap: 3_789_012_000,
    category: 'Layer 2',
    color: '#FF0420',
    sparkline: [3.52, 3.5, 3.48, 3.47, 3.46, 3.45],
  },
  ...
  },
  {
    ...
    volume24h: 234_567_000,
    volumeChange24h: 0,
    marketCap: 654_321_000,
    category: 'DeFi',
    color: '#6B21A8',
    sparkline: [0.48, 0.5, 0.52, 0.53, 0.55, 0.56],
    isNew: true,
...
export const TOKEN_FUNDAMENTALS: Record<string, TokenFundamentals> = {
  btcusdt: {
    ...
    name: 'Bitcoin',
    description:
      'Bitcoin la tien te ky thuat so phi tap trung dau tien, hoat dong tren mang luoi ngang hang khong can trung gian, su dung co che dong thuan Proof of Work.',
  ...
  ethusdt: {
    ...
    name: 'Ethereum',
    description:
      'Ethereum la nen tang hop dong thong minh lon nhat, cho phep xay dung ung dung phi tap trung (dApps) va token ERC-20.',
    website: 'https://ethereum.org',
    whitepaper: 'https://ethereum.org/whitepaper',
    github: 'https://github.com/ethereum',
    twitter: 'https://twitter.com/ethereum',
    telegram: '',
    circulatingSupply: 120_234_567,
    totalSupply: 120_234_567,
    maxSupply: null,
    ...
    network: 'Ethereum',
    contractAddresses: [],
    allTimeHigh: 4_878.26,
    allTimeHighDate: '2021-11-10',
    allTimeLow: 0.43,
    allTimeLowDate: '2015-10-20',
    roi1y: 67.8,
    activeAddresses24h: 567_890,
    txCount24h: 1_234_567,
    tvl: 45_678_901_000,
    holders: 234_567_890,
    supplyDistribution: [
  ...
  solusdt: {
    ...
    name: 'Solana',
    description:
      'Solana la blockchain hieu suat cao voi toc do giao dich nhanh va phi thap, su dung co che Proof of History ket hop Proof of Stake.',
    website: 'https://solana.com',
    whitepaper: 'https://solana.com/solana-whitepaper.pdf',
    github: 'https://github.com/solana-labs',
    twitter: 'https://twitter.com/solana',
    telegram: 'https://t.me/solana',
    circulatingSupply: 440_123_456,
    totalSupply: 568_901_234,
    maxSupply: null,
    ...
    allTimeLow: 0.5,
    allTimeLowDate: '2020-05-11',
    roi1y: 567.3,
    activeAddresses24h: 345_678,
    txCount24h: 2_345_678,
    tvl: 4_567_890_000,
    holders: 12_345_678,
    supplyDistribution: [
  ...
  bnbusdt: {
    ...
    name: 'BNB',
    description:
      'BNB la token tien ich cua he sinh thai Binance, duoc su dung de thanh toan phi giao dich, tham gia Launchpad va nhieu dich vu khac.',
    website: 'https://www.bnbchain.org',
    whitepaper: '',
    github: 'https://github.com/bnb-chain',
    twitter: 'https://twitter.com/bnbchain',
    telegram: 'https://t.me/BNBcoin',
    circulatingSupply: 153_856_150,
    totalSupply: 153_856_150,
    ...
    allTimeLow: 0.0396,
    allTimeLowDate: '2017-08-01',
    roi1y: 89.2,
    activeAddresses24h: 234_567,
    txCount24h: 4_567_890,
    holders: 56_789_012,
    supplyDistribution: [

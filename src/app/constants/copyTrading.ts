 ...
 */
export const SORT_OPTIONS = ['Top ROI', 'Ổn định nhất', 'Nhiều copier', 'AUM cao'] as const;
...
export const COMPLIANCE_MESSAGES = {
  ...
  FIDUCIARY_DISCLAIMER:
    'Provider không phải là investment advisor hoặc fiduciary. Chiến lược copy không phải là lời khuyên tài chính. Bạn hoàn toàn chịu trách nhiệm cho quyết định đầu tư của mình.',

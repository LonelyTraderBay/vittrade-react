...
describe('IconButton', () => {
  describe('Rendering', () => {
    it('should render icon without label', () => {
      renderWithProviders(<IconButton icon={Search} aria-label="Search" />);
    ...
    it('should render icon with label', () => {
      renderWithProviders(<IconButton icon={Search} label="Tìm kiếm" />);
    ...
    it('should use aria-label when provided', () => {
      renderWithProviders(
        <IconButton icon={Search} label="Tìm kiếm" aria-label="Custom search label" />,
      );
  ...
  describe('Variants', () => {
    ...
    variants.forEach((variant) => {
      it(`should render ${variant} variant`, () => {
        renderWithProviders(<IconButton icon={Search} label="Test" variant={variant} />);
  ...
  describe('Sizes', () => {
    ...
    sizes.forEach((size) => {
      it(`should render ${size} size`, () => {
        renderWithProviders(<IconButton icon={Search} label="Test" size={size} />);
  ...
  describe('Interactions', () => {
    it('should call onClick when clicked', async () => {
      ...
      renderWithProviders(<IconButton icon={Search} label="Click me" onClick={handleClick} />);
    ...
    it('should not call onClick when disabled', async () => {
      ...
      renderWithProviders(
        <IconButton icon={Search} label="Disabled" onClick={handleClick} disabled />,
      );
    ...
    it('should not call onClick when loading', async () => {
      ...
      renderWithProviders(
        <IconButton icon={Search} label="Loading" onClick={handleClick} loading />,
      );
    ...
    it('should be disabled when disabled prop is true', () => {
      renderWithProviders(<IconButton icon={Search} label="Disabled" disabled />);
    ...
    it('should be disabled when loading prop is true', () => {
      renderWithProviders(<IconButton icon={Search} label="Loading" loading />);
  ...
  describe('Loading State', () => {
    it('should show spinner when loading', () => {
      const { container } = renderWithProviders(
        <IconButton icon={Search} label="Loading" loading />,
      );
    ...
    it('should still show label when loading', () => {
      renderWithProviders(<IconButton icon={Search} label="Loading text" loading />);
  ...
  describe('Custom Styling', () => {
    it('should apply custom className', () => {
      const { container } = renderWithProviders(
        <IconButton icon={Search} label="Custom" className="custom-class" />,
      );
    ...
    it('should apply custom style', () => {
      const { container } = renderWithProviders(
        <IconButton icon={Search} label="Custom" style={{ marginTop: '20px' }} />,
      );
  ...
  describe('Accessibility', () => {
    it('should have role="button"', () => {
      renderWithProviders(<IconButton icon={Search} label="Search" />);
...
describe('IconOnlyButton', () => {
  it('should render without label', () => {
    renderWithProviders(<IconOnlyButton icon={Search} aria-label="Search only" />);
  ...
  it('should require aria-label', () => {
    ...
    renderWithProviders(<IconOnlyButton icon={Search} aria-label="Required label" />);
...
describe('BackButton', () => {
  it('should render with default label "Quay lại"', () => {
    renderWithProviders(<BackButton onClick={() => {}} />);
  ...
  it('should render with custom label', () => {
    renderWithProviders(<BackButton onClick={() => {}} label="Trở về" />);
  ...
  it('should use ArrowLeft icon by default', () => {
    const { container } = renderWithProviders(<BackButton onClick={() => {}} />);
  ...
  it('should use ChevronLeft icon when useChevron is true', () => {
    const { container } = renderWithProviders(<BackButton onClick={() => {}} useChevron />);
  ...
  it('should support size prop', () => {
    const { container } = renderWithProviders(<BackButton onClick={() => {}} size="lg" />);
...
describe('CloseButton', () => {
  it('should render with default label "Đóng"', () => {
    renderWithProviders(<CloseButton onClick={() => {}} />);
  ...
  it('should render with custom label', () => {
    renderWithProviders(<CloseButton onClick={() => {}} label="Thoát" />);
  ...
  it('should call onClick when clicked', async () => {
    ...
    renderWithProviders(<CloseButton onClick={handleClick} />);
  ...
  it('should support size prop', () => {
    const { container } = renderWithProviders(<CloseButton onClick={() => {}} size="sm" />);
  ...
  it('should apply ghost variant', () => {
    const { container } = renderWithProviders(<CloseButton onClick={() => {}} />);
...
describe('IconButton Edge Cases', () => {
  it('should handle no onClick gracefully', () => {
    renderWithProviders(<IconButton icon={Search} label="No handler" />);
  ...
  it('should work without label or aria-label (icon only)', () => {
    renderWithProviders(<IconButton icon={Search} />);
  ...
  it('should handle both disabled and loading simultaneously', () => {
    renderWithProviders(<IconButton icon={Search} label="Both states" disabled loading />);
  ...
  it('should maintain font weight 600', () => {
    const { container } = renderWithProviders(<IconButton icon={Search} label="Bold" />);
  ...
  it('should have rounded-xl class', () => {
    const { container } = renderWithProviders(<IconButton icon={Search} label="Rounded" />);
  ...
  it('should have active:opacity-70 class', () => {
    const { container } = renderWithProviders(<IconButton icon={Search} label="Active" />);

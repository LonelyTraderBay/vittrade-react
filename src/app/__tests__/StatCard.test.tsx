...
describe('StatCard', () => {
  ...
  describe('Trends', () => {
    it('should render up trend with green color', () => {
      const { container } = renderWithProviders(
        <StatCard label="Price" value="$100" trend="up" />
      );
    ...
    it('should not render trend icon for neutral trend', () => {
      renderWithProviders(
        <StatCard label="Price" value="$100" trend="neutral" />
      );
  ...
  describe('Sizes', () => {
    ...
    sizes.forEach(size => {
      it(`should render ${size} size`, () => {
        renderWithProviders(
          <StatCard label="Test" value="100" size={size} />
        );
    ...
    it('should apply correct font size for sm value', () => {
      renderWithProviders(
        <StatCard label="Small" value="100" size="sm" />
      );
    ...
    it('should apply correct font size for md value', () => {
      renderWithProviders(
        <StatCard label="Medium" value="100" size="md" />
      );
    ...
    it('should apply correct font size for lg value', () => {
      renderWithProviders(
        <StatCard label="Large" value="100" size="lg" />
      );
  ...
  describe('Loading State', () => {
    it('should show skeleton when loading', () => {
      const { container } = renderWithProviders(
        <StatCard label="Loading" value="100" loading />
      );
    ...
    it('should show label even when loading', () => {
      renderWithProviders(
        <StatCard label="Still visible" value="Hidden" loading />
      );
  ...
  describe('Interactive Behavior', () => {
    ...
    it('should not have cursor-pointer class when onClick is not provided', () => {
      const { container } = renderWithProviders(
        <StatCard label="Static" value="100" />
      );
  ...
  describe('Accessibility', () => {
    it('should have rounded-2xl class', () => {
      const { container } = renderWithProviders(
        <StatCard label="Rounded" value="100" />
      );
    ...
    it('should apply font weight 500 to label', () => {
      const { container } = renderWithProviders(
        <StatCard label="Label weight" value="100" />
      );
...
describe('StatItem', () => {
  describe('Rendering', () => {
    it('should render label and value horizontally', () => {
      renderWithProviders(
        <StatItem label="Total" value="$100" />
      );
    ...
    it('should render with trend', () => {
      const { container } = renderWithProviders(
        <StatItem label="Price" value="$100" trend="up" />
      );
    ...
    it('should render in compact mode', () => {
      const { container } = renderWithProviders(
        <StatItem label="Compact" value="100" compact />
      );
  ...
  describe('Trends', () => {
    it('should apply green color for up trend', () => {
      renderWithProviders(
        <StatItem label="Up" value="$100" trend="up" />
      );
    ...
    it('should apply red color for down trend', () => {
      renderWithProviders(
        <StatItem label="Down" value="$100" trend="down" />
      );
    ...
    it('should not show trend icon for neutral', () => {
      renderWithProviders(
        <StatItem label="Neutral" value="$100" trend="neutral" />
      );
  ...
  describe('Compact Mode', () => {
    ...
    it('should use normal font size in non-compact mode', () => {
      renderWithProviders(
        <StatItem label="Normal" value="100" />
      );
  ...
  describe('Layout', () => {
    ...
    it('should align items center', () => {
      const { container } = renderWithProviders(
        <StatItem label="Aligned" value="100" />
      );
...
describe('PercentageStat', () => {
  it('should render positive percentage with up trend', () => {
    renderWithProviders(
      <PercentageStat label="Gain" percentage={5.25} />
    );
  ...
  it('should render negative percentage with down trend', () => {
    renderWithProviders(
      <PercentageStat label="Loss" percentage={-3.50} />
    );
  ...
  it('should render zero percentage with neutral trend', () => {
    renderWithProviders(
      <PercentageStat label="No change" percentage={0} />
    );
  ...
  it('should format percentage to 2 decimal places', () => {
    renderWithProviders(
      <PercentageStat label="Precise" percentage={3.14159} />
    );
  ...
  it('should disable auto trend when autoTrend is false', () => {
    const { container } = renderWithProviders(
      <PercentageStat label="Manual" percentage={5.0} autoTrend={false} />
    );
  ...
  it('should show green color for positive percentage', () => {
    renderWithProviders(
      <PercentageStat label="Green" percentage={5} />
    );
  ...
  it('should show red color for negative percentage', () => {
    renderWithProviders(
      <PercentageStat label="Red" percentage={-5} />
    );
...
describe('StatCard Edge Cases', () => {
  ...
  it('should render without any optional props', () => {
    renderWithProviders(
      <StatCard label="Minimal" value="100" />
    );

...
describe('BottomSheetV2', () => {
  ...
  describe('Custom Styling', () => {
    ...
    it('should apply rounded-3xl to center variant', () => {
      ...
      const sheet = container.querySelector('.rounded-3xl');
      expect(sheet).toBeInTheDocument();
    });
  });
...
describe('BottomSheetRow', () => {
  describe('Rendering', () => {
    it('should render label and value', () => {
      renderWithProviders(
        <BottomSheetRow label="Amount" value="$100.00" />
      );
    ...
    it('should render in horizontal layout', () => {
      const { container } = renderWithProviders(
        <BottomSheetRow label="Price" value="$50" />
      );
  ...
  describe('Highlight', () => {
    it('should apply bold font weight when highlight is true', () => {
      renderWithProviders(
        <BottomSheetRow label="Total" value="$150.00" highlight />
      );
  ...
  describe('Monospace Font', () => {
    it('should use monospace font family for values', () => {
      renderWithProviders(
        <BottomSheetRow label="ID" value="ABC123" />
      );
  ...
  describe('Font Sizes', () => {
    it('should use 13px font size for label and value', () => {
      renderWithProviders(
        <BottomSheetRow label="Label" value="Value" />
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long labels', () => {
      renderWithProviders(
        <BottomSheetRow
          label="This is a very long label that should still work"
          value="$100"
        />
      );
      
      expect(screen.getByText('This is a very long label that should still work')).toBeInTheDocument();
    });

...
const StakingEarningsCalendarPage = lazyRoute(() =>
...
const SavingsProductDetailPage = lazyRoute(() =>
  import('../pages/earn/SavingsProductDetailPage').then((m) => ({
    default: m.SavingsProductDetailPage,
  })),
);
const SavingsRedeemPage = lazyRoute(() =>
  import('../pages/earn/SavingsRedeemPage').then((m) => ({ default: m.SavingsRedeemPage })),
);
const SavingsReceiptPage = lazyRoute(() =>
  import('../pages/earn/SavingsReceiptPage').then((m) => ({ default: m.SavingsReceiptPage })),
);

// ─── Savings Portfolio & History (P2) ───
const SavingsPortfolioPage = lazyRoute(() =>
  import('../pages/earn/SavingsPortfolioPage').then((m) => ({ default: m.SavingsPortfolioPage })),
);
const SavingsHistoryPage = lazyRoute(() =>
  import('../pages/earn/SavingsHistoryPage').then((m) => ({ default: m.SavingsHistoryPage })),
);

// ─── Savings UX (P3) ───
const SavingsGuidePage = lazyRoute(() =>
  import('../pages/earn/SavingsGuidePage').then((m) => ({ default: m.SavingsGuidePage })),
);
const SavingsFAQPage = lazyRoute(() =>
  import('../pages/earn/SavingsFAQPage').then((m) => ({ default: m.SavingsFAQPage })),
);
const SavingsNotificationsPage = lazyRoute(() =>
  import('../pages/earn/SavingsNotificationsPage').then((m) => ({
    default: m.SavingsNotificationsPage,
  })),
);

// ─── Savings Recommendations & Risk (P4-P5) ───
const SavingsRecommendationsPage = lazyRoute(() =>
  import('../pages/earn/SavingsRecommendationsPage').then((m) => ({
    default: m.SavingsRecommendationsPage,
  })),
);
const SavingsRiskAssessmentPage = lazyRoute(() =>
  import('../pages/earn/SavingsRiskAssessmentPage').then((m) => ({
    default: m.SavingsRiskAssessmentPage,
  })),
);

// ─── Savings Comparison & Auto-Compound (P6) ───
const SavingsComparisonPage = lazyRoute(() =>
  import('../pages/earn/SavingsComparisonPage').then((m) => ({ default: m.SavingsComparisonPage })),
);
const AutoCompoundSettingsPage = lazyRoute(() =>
  import('../pages/earn/AutoCompoundSettingsPage').then((m) => ({
    default: m.AutoCompoundSettingsPage,
  })),
);

// ─── Savings Goal (P7) ───
const SavingsGoalPage = lazyRoute(() =>
  import('../pages/earn/SavingsGoalPage').then((m) => ({ default: m.SavingsGoalPage })),
);

// ─── Savings Analytics (P7) ───
const SavingsAnalyticsPage = lazyRoute(() =>
  import('../pages/earn/SavingsAnalyticsPage').then((m) => ({ default: m.SavingsAnalyticsPage })),
);

// ─── Savings Auto-Rebalance (P8) ───
const SavingsAutoRebalancePage = lazyRoute(() =>
  import('../pages/earn/SavingsAutoRebalancePage').then((m) => ({
    default: m.SavingsAutoRebalancePage,
  })),
);

// ─── Savings Notification Preferences (P9) ───
const SavingsNotificationPreferencesPage = lazyRoute(() =>
  import('../pages/earn/SavingsNotificationPreferencesPage').then((m) => ({
    default: m.SavingsNotificationPreferencesPage,
  })),
);

// ─── Savings DCA (P10) ───
const SavingsDCAPage = lazyRoute(() =>
  import('../pages/earn/SavingsDCAPage').then((m) => ({ default: m.SavingsDCAPage })),
);

// ─── Savings Smart Suggestions (P11) ───
const SavingsSmartSuggestionsPage = lazyRoute(() =>
  import('../pages/earn/SavingsSmartSuggestionsPage').then((m) => ({
    default: m.SavingsSmartSuggestionsPage,
  })),
);

// ─── Savings Export (P12) ───
const SavingsExportPage = lazyRoute(() =>
  import('../pages/earn/SavingsExportPage').then((m) => ({ default: m.SavingsExportPage })),
);

// ─── Savings Backtest (P13) ───
const SavingsBacktestPage = lazyRoute(() =>
  import('../pages/earn/SavingsBacktestPage').then((m) => ({ default: m.SavingsBacktestPage })),
);

// ─── Savings AutoPilot (P14) ───
const SavingsAutoPilotPage = lazyRoute(() =>
  import('../pages/earn/SavingsAutoPilotPage').then((m) => ({ default: m.SavingsAutoPilotPage })),
);

// ─── Savings Ladder (P15) ───
const SavingsLadderPage = lazyRoute(() =>
  import('../pages/earn/SavingsLadderPage').then((m) => ({ default: m.SavingsLadderPage })),
);

// ─── Savings WhatIf (P16) ───
const SavingsWhatIfPage = lazyRoute(() =>
  import('../pages/earn/SavingsWhatIfPage').then((m) => ({ default: m.SavingsWhatIfPage })),
);
...
export function createStakingRoutes(): RouteObject[] {
  return [
    ...
    // ─── Savings Notification Preferences (P9) ───
    {
      path: 'earn/savings/notification-preferences',
      Component: SavingsNotificationPreferencesPage,
    },

...
import { fmtAbsPct } from '@/shared/lib/formatNumber';
import { useMarketOrderBookQuery } from '@/features/market';
...
export const OrderBook = memo(function OrderBook({ pairId, price, change24h }: OrderBookProps) {
  ...
  const { asks, bids } = orderBookQuery.data;
      ...
      <div className="flex flex-col-reverse">
        {asks.slice(0, 8).map((ask) => (
          ...
          >
            ...
            />
            <span style={{ color: '#EF4444', fontSize: 12, flex: 1, position: 'relative' }}>
              {fmt(ask.price)}
            </span>
            <span
              style={{
      ...
      <div>
        {bids.slice(0, 8).map((bid) => (
          ...
          >
            ...
            />
            <span style={{ color: '#10B981', fontSize: 12, flex: 1, position: 'relative' }}>
              {fmt(bid.price)}
            </span>
            <span
              style={{

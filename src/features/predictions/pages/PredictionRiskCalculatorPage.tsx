...
import { calculatePredictionRiskMetrics } from '@/features/predictions/lib/prediction-risk-calculations';
...
export function PredictionRiskCalculatorPage() {
  ...
  const metrics = calculatePredictionRiskMetrics(shares, entryPrice, currentPrice, bankroll);

...
import type { DCAPlan } from '../model/dca-types';
      ...
      <div style={{ padding: '16px 16px 12px' }}>
        ...
        >
          ...
          <button
            ...
            disabled={isLoading || plan.status === 'error' || !onToggleStatus}
            style={{
              flex: 1,
              height: 40,
              borderRadius: 'var(--φ-radius-sm, 8px)',
              border: 'none',
              cursor:
                isLoading || plan.status === 'error' || !onToggleStatus ? 'not-allowed' : 'pointer',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              gap: 6,
              ...
              opacity: isLoading || plan.status === 'error' || !onToggleStatus ? 0.4 : 1,
              background:
          ...
          <button
            ...
            style={{
              ...
              background: 'transparent',
              cursor: isLoading || !onDelete ? 'not-allowed' : 'pointer',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              color: '#EF4444',
              transition: 'background 0.15s, opacity 0.15s',
              opacity: isLoading || !onDelete ? 0.4 : 0.7,
            }}

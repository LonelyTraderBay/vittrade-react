...
import { useLoadingState } from '@/dev/legacy/hooks/useLoadingState';
...
import {
  ...
  isExpiringSoon,
  MYSTERY_BOXES,
} from '@/dev/mocks/rewards-fixtures';
...
import {
  ...
  BatchClaimPreview,
} from '@/dev/legacy/rewards/RewardSubComponents';
...
export function RewardsHubPage() {
  ...
  const completionRate =
    tasks.length > 0 ? Math.round((claimedTasks.length / tasks.length) * 100) : 0;
  ...
  const [confirmDialog, setConfirmDialog] = useState<{
    ...
    data?: UnifiedTask | UnifiedTask[] | (typeof REDEMPTION_ITEMS)[number];
  ...
  const executeClaimTask = (task: UnifiedTask) => {
    ...
    setTasks((prev) =>
      prev.map((t) => (t.id === task.id ? { ...t, status: 'claimed' as const } : t)),
    );
    setConfettiActive(true);
  ...
  const executeBatchClaim = () => {
    ...
    setTasks((prev) =>
      prev.map((t) => (t.status === 'completed' ? { ...t, status: 'claimed' as const } : t)),
    );
    setConfettiActive(true);
  ...
  /* ─── Combo tracking ─── */
  const completedToday = claimedTasks.filter(
    (t) => t.category === 'daily' || t.category === 'flash',
  ).length;
  ...
  const handleConfirm = () => {
    if (confirmDialog.type === 'claim' && confirmDialog.data) {
      ...
      executeRedeem(confirmDialog.data as (typeof REDEMPTION_ITEMS)[number]);
    }
  };
    ...
    <div className="contents">
      ...
      >
        ...
        <PageContent gap="default" padding="compact">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-3 relative z-10">
              ...
              <div className="flex-1 min-w-0">
                <p style={{ color: '#FFFFFF', fontSize: 15, fontWeight: 700, lineHeight: 1.3 }}>
                  Phần thưởng
                </p>
                <p
                  style={{
              ...
              <div
                ...
                style={{
                  background: `${tier.current.color}20`,
                  border: `1px solid ${tier.current.color}40`,
                }}
              >
                <span style={{ fontSize: 14 }}>{tier.current.emoji}</span>
                <span style={{ color: tier.current.color, fontSize: 10, fontWeight: 700 }}>
                  {tier.current.label}
                </span>
              </div>
            </div>
            ...
            <div className="flex gap-3 relative z-10">
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontSize: 11, fontWeight: 500, marginLeft: 3, opacity: 0.8 }}>
                    USDT
                  </span>
                </p>
            ...
            <BalanceBreakdown
              totalBalance={arenaStats.currentBalance}
              lockedBalance={arenaStats.lockedBalance}
            />
            ...
            {expiringTasks.length > 0 && (
              ...
              >
                ...
                <p
                  ...
                  style={{ color: 'rgba(255,255,255,0.8)', fontSize: 10, lineHeight: 1.4 }}
                >
                  <span style={{ color: '#EF4444', fontWeight: 700 }}>{expiringTasks.length}</span>{' '}
                  nhiệm vụ sắp hết hạn
                  {expiringTasks[0] && (
                    <span style={{ color: 'rgba(255,255,255,0.5)' }}>
                      {' '}
                      · {expiringTasks[0].title}
                    </span>
                  )}
                </p>
                <span
            ...
            <div className="mt-3 relative z-10">
              ...
              <div
                className="h-2 rounded-full flex overflow-hidden mb-3"
                  ...
                  return (
                    <div key={s.cat} className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-1.5" style={{ width: 72 }}>
                        ...
                        />
                        <span
                          style={{ color: 'rgba(255,255,255,0.6)', fontSize: 9, fontWeight: 500 }}
                        >
                          {s.label}
                        </span>
                      </div>
                      ...
                      <div
                        ...
                        style={{ width: 54, justifyContent: 'flex-end' }}
                      >
                        <span
                          style={{
                            color: s.color,
            ...
            <TrCard className="p-3 relative overflow-hidden">
              ...
              <div className="flex items-center gap-2 mt-2.5 px-1">
                ...
                <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.4 }}>
                  7 ngày liên tiếp:{' '}
                  <span style={{ color: '#8B5CF6', fontWeight: 600 }}>100 pts</span> +{' '}
                  <span style={{ color: '#F59E0B', fontWeight: 600 }}>0.5 USDT</span>
                </p>
              </div>
            </TrCard>
          </div>
              ...
              <div className="relative z-10 flex items-center gap-3.5 px-4 py-4">
                ...
                <div className="flex-1 min-w-0 text-left">
                  ...
                  >
                    ...
                    {' + '}
                    <span style={{ color: '#C4B5FD', fontWeight: 700 }}>200 pts</span> mỗi lượt mời
                  </p>
                </div>
          ...
          <div>
            <div
              className="flex gap-2 overflow-x-auto -mx-5 px-5 pt-3 pb-2"
              style={{ scrollbarWidth: 'none' }}
            >
              {FILTER_TABS.map((tab) => {
                const catKey = FILTER_MAP[tab];
                const count = catKey
                  ? tasks.filter((t) => t.category === catKey).length
                  : tasks.length;
          ...
          <div className="flex flex-col gap-3">
            {sortedFilteredTasks.length === 0 && (
              <TrCard className="py-12 text-center">
                ...
                <p style={{ color: c.text2, fontSize: 14, fontWeight: 600 }}>
            ...
            <TrCard className="p-4 relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-3 relative z-10">
                ...
                <div className="relative">
                  ...
                  <motion.div
                    ...
                    style={{
                      background: `${tier.current.color}15`,
                      border: `1.5px solid ${tier.current.color}30`,
                    }}
                    animate={{ y: [0, -2, 0] }}
              ...
              <div className="relative mt-4 px-1 z-10">
                ...
                <motion.div
                  ...
                  style={{
                    background: `linear-gradient(90deg, ${tier.current.color}, ${tier.current.color}60)`,
                  }}
                  initial={{ width: '0%' }}
                  animate={{
                      ...
                      >
                        <motion.div
                          ...
                          style={{
                            ...
                            border: isCurrent
                              ? `2px solid ${t.color}`
                              : `1px solid ${isReached ? t.color + '40' : c.border}`,
                          }}
                          animate={isCurrent ? { scale: [1, 1.12, 1] } : {}}
                          transition={
                            isCurrent ? { duration: 2, repeat: Infinity, ease: 'easeInOut' } : {}
                          }
                        >
            ...
            <TrCard overflow>
              ...
              {leaderboardTop.map((entry, i) => (
                <div
                  ...
                  className="flex items-center gap-3 px-4 py-2.5"
                  style={{
                    borderBottom: i < leaderboardTop.length - 1 ? `1px solid ${c.divider}` : 'none',
                  }}
                >
                  <div
                    className="w-6 h-6 rounded-full flex items-center justify-center shrink-0"
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <ChevronRight
                    ...
                    color="#8B5CF6"
                    style={{
                      transform: showRedeem ? 'rotate(90deg)' : 'none',
          ...
          <div className="flex flex-col gap-2">
            <TrCard className="p-3 flex items-start gap-2">
              ...
              <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.5 }}>
                Phần thưởng USDT và Points được tính dựa trên hoạt động thực tế. Combo nhân thưởng
                áp dụng trong ngày và reset lúc 00:00 UTC. Arena Points không phải tài sản tài
                chính.
              </p>
            </TrCard>
            ...
            <button
              onClick={() => {
                hapticSelection();
                actionToast.info('Điều khoản chương trình phần thưởng');
              }}
              className="flex items-center justify-center gap-2 py-2.5 active:opacity-70"
              style={{ minHeight: 44 }}
            >
              <FileText size={13} color={c.text3} />
              <span style={{ color: c.text3, fontSize: 11, fontWeight: 500 }}>
                ...
                {(confirmDialog.data as UnifiedTask).pointsReward && (
                  <div className="flex items-center gap-1">
                    ...
                    <span style={{ color: '#8B5CF6', fontWeight: 700 }}>
                      {(confirmDialog.data as UnifiedTask).pointsReward} pts
                    </span>
                  </div>
                )}
              </div>
          ...
          confirmDialog.data && confirmDialog.type === 'redeem' ? (
            <div className="contents">
              <p style={{ marginBottom: 8 }}>
                {(confirmDialog.data as (typeof REDEMPTION_ITEMS)[number]).title}
              </p>

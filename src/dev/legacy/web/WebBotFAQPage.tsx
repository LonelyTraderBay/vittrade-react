...
import { WEB_FONT, WEB_ICON, WEB_SPACING } from '@/shared/theme/webTokens';
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      border: 'none',
                      background: active ? `${c.primaryAlpha08}` : 'transparent',
                ...
                {filteredFAQs.map((faq, idx) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        background: c.surface,
                        border: `1px solid ${isExpanded ? c.primaryAlpha30 : c.border}`,
                        borderRadius: 14,
                        overflow: 'hidden',

...
const MOCK_ENTRIES: LoginEntry[] = [
  {
    ...
    country: 'Việt Nam',
    status: 'success',
    statusDetail: 'Đăng nhập thành công',
    method: 'Email + 2FA',
  ...
  },
  {
    ...
    country: 'Việt Nam',
    status: 'success',
    statusDetail: 'Đăng nhập bằng Passkey',
    method: 'Passkey (Face ID)',
    sessionActive: true,
  },
  {
    id: 'l3',
    timestamp: '2026-03-12 22:48:31',
  ...
  },
  {
    ...
    country: 'Russia',
    status: 'suspicious',
    statusDetail: 'Đăng nhập từ vị trí bất thường — bị chặn bởi hệ thống',
    method: 'Email + Password',
  },
  {
    id: 'l5',
    timestamp: '2026-03-12 14:22:08',
    ...
    country: 'Việt Nam',
    status: 'failed',
    statusDetail: 'Sai mật khẩu (lần 2/5)',
    method: 'Email + Password',
  },
  {
    id: 'l6',
    timestamp: '2026-03-11 10:33:55',
  ...
  },
  {
    ...
    country: 'France',
    status: 'blocked',
    statusDetail: 'Bị chặn: Tài khoản tạm khóa do nhập sai 5 lần',
    method: 'Email + Password',
  },
  {
    id: 'l8',
    timestamp: '2026-03-09 19:45:22',
  ...
  },
  {
    ...
    country: 'Việt Nam',
    status: 'success',
    statusDetail: 'Đăng nhập bằng OTP email',
    method: 'Email + OTP',
    sessionActive: false,
  },
  {
    id: 'l10',
    timestamp: '2026-03-07 16:55:33',
...
export function WebLoginActivityPage() {
  ...
  const stats = {
    ...
    suspicious: MOCK_ENTRIES.filter((e) => e.status === 'suspicious' || e.status === 'blocked')
      .length,
  };
        ...
        <div className="flex flex-col" style={{ gap: 24 }}>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p style={{ color: c.text2, fontSize: WEB_FONT.sm, lineHeight: 1.5 }}>
                  {stats.suspicious} lần đăng nhập bất thường trong 7 ngày qua. Kiểm tra chi tiết
                  bên dưới và{' '}
                  <button
                  ...
                  nếu bạn không nhận ra hoạt động này.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="grid grid-cols-4" style={{ gap: 12 }}>
            {[
              { label: 'Tổng đăng nhập', value: stats.total, color: '#3B82F6', sub: '7 ngày qua' },
              {
                ...
                value: stats.success,
                color: '#10B981',
                sub: `${Math.round((stats.success / stats.total) * 100)}%`,
              },
          ...
          <div style={card()}>
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                padding: 0,
                marginBottom: showSessions ? 14 : 0,
              }}
            >
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          height: 40,
                          borderRadius: 10,
                          background: s.isCurrent ? 'rgba(59,130,246,0.06)' : c.surface,
                        }}
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span
                            style={{
                              color: s.isCurrent ? '#10B981' : c.text3,
                              fontSize: WEB_FONT.xs,
          ...
          <div style={card()}>
            ...
            <div className="flex items-center" style={{ gap: 10, marginBottom: 16 }}>
              ...
              >
                ...
                <input
                  type="text"
                  placeholder="Tìm thiết bị, IP, vị trí..."
                  value={search}
                      ...
                      >
                        ...
                        <div className="shrink-0 text-right" style={{ minWidth: 80 }}>
                          ...
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <span
                              style={{ color: sc.color, fontSize: WEB_FONT.xs, fontWeight: 600 }}
                            >
                              {sc.label}
                            </span>
                          </div>
                        ...
                        >
                          <div className="grid grid-cols-2" style={{ gap: 12 }}>
                            {[
                              { icon: Clock, label: 'Thời gian chính xác', value: entry.timestamp },
                              {
                                icon: Globe,
                                label: 'Trình duyệt',
                                value: `${entry.browser} — ${entry.os}`,
                              },
                              {
                                icon: MapPin,
                                label: 'Vị trí',
                                value: `${entry.location}, ${entry.country}`,
                              },
                          ...
                          {(entry.status === 'suspicious' || entry.status === 'blocked') && (
                            ...
                            >
                              ...
                              />
                              <p
                                style={{ color: '#EF4444', fontSize: WEB_FONT.xs, lineHeight: 1.5 }}
                              >
                                Hoạt động này được đánh dấu đáng ngờ. Nếu không phải bạn, hãy đổi
                                mật khẩu và kiểm tra thiết bị tin tưởng.
                              </p>
                            </div>
                          )}
                        </div>
          ...
          >
            ...
            <p style={{ color: c.text2, fontSize: WEB_FONT.xs, lineHeight: 1.5 }}>
              Lịch sử đăng nhập được lưu trữ trong{' '}
              <span style={{ color: c.text1, fontWeight: 500 }}>90 ngày</span>. Nếu phát hiện hoạt
              động lạ, hãy{' '}
              <button
                onClick={() => navigate('/w/auth/forgot-password')}
                className="hover:underline"
              ...
              ,{' '}
              <button
                onClick={() => navigate('/w/profile/security/passkey')}
                className="hover:underline"
                style={{
                  color: '#3B82F6',
                  fontWeight: 500,

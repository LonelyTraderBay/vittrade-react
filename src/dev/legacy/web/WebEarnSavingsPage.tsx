 ...
 * ══════════════════════════════════════════════════════════
 *
 *  Archived development-only mock; the active route uses features/earn.
 *
                ...
                {PRODUCT_CATEGORIES.map((category) => (
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      backgroundColor:
                        selectedCategory === category.id ? `${c.primaryAlpha08}` : 'transparent',
            ...
            {selectedCategory === 'all' && (
              <div
                style={{
                  ...
                  padding: 20,
                  border: `1px solid ${c.border}`,
                  background: `linear-gradient(135deg, ${c.primaryAlpha08} 0%, ${c.surface} 100%)`,
                }}
              >
                <div

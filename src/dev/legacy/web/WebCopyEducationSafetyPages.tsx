...
import { COMPLIANCE_MESSAGES } from '@/features/trading/constants/copyTrading';
import { WEB_FONT, WEB_ICON } from '@/shared/theme/webTokens';
import {
  AreaChart,
  Area,
  XAxis,
...
function Search(props: React.ComponentProps<typeof Eye>) {
  return <Eye {...props} />;
}
function Settings(props: React.ComponentProps<typeof Zap>) {
  return <Zap {...props} />;
}

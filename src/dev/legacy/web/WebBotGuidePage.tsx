...
const STRATEGIES = [
  {
    ...
    howItWorks: [
      'Đặt số tiền đầu tư (VD: $100)',
      'Chọn tần suất (ngày, tuần, tháng)',
      'Bot tự động mua theo lịch',
      'Trung bình giá qua biến động',
      'Tốt nhất cho tích lũy dài hạn',
    ],
    pros: [
      'Chiến lược đơn giản nhất',
      'Loại bỏ cảm xúc khi mua',
      'Giảm rủi ro timing',
      'Tốt cho thị trường biến động',
    ],
    ...
    example: {
      setup: 'Mua $100 BTC mỗi tuần',
      duration: '6 tháng',
      result: 'Giá TB: $67,500 vs giá spot: $68,450',
      profit: '+$127 (1.8%)',
    },
  },
  {
    ...
    howItWorks: [
      'Xác định khoảng giá (VD: $65K-$70K)',
      'Đặt số lưới (VD: 20)',
      'Bot đặt lệnh mua/bán tại mỗi mức',
      'Kiếm lời từ mỗi dao động giá',
      'Tốt nhất trong thị trường sideway',
    ],
    pros: [
      'Kiếm lời từ biến động',
      'Không cần dự đoán hướng',
      'Giao dịch tự động 24/7',
      'Win rate cao (70-80%)',
    ],
    cons: [
      'Lỗ khi xu hướng mạnh',
      'Cần đủ vốn cho tất cả lưới',
      'Có thể bỏ lỡ move lớn ngoài range',
    ],
    bestFor: 'Thị trường sideway, trader tích cực',
    example: {
      setup: '20 lưới, range $65K-$70K, vốn $1,000',
      duration: '1 tháng',
      result: '156 giao dịch, win rate 72.3%',
      profit: '+$127.40 (12.7%)',
    },
  },
  {
    ...
    howItWorks: [
      'Theo dõi chuyển động giá và chỉ báo',
      'Mua khi phát hiện uptrend',
      'Bán khi phát hiện downtrend',
      'Trail stop-loss bảo vệ lợi nhuận',
      'Tốt nhất cho thị trường trending',
    ],
    pros: [
      'Nắm bắt chuyển động xu hướng lớn',
      'Stop-loss tích hợp',
      'Lợi nhuận lớn trong xu hướng',
      'Thích nghi với điều kiện thị trường',
    ],
    cons: [
      'Tín hiệu giả trong thị trường choppy',
      'Cần tinh chỉnh thông số',
      'Whipsaw trong thị trường sideway',
    ],
    bestFor: 'Thị trường trending (bull/bear), trader có kinh nghiệm',
    example: {
      setup: 'MA crossover, stop-loss 3%',
      duration: '2 tháng',
      result: '23 giao dịch, win rate 68.4%',
      profit: '+$559 (55.9%)',
    },
  },
  {
    ...
    howItWorks: [
      'Bắt đầu với vị thế cơ bản ($100)',
      'Nếu thua, gấp đôi ($200)',
      'Nếu thua tiếp, gấp đôi ($400)',
      'Một lần thắng phục hồi tất cả',
      '⚠️ RỦI RO CAO - có thể xóa tài khoản',
    ],
    pros: ['Win rate cao (78%+)', 'Phục hồi lỗ nhanh', 'Logic đơn giản'],
    cons: [
      'Rủi ro thảm họa nếu thua nhiều',
      'Cần vốn lớn',
      'Max drawdown -30%+',
    ...
    example: {
      setup: 'Base $100, nhân 2x, max 5 lần',
      duration: '1 tháng',
      result: '312 giao dịch, win rate 78.9%, max DD -28.7%',
      profit: '+$894 (89.4%) ⚠️ Rủi ro cao',
    },
  },
];
...
const BEST_PRACTICES = [
  {
    title: 'Bắt đầu nhỏ',
    desc: 'Bắt đầu với $50-200 để thử nghiệm trước khi tăng vốn.',
    icon: '💡',
  },
  {
    title: 'Backtest trước',
    desc: 'Luôn backtest chiến lược trên dữ liệu lịch sử trước khi triển khai.',
    icon: '📊',
  },
  {
    title: 'Đặt Stop-Loss',
    desc: 'Sử dụng giới hạn drawdown và emergency stop để bảo vệ vốn.',
    icon: '🛡️',
  },
  {
    title: 'Theo dõi hàng ngày',
    desc: 'Kiểm tra hiệu suất bot ít nhất mỗi ngày để phát hiện bất thường.',
    icon: '👁️',
  },
  {
    title: 'Đa dạng hóa',
    desc: 'Không bỏ hết vốn vào một bot - phân bổ giữa nhiều chiến lược.',
    icon: '🎯',
  },
...
const COMMON_MISTAKES = [
  {
    mistake: 'Over-optimize thông số',
    why: 'Thông số tối ưu trên dữ liệu quá khứ có thể không hoạt động trong tương lai.',
    fix: 'Dùng thông số đơn giản, robust. Kiểm tra walk-forward validation.',
  },
  {
    mistake: 'Bỏ qua phí',
    why: 'Bot giao dịch nhiều có thể lỗ ròng chỉ từ phí giao dịch.',
    fix: 'Tính tác động phí. Nhắm lợi nhuận > 2x phí mỗi giao dịch.',
  },
  {
    mistake: 'Không quản lý rủi ro',
    why: 'Bot có thể tích lũy lỗ mà không có stop-loss.',
    fix: 'Đặt max drawdown (-20%), giới hạn lỗ hàng ngày, dùng emergency stop.',
  },
  {
    mistake: 'Thay đổi chiến lược giữa chừng',
    why: 'Gián đoạn logic chiến lược, có thể gây lỗ.',
    fix: 'Để bot chạy đủ chu kỳ (7-30 ngày) trước khi điều chỉnh.',
  },
  {
    mistake: 'Dùng kết quả demo như cam kết',
    why: 'Demo không có slippage, fill tức thì, không lỗi mạng.',
    fix: 'Kỳ vọng kết quả thực tế kém hơn demo 10-20%.',
  },
];
    ...
    <PageLayout>
      ...
      <div style={{ padding: '24px 0 40px' }}>
        ...
        >
          ...
          <div>
            ...
            <p style={{ color: c.text2, fontSize: WEB_FONT.base, lineHeight: 1.6, margin: 0 }}>
              Tìm hiểu cách hoạt động của từng chiến lược bot, khi nào nên sử dụng và cách tránh sai
              lầm phổ biến. Phù hợp cho cả người mới và trader có kinh nghiệm.
            </p>
          </div>
        </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    border: `1px solid ${isExpanded ? strategy.color + '40' : c.border}`,
                    borderRadius: 16,
                    overflow: 'hidden',
        ...
        >
          <div
            className="flex items-center justify-center shrink-0"
            style={{ width: 48, height: 48, borderRadius: 14, background: `${c.primaryAlpha08}` }}
          >

...
import { CopyTradingCard } from '@/dev/legacy/demo/CopyTradingCard';
import { IssueComparisonTable } from '@/dev/legacy/demo/IssueComparisonTable';
  ...
  return (
    <PageLayout>
      ...
      <PageContent gap="relaxed">
        {/* Analysis Header */}
        <div className="rounded-2xl p-5" style={{ backgroundColor: c.surface }}>
          <h2 className="text-lg font-bold mb-2" style={{ color: c.text }}>
            📊 Enterprise Fintech Card Analysis
          </h2>
          <p className="text-sm leading-relaxed mb-3" style={{ color: c.text2 }}>
            Below are 3 variants designed to address enterprise-level fintech standards: visual
            hierarchy, trust-first principles, and regulatory compliance.
          </p>
          <div className="p-3 rounded-xl" style={{ backgroundColor: c.bg }}>
            <p className="text-xs leading-relaxed" style={{ color: c.text3 }}>
        ...
        <div>
          ...
          <CopyTradingCard {...mockData} variant="hero" />
          <div className="mt-2 p-3 rounded-xl" style={{ backgroundColor: c.surface }}>
        ...
        <div>
          ...
          <CopyTradingCard {...mockData} variant="tabular" />
          <div className="mt-2 p-3 rounded-xl" style={{ backgroundColor: c.surface }}>
            <p className="text-xs leading-relaxed" style={{ color: c.text2 }}>
              <strong style={{ color: c.text }}>Why better:</strong>
              <br />
        ...
        <div>
          ...
          <CopyTradingCard {...mockData} variant="compact" />
          <div className="mt-2 p-3 rounded-xl" style={{ backgroundColor: c.surface }}>
            <p className="text-xs leading-relaxed" style={{ color: c.text2 }}>
        ...
        <div
          ...
          style={{
            backgroundColor: c.sellAlpha10,
            borderLeft: `4px solid ${c.error}`,
          }}
        >
          <h3 className="text-base font-bold mb-3" style={{ color: c.error }}>
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-xs leading-relaxed" style={{ color: c.text2 }}>
                • AUM ($19.25M) = most critical metric but equal weight with others
        ...
        <div
          className="rounded-2xl p-5"
          style={{
            backgroundColor: c.buyAlpha10,
            borderLeft: `4px solid ${c.success}`,
          }}
        >
          <h3 className="text-base font-bold mb-3" style={{ color: c.success }}>
            ✅ Final Recommendation
          </h3>
          <p className="text-sm leading-relaxed mb-3" style={{ color: c.text }}>
            <strong>Use Variant A (Hero Metric Pattern)</strong> for production deployment:
          </p>
          ...
          <div className="space-y-2">
            <div className="flex items-start gap-2">
              <span
                ...
                style={{
                  backgroundColor: c.primaryAlpha12,
                  color: c.primary,
                }}
              >
                §1
              </span>
              <p className="text-xs leading-relaxed flex-1" style={{ color: c.text2 }}>
                <strong style={{ color: c.text }}>Trust-first:</strong> Added timestamp, trend, info
                access
              </p>
            </div>
            <div className="flex items-start gap-2">
              ...
              <p className="text-xs leading-relaxed flex-1" style={{ color: c.text2 }}>
                <strong style={{ color: c.text }}>Clarity over density:</strong> Hierarchy
                prioritizes scanability
              </p>
            </div>
            <div className="flex items-start gap-2">
              <span
              ...
              <p className="text-xs leading-relaxed flex-1" style={{ color: c.text2 }}>
                <strong style={{ color: c.text }}>Readability:</strong> Icon ≠ color-only, contrast
                optimized
              </p>
            </div>
            <div className="flex items-start gap-2">
              ...
              <p className="text-xs leading-relaxed flex-1" style={{ color: c.text2 }}>
                <strong style={{ color: c.text }}>Number clarity:</strong> Tabular-nums, formatted,

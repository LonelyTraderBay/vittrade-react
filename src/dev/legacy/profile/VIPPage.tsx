...
import { fmtUsd, fmtCompact } from '@/shared/lib/formatNumber';
    ...
    <PageLayout>
      ...
      <PageContent gap="relaxed">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4 relative">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span style={{ color: currentTier.color, fontSize: 18, fontWeight: 800 }}>
                    {currentTier.name}
                  </span>
                </div>
                <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 12 }}>
                  Thành viên từ 15/08/2023
                </p>
              </div>
            </div>
            <div className="text-right">
              <div
                ...
                style={{
                  background: `${currentTier.color}33`,
                  border: `1px solid ${currentTier.color}55`,
                }}
              >
                <span style={{ color: currentTier.color, fontSize: 13, fontWeight: 700 }}>
                  {currentTier.badge}
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 relative">
            {[
              {
                label: 'Maker fee',
                value: `${currentTier.makerFee.toFixed(2)}%`,
                color: '#10B981',
              },
              {
                label: 'Taker fee',
                value: `${currentTier.takerFee.toFixed(2)}%`,
                color: '#10B981',
              },
            ].map((s) => (
              <div
        ...
        <div className="flex rounded-2xl p-1 gap-1" style={{ background: c.surface2 }}>
          {(
            ...
            <button
              ...
              style={{
                background: selectedTab === t.id ? c.chipActiveBg : 'transparent',
                color: selectedTab === t.id ? c.chipActiveText : c.text2,
              }}
            >
              {t.label}
            </button>
        ...
        {selectedTab === 'overview' && (
          <div key="overview" className="flex flex-col gap-4">
              ...
              <TrCard className="p-4">
                ...
                <div className="mb-3">
                  ...
                  <p style={{ color: c.text3, fontSize: 11, marginTop: 4 }}>
                    Cần thêm ${fmtUsd(nextTier.monthlyVolume - USER_VIP.monthlyVolume)} để đạt mục
                    tiêu
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5 mt-2">
                    ...
                    <p style={{ color: '#10B981', fontSize: 11 }}>Điều kiện tài sản đã đạt ✓</p>
                  </div>
                </div>
              </TrCard>
            )}
            ...
            <TrCard overflow>
              ...
              >
                {['Cấp độ', 'Volume/tháng', 'Maker', 'Taker'].map((h) => (
                  <span key={h} style={{ color: c.text3, fontSize: 11 }}>
                    {h}
                  </span>
                ))}
              </div>
              {VIP_TIERS.map((tier) => (
                <div
                  ...
                  style={{
                    ...
                    background:
                      tier.level === USER_VIP.level ? 'rgba(59,130,246,0.05)' : 'transparent',
                  }}
                >
                  <div className="flex items-center gap-1.5">
                    ...
                    <span
                      style={{
                        color: tier.level === USER_VIP.level ? '#3B82F6' : c.text1,
                        fontSize: 12,
                        fontWeight: tier.level === USER_VIP.level ? 700 : 400,
                      }}
                    >
                      {tier.name}
                    </span>
                  ...
                  <span
                    style={{
                      color: tier.level === USER_VIP.level ? '#10B981' : c.text1,
                      fontSize: 12,
                      fontFamily: 'monospace',
                      fontWeight: 600,
                    }}
        ...
        {selectedTab === 'benefits' && (
          <div key="benefits" className="flex flex-col gap-3">
                ...
                <div key={tier.level}>
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: isUnlocked ? tier.color + '15' : 'transparent',
                        borderBottom: `1px solid ${c.divider}`,
                      }}
                    >
                      ...
                      <div className="flex-1">
                        <span
                          style={{
                            color: isUnlocked ? tier.color : c.text2,
                            fontSize: 15,
                            fontWeight: 700,
                          }}
                        >
                        ...
                        <p style={{ color: c.text3, fontSize: 11 }}>
                          Volume ≥ ${fmtUsd(tier.monthlyVolume)}/tháng hoặc Tài sản ≥ $
                          {fmtUsd(tier.assetHold)}
                        </p>
                      </div>
                      {isUnlocked ? (
                    ...
                    <div className="px-4 py-3 flex flex-col gap-2">
                      {tier.features.map((feature) => (
                        <div key={feature} className="flex items-center gap-2">
                          ...
                          <span style={{ color: isUnlocked ? c.text1 : c.text3, fontSize: 13 }}>
                            {feature}
                          </span>
                        </div>
                      ))}
                      ...
                      >
                        <div className="flex gap-4">
                          <div>
                            ...
                            <p
                              style={{
                                color: isUnlocked ? '#10B981' : c.text2,
                                fontSize: 13,
                                fontWeight: 700,
                              }}
                            >
                          ...
                          <div>
                            ...
                            <p style={{ color: c.text2, fontSize: 13 }}>
                              {fmtCompact(tier.withdrawLimit, { prefix: '$' })}/ngày
                            </p>
                          </div>
                        </div>
                      </div>
            ...
            {nextTier && (
              ...
              >
                ...
                <button
                  onClick={() => navigate(routePrefix + '/trade/btcusdt')}
        ...
        {/* HISTORY TAB */}
        {selectedTab === 'history' && (
          <div key="history" className="flex flex-col gap-3">
            {[
              {
                date: '2026-02-23',
                volume: '$12,450',
                ...
                <TrCard className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span
                      ...
                      style={{
                        background: row.level !== 'Standard' ? 'rgba(245,158,11,0.12)' : c.surface2,
                        color: row.level !== 'Standard' ? '#F59E0B' : c.text2,
                      }}
                    >
                      {row.level}
                    </span>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <div key={r.label}>
                        ...
                        <p
                          style={{
                            color: 'color' in r ? r.color : c.text1,
                            fontSize: 12,
                            fontWeight: 600,
                            fontFamily: 'monospace',
                          }}

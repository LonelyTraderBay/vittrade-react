...
import { MiniChart } from '@/features/trading';
import { ChartPerformanceMonitor } from '@/dev/legacy/tools/ChartPerformanceMonitor';
import { getPairConfig } from '@/shared/lib/charts/chartDataGenerator';

...
const FLOW_CONNECTIONS: FlowLink[] = [
  ...
  },
  {
    ...
    to: 'P2PEscrowDetailPage',
    toRoute: '/p2p/order/:orderId',
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1">
                ...
                <p style={{ color: '#4A5568', fontSize: 11, fontFamily: 'monospace' }}>
                  {screen.route}
                </p>
              </div>
              <div
    ...
    <div className="flex flex-col gap-4">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5 mb-0.5">
                  ...
                  <span style={{ color: flow.color, fontSize: 12, fontWeight: 600 }}>
                    {flow.to}
                  </span>
                </div>
      ...
      >
        <p style={{ color: '#3B82F6', fontSize: 12, lineHeight: 1.5 }}>
          ℹ️ Tất cả header back button sử dụng{' '}
          <span style={{ fontFamily: 'monospace' }}>navigate(-1)</span> theo pattern hiện có.
        </p>
      </div>
    </div>
  );
      ...
      <PageContent gap="default" padding="default">
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 style={{ color: '#F0F4FF', fontSize: 18, fontWeight: 700 }}>
                03 – Missing Screens & Flow Fix
              </h1>
              <p style={{ color: '#8B95B3', fontSize: 12 }}>
                No redesign • Chỉ tạo mới + v2 entry points
              </p>
            </div>
          </div>
        </div>

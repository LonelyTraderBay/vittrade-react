...
function MiniBottomNav({ scale = 1 }: { scale?: number }) {
  ...
  return (
    <div
      className="flex items-end justify-around px-1 py-1.5"
      ...
      {items.map((item, i) => {
        ...
        return (
          <div key={i} className="flex flex-col items-center gap-0.5">
            ...
            <span style={{ fontSize: 6 * scale, color: item.active ? '#3B82F6' : '#4A5568' }}>
              {item.label}
            </span>
          </div>
        );
...
function MiniLeftRail({ height }: { height: number }) {
  ...
  return (
    ...
    >
      <div
        className="w-4 h-4 rounded flex items-center justify-center mb-2"
  ...
  return (
    <div className="flex flex-col gap-1 p-2 flex-1">
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, #1a2550, #0d1b3e)',
    ...
    <PageLayout variant="immersive" style={{ background: '#0B0E17' }}>
      ...
      <div className="px-6 pt-6 pb-4">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 style={{ color: '#F0F4FF', fontSize: 22, fontWeight: 700 }}>
              01 – Responsive Shell
            </h1>
            <p style={{ color: '#8B95B3', fontSize: 13 }}>
              No Redesign — Chỉ reflow, giữ nguyên visual style
            </p>
          </div>
        </div>
      </div>
      ...
      {activeSection === 'templates' && (
        <div className="px-6">
          <p style={{ color: '#8B95B3', fontSize: 13, marginBottom: 24, lineHeight: 1.6 }}>
            4 shell templates cho breakpoints khác nhau. Mobile/Tablet dùng BottomNav. Desktop có 2
            phương án: Desktop Centered (BottomNav, max-width 480) và Desktop Adaptive (LeftRail
            sidebar, max-width 1200).
          </p>
          ...
          <p style={{ color: '#F0F4FF', fontSize: 16, fontWeight: 700, marginBottom: 16 }}>
            Desktop — 2 phương án
          </p>
          <div className="flex flex-wrap gap-8 mb-8 justify-center">
            {/* Desktop Centered */}
            <ShellFrame label="Desktop – Centered" width={1440} height={900} badge="Phương án A">
              <div
                ...
                style={{
                  background: 'radial-gradient(ellipse at 50% 0%, #0d1b3e 0%, #050810 70%)',
                }}
              >
                <div
                  style={{
            ...
            <ShellFrame label="Desktop – Adaptive" width={1440} height={900} badge="Phương án B">
              <div className="flex h-full">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  >
                    <span style={{ fontSize: 5, color: '#8B95B3', marginLeft: 4 }}>
                      VitTrade Desktop
                    </span>
                  </div>
          ...
          >
            ...
            {[
              ...
              {
                bp: 'Desktop Centered',
                rule: 'BottomNav kept, content max-width 480, phone-like frame',
              },
              {
                bp: 'Desktop Adaptive',
                rule: 'LeftRail sidebar, content max-width 1200, multi-column layouts',
              },
            ].map((r, i) => (
              <div
                key={r.bp}
              ...
              >
                <span style={{ color: '#3B82F6', fontSize: 12, fontWeight: 600, width: 140 }}>
                  {r.bp}
                </span>
      ...
      {activeSection === 'applied' && (
        <div className="px-6">
          <p style={{ color: '#8B95B3', fontSize: 13, marginBottom: 24, lineHeight: 1.6 }}>
            8 màn hub đã được áp dụng shell responsive. Mỗi màn tự động reflow theo breakpoint:
            Mobile L → Tablet → Desktop Adaptive. Click vào bất kỳ màn nào để xem live responsive.
          </p>
                ...
                <tbody>
                  {[
                    { page: 'Home', cols: '1', left: 'Full content (centered)', right: '—' },
                    {
                      page: 'MarketList',
                      cols: '2',
                      left: 'Market list + search',
                      right: 'Top Movers + Watchlist',
                    },
                    {
                      page: 'PairDetail',
                      cols: '2',
                      left: 'Chart / Orderbook / Trades',
                      right: 'Quick Buy/Sell + Alerts',
                    },
                    { page: 'Trade', cols: '2', left: 'Chart + Orderbook', right: 'Order Form' },
                    {
                      page: 'Wallet',
                      cols: '2',
                      left: 'Balances + Assets',
                      right: 'Recent Activity + Stats',
                    },
                    {
                      page: 'TxHistory',
                      cols: '1 (wide)',
                      left: 'Table-like list (extra cols)',
                      right: '—',
                    },
                    {
                      page: 'Profile',
                      cols: '1',
                      left: 'Full content, 2-col grid items',
                      right: '—',
                    },

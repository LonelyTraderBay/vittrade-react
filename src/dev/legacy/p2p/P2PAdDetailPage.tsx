...
import { fmtVnd, fmtAmount, fmtVolume } from '@/shared/lib/formatNumber';
import { φ, φIcon, φAvatar, φRadius } from '@/shared/lib/golden';
import { TrCard } from '@/shared/ui/TrCard';
import { TrInput } from '@/shared/ui/TrInput';
import { P2PConfirmationModal } from '@/dev/legacy/p2p/P2PConfirmationModal';
import type { ConfirmSummaryRow, ConfirmWarning } from '@/dev/legacy/p2p/P2PConfirmationModal';
import { ErrorState } from '@/shared/ui/ErrorState';
import { useActionToast } from '@/shared/hooks/useActionToast';
import { useP2PAdQuery, useP2POrderMutation } from '@/features/p2p';
...
export function P2PAdDetailPage() {
  ...
  }, [amount, fiatAmount, inputMode, ad]);
  ...
  if (adError || !ad) {
    return (
      <PageLayout variant="flush">
        ...
        <PageContent>
          <ErrorState
            title="Không thể tải quảng cáo P2P"
            onAction={() => {
              void refetchAd();
            }}
          />
  ...
  /* ─── Price vs Market ─── */
  const marketPrice = ad.referencePrice ?? ad.price;
  ...
  const handleConfirmedOrder = async () => {
    ...
    try {
      ...
      actionToast.error('Không thể tạo đơn P2P. Vui lòng thử lại.');
    }
  };
  ...
  return (
    <PageLayout variant="flush">
      ...
      <StickyFooter>
        ...
        >
          {orderMutation.isPending ? 'Đang tạo đơn...' : `${tradeLabel} ${ad.asset}`}
        </CTAButton>
      </StickyFooter>

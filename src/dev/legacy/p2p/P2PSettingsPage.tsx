...
export function P2PSettingsPage() {
  ...
  const [autoReplyBuy, setAutoReplyBuy] = useState(
    'Cảm ơn bạn! Vui lòng chuyển khoản theo thông tin bên dưới.',
  );
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          border: `1px solid ${value ? color : c.borderSolid}`,
      ...
      <div className="flex-1 px-5 py-4 pb-8 flex flex-col gap-5">
        ...
        >
          ...
          <TrCard className="p-4">
            {/* Default Asset */}
            <div className="mb-3">
              <p style={{ color: c.text2, fontSize: 11, marginBottom: 6, fontWeight: 600 }}>
                Tài sản mặc định
              </p>
            ...
            <ToggleRow
              ...
              desc={
                autoConfirmEnabled
                  ? `Đơn dưới ${parseInt(autoConfirmThreshold).toLocaleString('vi')}đ`
                  : 'Tắt — xác nhận thủ công'
              }
                ...
                <div className="flex gap-2">
                  {['500000', '1000000', '5000000'].map((t) => (
                    <button
                      key={t}
                      onClick={() => {
                        setAutoConfirmThreshold(t);
                        hapticSelection();
                      }}
                      className="px-2 py-1 rounded-lg text-xs"
                      style={{
                        background:
                          autoConfirmThreshold === t ? 'rgba(16,185,129,0.12)' : c.surface2,
                        color: autoConfirmThreshold === t ? '#10B981' : c.text3,
                        fontWeight: 600,
                      }}
                    >
                      {parseInt(t).toLocaleString('vi')}đ
                    </button>
                  ))}
                </div>
              </div>
        ...
        >
          ...
          <TrCard className="px-4">
            <ToggleRow
              icon={Bell}
              label="Đơn hàng"
              desc="Thông báo khi có đơn mới, xác nhận, tranh chấp"
              value={notifOrder}
            ...
            <ToggleRow
              icon={MessageSquare}
              label="Tin nhắn"
              desc="Thông báo tin nhắn mới trong chat"
              value={notifChat}
            ...
            <ToggleRow
              icon={AlertTriangle}
              label="Cảnh báo giá"
              desc="Khi giá thị trường biến động lớn"
              value={notifPrice}
        ...
        >
          ...
          <TrCard className="px-4">
            <ToggleRow
              ...
              desc="Hiển thị trạng thái trực tuyến cho đối tác"
              value={showOnline}
            ...
            <ToggleRow
              ...
              desc="Hiển thị % hoàn thành trên profile"
            ...
            <ToggleRow
              ...
              desc="Hiển thị tổng volume giao dịch"
              value={showVolume}
            ...
            <ToggleRow
              ...
              desc="Hiển thị 'hoạt động X phút trước'"
              value={showLastSeen}
        ...
        >
          ...
          <TrCard className="px-4">
            <ToggleRow
              icon={Lock}
              label="Xác thực 2FA"
              desc="Yêu cầu 2FA cho mọi giao dịch P2P"
              value={require2FA}
            ...
            <ToggleRow
              ...
              desc="Nhập PIN khi xác nhận đã nhận tiền"
              value={requirePin}
            ...
            <ToggleRow
              icon={Globe}
              label="IP Whitelist"
              desc="Chỉ cho phép giao dịch từ IP đã đăng ký"
              value={ipWhitelist}
            ...
            <NavRow
              ...
              desc="Quản lý người dùng đã chặn"
              color="#EF4444"
              onClick={() => navigate(`${prefix}/p2p/blacklist`)}
            />
          </TrCard>
        </motion.div>
        ...
        >
          ...
          <TrCard className="p-4">
            <div className="flex rounded-xl p-1 mb-3" style={{ background: c.surface2 }}>
              <button
                onClick={() => {
                  setTradingHoursMode('247');
                  hapticSelection();
                }}
                className="flex-1 py-2 rounded-lg text-xs"
                style={{
                  background: tradingHoursMode === '247' ? c.chipActiveBg : 'transparent',
                  color: tradingHoursMode === '247' ? c.chipActiveText : c.text3,
                  fontWeight: 700,
                }}
              >
                24/7
              ...
              <button
                onClick={() => {
                  setTradingHoursMode('custom');
                  hapticSelection();
                }}
                className="flex-1 py-2 rounded-lg text-xs"
                style={{
                  background: tradingHoursMode === 'custom' ? c.chipActiveBg : 'transparent',
                  color: tradingHoursMode === 'custom' ? c.chipActiveText : c.text3,
                  fontWeight: 700,
                }}
              >
                Tùy chỉnh
            ...
            {autoReplyEnabled && (
              <div className="mt-2">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    onClick={() => {
                      setAutoReplyEdit(!autoReplyEdit);
                      hapticSelection();
                    }}

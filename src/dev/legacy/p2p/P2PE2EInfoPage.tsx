  ...
  return (
    <PageLayout>
      ...
      <div className="flex flex-col items-center gap-3 py-4">
        ...
        <p style={{ color: '#10B981', fontSize: 12, fontWeight: 600 }}>Bảo mật cấp quân sự</p>
      </div>
            ...
            <TrCard className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p style={{ color: c.text3, fontSize: 11, lineHeight: 1.6 }}>{item.desc}</p>
                </div>
              </div>
            </TrCard>
          </motion.div>
      ...
      <TrCard className="p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span style={{ color: c.text2, fontSize: 10, fontWeight: 600, letterSpacing: 0.5 }}>
            MÃ XÁC MINH BẢO MẬT
          </span>
        </div>
        <p
      ...
      {/* How it works */}
      <TrCard className="p-4">
        <p style={{ color: c.text1, fontSize: 13, fontWeight: 700, marginBottom: 10 }}>
          Cách hoạt động
        </p>
        {[
          {
            step: '1',
            label: 'Tạo khóa',
            desc: 'Khi bắt đầu chat, cặp khóa RSA-2048 được tạo trên thiết bị',
            icon: KeyRound,
          },
          {
            step: '2',
            label: 'Trao đổi khóa',
            desc: 'Khóa công khai được trao đổi an toàn qua kênh xác thực',
            icon: Shield,
          },
          {
            step: '3',
            label: 'Mã hóa tin nhắn',
            desc: 'Mỗi tin nhắn được mã hóa AES-256 với khóa phiên duy nhất',
            icon: Lock,
          },
          {
            step: '4',
            label: 'Giải mã an toàn',
            desc: 'Chỉ khóa riêng trên thiết bị đối tác mới có thể giải mã',
            icon: Eye,
          },
        ].map((item, i) => (
      ...
      >
        <div className="flex items-start gap-2">
          ...
          <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.6 }}>
            VitTrade sử dụng kiến trúc Zero-Knowledge. Máy chủ chỉ lưu trữ tin nhắn đã mã hóa và
            không có khả năng giải mã nội dung.
          </p>
        </div>
      </div>
    </PageLayout>

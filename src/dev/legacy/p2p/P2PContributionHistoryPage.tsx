...
const MOCK_CONTRIBUTIONS: Contribution[] = [
  {
    ...
    date: '2026-03-03',
    orderId: 'P2P-78470',
    orderAmount: 7_200_000,
    contributionAmount: 7_200,
    feeRate: 0.1,
    coin: 'BTC',
  },
  {
    ...
    date: '2026-03-02',
    orderId: 'P2P-78460',
    orderAmount: 18_500_000,
    contributionAmount: 18_500,
    feeRate: 0.1,
    coin: 'USDT',
  },
  {
    ...
    date: '2026-03-01',
    orderId: 'P2P-78450',
    orderAmount: 42_000_000,
    contributionAmount: 42_000,
    feeRate: 0.1,
    coin: 'ETH',
  },
  {
  ...
  },
  {
    ...
    date: '2026-02-10',
    orderId: 'P2P-78350',
    orderAmount: 22_000_000,
    contributionAmount: 22_000,
    feeRate: 0.1,
    coin: 'USDT',
  },
  {
    ...
    date: '2026-02-05',
    orderId: 'P2P-78320',
    orderAmount: 35_000_000,
    contributionAmount: 35_000,
    feeRate: 0.1,
    coin: 'ETH',
  },
  {
    ...
    date: '2026-01-28',
    orderId: 'P2P-78280',
    orderAmount: 18_000_000,
    contributionAmount: 18_000,
    feeRate: 0.1,
    coin: 'USDT',
  },
  {
    ...
    date: '2026-01-25',
    orderId: 'P2P-78250',
    orderAmount: 9_500_000,
    contributionAmount: 9_500,
    feeRate: 0.1,
    coin: 'BTC',
  },
  {
    ...
    date: '2026-01-20',
    orderId: 'P2P-78220',
    orderAmount: 28_000_000,
    contributionAmount: 28_000,
    feeRate: 0.1,
    coin: 'ETH',
  },
  {
    ...
    date: '2026-01-15',
    orderId: 'P2P-78180',
    orderAmount: 16_000_000,
    contributionAmount: 16_000,
    feeRate: 0.1,
    coin: 'USDT',
  },
];
        ...
        <TrCard className="p-5">
          ...
          <div className="pt-3" style={{ borderTop: `1px solid ${c.divider}` }}>
            ...
            <div className="flex items-center justify-between mt-2">
              <span style={{ color: c.text2, fontSize: φ.sm, lineHeight: 1.5 }}>Tỷ lệ phí</span>
              <span
                style={{
                  color: c.text1,
                  fontSize: φ.base,

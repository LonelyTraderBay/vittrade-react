          ...
          <div className="flex gap-2 overflow-x-auto pb-2">
            {TAX_YEARS.map((year) => (
              <button
                ...
                style={{
                  background: selectedYear === year ? '#8B5CF6' : c.surface,
          ...
          <div className="flex flex-col gap-2">
            {JURISDICTIONS.map((jur) => (
              <button
                ...
                style={{
                  background:
                    selectedJurisdiction === jur.code ? hexToRgba('#8B5CF6', 12) : c.surface,
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p
                      style={{
                        color: selectedJurisdiction === jur.code ? '#8B5CF6' : c.text1,
                        fontSize: φ.sm,
                        fontWeight: 600,
                      }}
                    >
        ...
        <div className="px-5 mb-6">
          <div className="grid grid-cols-2 gap-3 mb-3">
            <TrCard rounded="md" className="p-4">
              ...
              <p style={{ color: c.text1, fontSize: φ.lg, fontWeight: 700 }}>
            ...
            <TrCard rounded="md" className="p-4">
              ...
              <p style={{ color: c.text1, fontSize: φ.sm, fontWeight: 700 }}>
                {fmtVnd(taxData.totalVolume / 1000000)}M
              </p>
            </TrCard>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <TrCard rounded="md" className="p-4" style={{ background: hexToRgba('#10B981', 10) }}>
              ...
              <p style={{ color: '#10B981', fontSize: φ.md, fontWeight: 700 }}>
                +{fmtVnd(taxData.capitalGains / 1000000)}M
              </p>
            </TrCard>
            ...
            <TrCard rounded="md" className="p-4" style={{ background: hexToRgba('#EF4444', 10) }}>
              ...
              <p style={{ color: '#EF4444', fontSize: φ.md, fontWeight: 700 }}>
                {fmtVnd(taxData.capitalLosses / 1000000)}M
              </p>
            </TrCard>
          </div>
          ...
          <TrCard
            rounded="md"
            className="p-4 mt-3"
            style={{ background: hexToRgba('#8B5CF6', 10) }}
          >
            <div className="flex items-center justify-between">
              <div>
                <p style={{ color: '#8B5CF6', fontSize: 11, fontWeight: 600, marginBottom: 4 }}>
                  Net Capital Gains
                </p>
                <p style={{ color: '#8B5CF6', fontSize: φ.xl, fontWeight: 700 }}>
                  {fmtVnd(taxData.netGains / 1000000)}M VND
                </p>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      ...
                      style={{ background: hexToRgba('#10B981', 15) }}
                    >
              ...
              <TrCard rounded="md" className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className="w-10 h-10 rounded-xl flex items-center justify-center"
                      style={{ background: hexToRgba('#3B82F6', 15) }}
                    >
                    ...
                    <div>
                      ...
                      <p style={{ color: c.text3, fontSize: 10 }}>
                        All transactions for {selectedYear}
                      </p>
                    </div>
                  </div>
                  <button
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
                    Tax forms for {selectedYear} will be available after January 31,{' '}
                    {selectedYear + 1}
                  </p>
                </div>
              </div>
          ...
          <TrCard rounded="md" className="p-4" style={{ background: hexToRgba('#EF4444', 8) }}>
            <div className="flex items-start gap-2">
              ...
              <p style={{ color: c.text2, fontSize: 10, lineHeight: 1.6 }}>
                <strong style={{ color: '#EF4444' }}>Tax Disclaimer:</strong> This report is for
                informational purposes only and should not be considered tax advice. Please consult
                a qualified tax professional for your specific situation. Cryptocurrency tax laws

...
// Import pages
import { P2PKYCStatusPage } from '@/dev/legacy/p2p/P2PKYCStatusPage';
import { P2PSecurityCenterPage } from '@/dev/legacy/p2p/P2PSecurityCenterPage';
import { P2PWalletPage } from '@/dev/legacy/p2p/P2PWalletPage';
import { P2PTransactionLimitsPage } from '@/dev/legacy/p2p/P2PTransactionLimitsPage';

// Mock services
import * as p2pApiService from '@/test/fixtures/p2p-api-service';
...
describe('P2P Security Flow Integration', () => {
  ...
  it('TC2.3: should fetch trusted devices', async () => {
    ...
    expect(mockDevices).toHaveBeenCalledOnce();
  });
});
...
describe('P2P Wallet Flow Integration', () => {
  ...
  it('TC3.3: should fetch escrow balance', async () => {
    ...
    expect(mockEscrow).toHaveBeenCalledOnce();
  });
});
...
describe('P2P Compliance Flow Integration', () => {
  ...
  it('TC4.2: should fetch AML status', async () => {
    ...
    expect(mockAML).toHaveBeenCalledOnce();
  });
...
describe('P2P Payment Method Flow Integration', () => {
  ...
  it('TC5.3: should verify payment method with correct amounts', async () => {
    ...
    expect(result.success).toBe(true);
    expect(mockVerify).toHaveBeenCalledWith('PM-123', [1.23, 4.56]);
  });
  ...
  it('TC5.4: should reject incorrect verification amounts', async () => {
    ...
    expect(mockVerify).toHaveBeenCalledWith('PM-123', [1.0, 2.0]);
  });
});

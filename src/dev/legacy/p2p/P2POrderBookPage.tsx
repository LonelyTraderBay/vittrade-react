...
import { fmtVnd, fmtAmount, fmtCompact } from '@/shared/lib/formatNumber';
...
const MARKET_STATS: Record<Asset, MarketStats> = {
  ...
  BTC: {
    lastPrice: 1_715_000_000,
    change24h: -2.3,
    high24h: 1_755_000_000,
    low24h: 1_698_000_000,
    volume24h: 85_000_000_000,
    trades24h: 892,
  },
  ETH: {
    lastPrice: 89_000_000,
    change24h: 3.5,
    high24h: 91_200_000,
    low24h: 86_500_000,
...
export function P2POrderBookPage() {
  ...
  const { bids, asks } = useMemo(() => generateOrderBook(basePrice, spread), [selectedAsset]);
          ...
          {(['USDT', 'BTC', 'ETH', 'BNB', 'SOL'] as Asset[]).map((asset) => {
            ...
            return (
              ...
              >
                ...
                >
                  {isPositive ? '+' : ''}
                  {assetStats.change24h.toFixed(2)}%
                </p>
              </button>
            );
          })}
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <div
                ...
                style={{
                  background:
                    stats.change24h > 0 ? 'rgba(16,185,129,0.12)' : 'rgba(239,68,68,0.12)',
                }}
              >
                <div className="flex items-center gap-1">
                  ...
                  <span
                    style={{
                      color: stats.change24h > 0 ? '#10B981' : '#EF4444',
                      fontSize: 10,
                      fontWeight: 700,
                    }}
                  >
        ...
        <div className="grid grid-cols-2 gap-3">
          <TrCard className="p-3" accentBorder="rgba(16,185,129,0.3)" style={{ borderWidth: 1.5 }}>
            <div className="flex items-center gap-2 mb-2">
              ...
              <p style={{ color: '#10B981', fontSize: 11, fontWeight: 700, letterSpacing: 0.3 }}>
                BID CAO NHẤT
              </p>
            </div>
            <p
            ...
            <div className="flex items-center justify-between">
              ...
              <span style={{ color: c.text2, fontSize: 11, fontWeight: 600 }}>
                {fmtAmount(bestBid.volume)} {selectedAsset}
              </span>
            </div>
          ...
          <TrCard className="p-3" accentBorder="rgba(239,68,68,0.3)" style={{ borderWidth: 1.5 }}>
            <div className="flex items-center gap-2 mb-2">
              ...
              <p style={{ color: '#EF4444', fontSize: 11, fontWeight: 700, letterSpacing: 0.3 }}>
                ASK THẤP NHẤT
              </p>
            </div>
            <p
            ...
            <div className="flex items-center justify-between">
              <span style={{ color: c.text3, fontSize: 10 }}>Volume</span>
              <span style={{ color: c.text2, fontSize: 11, fontWeight: 600 }}>
                {fmtAmount(bestAsk.volume)} {selectedAsset}
              </span>
            </div>
            <div className="flex items-center justify-between mt-1">
              <span style={{ color: c.text3, fontSize: 10 }}>Lệnh</span>
              ...
              {bids.slice(0, 10).map((bid, i) => {
                ...
                return (
                  <div key={i} className="relative">
                    <div
                      className="absolute right-0 top-0 h-full rounded"
                    ...
                    <div className="relative flex justify-between py-1 px-2">
                      ...
                      >
                        {selectedAsset === 'USDT'
                          ? (bid.price / 1000).toFixed(2)
                          : (bid.price / 1000000).toFixed(3)}
                      </span>
                ...
                return (
                  <div key={i} className="relative">
                    ...
                    <div className="relative flex justify-between py-1 px-2">
                      ...
                      >
                        {selectedAsset === 'USDT'
                          ? (ask.price / 1000).toFixed(2)
                          : (ask.price / 1000000).toFixed(3)}
                      </span>
                      <span style={{ color: c.text2, fontSize: 10, fontFamily: 'monospace' }}>

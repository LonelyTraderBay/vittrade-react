...
const POR_DATA: Record<string, AssetReserve> = {
  ETH: {
    asset: 'ETH',
    onChainBalance: 125430.5,
    userLiabilities: 122000.0,
    reserveRatio: 102.8,
  ...
  SOL: {
    asset: 'SOL',
    onChainBalance: 850000.0,
    userLiabilities: 820000.0,
    reserveRatio: 103.7,
    lastUpdated: '2026-03-07T14:30:00Z',
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                Enter your User ID and staked balance to verify inclusion in the Merkle tree. This
                proves your balance is included in our Proof of Reserves.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-4">
            {merkleProof.verified ? (
              ...
              >
                ...
                <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                  Your balance of <strong>{merkleProof.balance} ETH</strong> is included in the
              ...
              <div className="space-y-2">
                <div className="rounded-xl p-3" style={{ background: c.surface2 }}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {merkleProof.leaf.substring(0, 20)}...
                      {merkleProof.leaf.substring(merkleProof.leaf.length - 10)}
                    </p>
                    <Copy
                      size={12}
                      color={c.text3}
                      className="cursor-pointer shrink-0 ml-2"
                      onClick={() => handleCopy(merkleProof.leaf)}
                    />
                  </div>
                </div>
                ...
                <div className="rounded-xl p-3" style={{ background: c.surface2 }}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {merkleProof.root.substring(0, 20)}...
                      {merkleProof.root.substring(merkleProof.root.length - 10)}
                    </p>
                    <Copy
                      size={12}
                      color={c.text3}
                      className="cursor-pointer shrink-0 ml-2"
                      onClick={() => handleCopy(merkleProof.root)}
                    />
                  </div>
                </div>
                ...
                <div className="rounded-xl p-3" style={{ background: c.surface2 }}>
                  <p style={{ color: c.text3, fontSize: 10, marginBottom: 4 }}>
                    Sibling Hashes ({merkleProof.siblings.length})
                  </p>
                  {merkleProof.siblings.map((sibling, idx) => (
                    ...
                    >
                      {idx + 1}. {sibling.substring(0, 16)}...
                      {sibling.substring(sibling.length - 8)}
                    </p>
                  ))}
                </div>
              </div>
      ...
      <PageContent>
        ...
        >
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                All reserves are verifiable on-chain. Third-party audited monthly. Users can verify
                their balance inclusion via Merkle tree proofs.
              </p>
            </div>
          </div>
        </div>
              ...
              <TrCard className="p-4">
                ...
                <div className="flex items-center justify-center gap-4 mt-3">
                  <div className="flex items-center gap-2">
                    ...
                    <p style={{ color: c.text2, fontSize: 11 }}>+1.7% YoY</p>
                  </div>
                  <div className="w-1 h-1 rounded-full" style={{ background: c.borderSolid }} />
                  <p style={{ color: c.text3, fontSize: 11 }}>Always ≥ 100%</p>
                </div>
              </TrCard>
            </PageSection>
                  ...
                  <TrCard key={asset.asset} className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        ...
                        <p style={{ color: c.text3, fontSize: 11 }}>
                          Updated:{' '}
                          {new Date(asset.lastUpdated).toLocaleTimeString('en-GB', {
                            hour: '2-digit',
                            minute: '2-digit',
                          })}
                        </p>
          ...
          <>
              ...
              <TrCard className="p-4">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                      Prove your staked balance is included in our Proof of Reserves using
                  ...
                  <TrCard key={item.step} className="p-4">
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p style={{ color: c.text3, fontSize: 12, lineHeight: 1.6 }}>{item.desc}</p>
                      </div>
                    </div>
                  </TrCard>
                ))}
            ...
            >
              <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.6 }}>
                💡 <strong>Privacy Note:</strong> Merkle tree verification allows you to prove
                inclusion without revealing your exact balance to others. Only the hash of your
                balance is used in the tree.
              </p>
            </div>
          </>
        )}
        ...
        <div className="rounded-2xl p-4" style={{ background: c.surface2 }}>
          <p style={{ color: c.text3, fontSize: 11, lineHeight: 1.6, textAlign: 'center' }}>
            Proof of Reserves is updated in real-time. On-chain balances are verified every 10
            minutes. Third-party audits conducted monthly by Armanino LLP. Merkle root published
            publicly at por.platform.com.
          </p>
        </div>
      </PageContent>
    </PageLayout>

...
export function StakingInsurancePage() {
  ...
  const totalInsuredValue = POSITIONS.filter((p) => p.insured).reduce(
    ...
    <PageLayout>
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
                <strong>Ví dụ:</strong> Nếu bạn stake $10,000 với plan này, phí bảo hiểm sẽ là $
                {((10000 * selectedPlan.premium) / 100).toFixed(0)}/năm ({selectedPlan.premium}%
                APY). Nếu bị slashing mất $1,000, bạn sẽ được bồi thường $
                {((1000 * selectedPlan.coverage) / 100).toFixed(0)}.
              </p>
            </div>
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          >
            <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
              💡 Claim sẽ được xem xét trong vòng {selectedPlan?.cooldown || 3} ngày. Bạn cần cung
              cấp bằng chứng (transaction hash, screenshot, audit report) để hỗ trợ claim.
            </p>
          </div>
        </div>
      </BottomSheetV2>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                Insurance bồi thường 25-75% thiệt hại nếu validator bị slashing. Phí bảo hiểm chỉ
                0.5-1.5% APY.
              </p>
            </div>
          </div>
                ...
                {[
                  {
                    icon: Shield,
                    label: 'Bảo vệ vốn',
                    desc: 'Bồi thường 25-75%',
                    color: '#10B981',
                  },
                  {
                    icon: Clock,
                    label: 'Xử lý nhanh',
                    desc: 'Claim trong 1-7 ngày',
                    color: '#3B82F6',
                  },
                  {
                    icon: DollarSign,
                    label: 'Phí thấp',
                    desc: 'Chỉ 0.5-1.5% APY',
                    color: '#F59E0B',
                  },
                  {
                    icon: CheckCircle2,
          ...
          <PageSection label="Vị thế Staking">
            <div className="flex flex-col gap-3">
              {POSITIONS.map((position) => {
                const plan = position.insurancePlan
                  ? INSURANCE_PLANS.find((p) => p.id === position.insurancePlan)
                  : null;
                return (
        ...
        {tab === 'claims' && (
          <>
            <div className="flex items-center justify-between">
              <p style={{ color: c.text1, fontSize: 15, fontWeight: 700 }}>Claim History</p>
              <button
              ...
              {CLAIM_HISTORY.length === 0 ? (
                <TrCard className="p-8">
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p style={{ color: c.text3, fontSize: 14 }}>Chưa có claim nào</p>
                  </div>
                </TrCard>
              ) : (
                <div className="flex flex-col gap-3">

    ...
    steps: [
      {
        ...
        description:
          'Gửi tiết kiệm crypto giống như gửi tiền tiết kiệm ngân hàng — bạn gửi tài sản và nhận lãi suất hàng ngày. Tài sản của bạn được sử dụng để cung cấp thanh khoản cho thị trường vay/mượn, và phần lãi được chia lại cho bạn.',
        icon: PiggyBank,
        tips: [
      ...
      },
      {
        ...
        description:
          'Có 2 loại sản phẩm tiết kiệm chính. "Linh hoạt" cho phép rút bất kỳ lúc nào nhưng APY thấp hơn. "Cố định" yêu cầu khóa tài sản trong thời gian nhất định (30, 60, 90 ngày) nhưng APY cao hơn đáng kể.',
        icon: Lock,
        tips: [
      ...
      },
      {
        ...
        description:
          'Chọn sản phẩm phù hợp → Nhập số lượng → Xem lại điều khoản → Xác nhận gửi. Sau khi gửi, lãi sẽ được tính ngay từ ngày hôm sau và tự động phân phối vào ví tiết kiệm.',
        icon: CheckCircle2,
        tips: [
    ...
    steps: [
      {
        ...
        description:
          'Chia tài sản vào nhiều sản phẩm với kỳ hạn khác nhau. Ví dụ: 40% Linh hoạt (thanh khoản khẩn cấp), 30% Cố định 30D, 30% Cố định 60D. Khi mỗi kỳ đáo hạn, bạn có thể quyết định tái gửi hoặc chuyển sang kỳ hạn dài hơn.',
        icon: TrendingUp,
        tips: [
      ...
      },
      {
        ...
        description:
          'Auto-compound tự động gộp lãi nhận được vào gốc để tạo lãi kép. Thay vì nhận lãi về ví, lãi được cộng thẳng vào số tiết kiệm → tháng sau tính lãi trên gốc + lãi cũ. Hiệu quả tăng 5-15% APY thực tế so với không compound.',
        icon: Zap,
        tips: [
      ...
      },
      {
        ...
        description:
          'APY không cố định — nó thay đổi theo cung/cầu thị trường. Khi nhu cầu vay cao (thị trường bull), APY tăng. Khi thị trường im ắng, APY giảm. Theo dõi APY trend để chọn thời điểm gửi Cố định tối ưu.',
        icon: Calculator,
        tips: [
    ...
    steps: [
      {
        ...
        description:
          'Tiết kiệm crypto có rủi ro thấp hơn trading nhưng không phải zero risk. Rủi ro chính: (1) Platform risk — nền tảng gặp sự cố, (2) Market risk — giá tài sản giảm trong khi khóa, (3) Liquidity risk — không rút kịp khi cần, (4) Smart contract risk — lỗi hệ thống kỹ thuật.',
        icon: AlertTriangle,
        tips: [
      ...
      },
      {
        ...
        description:
          'Nếu bạn cần rút tiền từ sản phẩm Cố định trước đáo hạn, phí phạt sẽ áp dụng. Thường là mất toàn bộ hoặc một phần lãi đã tích lũy. Một số sản phẩm có thể tính thêm phí 0.5-2% trên gốc.',
        icon: Shield,
        tips: [
      ...
      },
      {
        ...
        description:
          'Tài sản tiết kiệm được bảo vệ bởi nhiều lớp bảo mật: mã hóa end-to-end, xác thực 2 yếu tố (2FA), quản lý thiết bị, anti-phishing code, và Quỹ Bảo hiểm. Luôn bật đầy đủ các lớp bảo mật trước khi gửi số lượng lớn.',
        icon: Shield,
        tips: [
...
const QUICK_TIPS = [
  {
    icon: PiggyBank,
    title: 'Bắt đầu nhỏ',
    desc: 'Gửi $50-200 đầu tiên để làm quen với hệ thống',
    color: '#10B981',
  },
  {
    icon: TrendingUp,
    title: 'Theo dõi APY',
    desc: 'APY thay đổi liên tục, kiểm tra hàng tuần',
    color: '#3B82F6',
  },
  {
    icon: Shield,
    title: 'Bật 2FA',
    desc: 'Bảo vệ tài khoản trước khi gửi số lượng lớn',
    color: '#EF4444',
  },
  {
    icon: Zap,
    title: 'Auto-compound',
    desc: 'Bật tái đầu tư tự động để tối đa lãi kép',
    color: '#8B5CF6',
  },
  {
    icon: Lock,
    title: 'Ladder strategy',
    desc: 'Chia tài sản vào nhiều kỳ hạn khác nhau',
    color: '#F59E0B',
  },
  {
    icon: Calculator,
    title: 'Tính phí rút sớm',
    desc: 'Luôn kiểm tra phí trước khi rút Cố định sớm',
    color: '#06B6D4',
  },
];
...
export function SavingsGuidePage() {
  ...
  const progress =
    TUTORIALS.length > 0 ? Math.round((completedTutorials.size / TUTORIALS.length) * 100) : 0;
                ...
                <div className="rounded-xl p-3" style={{ background: c.surface2 }}>
                  ...
                  <ul className="flex flex-col gap-1.5" style={{ paddingLeft: 16 }}>
                    {step.tips.map((tip, idx) => (
                      <li
                        key={idx}
                        style={{ color: c.text2, fontSize: FONT_SCALE.xs, lineHeight: 1.6 }}
                      >
                        {tip}
                      </li>
                    ))}
          ...
          <>
            ...
            <div
              ...
              style={{
                ...
                border: `1.5px solid ${withAlpha(c.success, ALPHA.soft)}`,
              }}
            >
            ...
            <TrCard>
              ...
              <div className="flex items-center gap-1.5 mt-2">
                <CheckCircle2
                  size={ICON_SIZE.sm}
                  color={progress === 100 ? c.success : c.text3}
                  strokeWidth={ICON_STROKE.standard}
                />
                <span
                  style={{ color: progress === 100 ? c.success : c.text3, fontSize: FONT_SCALE.xs }}
                >
                  {progress === 100
                  ...
                  return (
                    <TrCard key={idx}>
                      <div className="flex flex-col gap-2 p-1">
                        ...
                        <div
                          style={{ color: c.text3, fontSize: FONT_SCALE.micro, lineHeight: 1.4 }}
                        >
                          {tip.desc}
                        </div>
                      </div>
          ...
          <>
            ...
            >
              ...
              <span style={{ color: '#3B82F6', fontSize: FONT_SCALE.micro, lineHeight: 1.4 }}>
                Thuật ngữ và giải thích mang tính giáo dục, không phải lời khuyên tài chính. Luôn tự
                nghiên cứu trước khi đưa ra quyết định đầu tư.
              </span>
            </div>
          </>
        )}

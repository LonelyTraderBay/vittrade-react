...
const EVENTS: CalendarEvent[] = [
  {
    ...
    usdValue: 0.45,
    color: '#26A17B',
    description: 'Nhận lãi hàng ngày',
  },
  {
    id: 'e2',
    date: '2026-03-08',
  ...
  },
  {
    ...
    usdValue: 3.15,
    color: '#8B5CF6',
    description: 'Tái đầu tư tự động (hàng tuần)',
  },
  {
    id: 'e5',
    date: '2026-03-15',
    ...
    usdValue: 6656,
    color: '#9945FF',
    description: 'Đến hạn - Nhận vốn + lãi',
  },
  {
    id: 'e6',
    date: '2026-03-21',
...
export function StakingEarningsCalendarPage() {
  ...
  const handleExportCalendar = () => {
    alert(
      'Xuất lịch nhận lãi (.ics) sẽ sớm ra mắt. Bạn có thể thêm vào Google Calendar / Apple Calendar.',
    );
  };
        ...
        <TrCard className="p-4">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p
                style={{ color: '#10B981', fontSize: 22, fontWeight: 700, fontFamily: 'monospace' }}
              >
              ...
              <div className="flex flex-col gap-2">
                {upcomingEvents.map((event) => {
                  ...
                  const daysUntil = Math.ceil(
                    (eventDate.getTime() - new Date(2026, 2, 7).getTime()) / (1000 * 60 * 60 * 24),
                  );
                    ...
                    <TrCard key={event.id} className="p-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p
                            style={{ color: c.text2, fontSize: 12, marginBottom: 2 }}
                            className="text-truncate"
                          >
                            {event.product}
                          </p>
                        ...
                        <div className="text-right shrink-0">
                          ...
                          {event.type === 'rate-change' && (
                            <>
                              ...
                              <p style={{ color: c.text3, fontSize: 10 }}>(từ {event.oldRate}%)</p>
                            </>
                          )}
                        </div>
                      </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <ul style={{ color: c.text2, fontSize: 12, lineHeight: 1.7, paddingLeft: 16 }}>
                <li>
                  Lãi được phân phối <strong>tự động</strong> vào ví staking của bạn
                </li>
                <li>
                  Bật thông báo để nhận alert trước <strong>24 giờ</strong>
                </li>

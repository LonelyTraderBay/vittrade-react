          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                Manage staking positions across Ethereum, Polygon, Avalanche, Cosmos, and Solana
                from one dashboard. Unified rewards tracking.
              </p>
            </div>
          </div>
        </div>
        ...
        <PageSection label="Quick Actions">
          <div className="grid grid-cols-2 gap-3">
            <TrCard hover className="p-4">
              ...
              <p style={{ color: c.text3, fontSize: 10 }}>Optimize allocation across chains</p>
            </TrCard>
            <TrCard hover className="p-4">
              ...
              <p style={{ color: c.text3, fontSize: 10 }}>Expand to new networks</p>
            </TrCard>
          </div>
        </PageSection>
              ...
              {[
                {
                  ...
                  desc: 'Reduce risk by spreading across multiple blockchains',
                },
                ...
                >
                  ...
                  <p style={{ color: c.text3, fontSize: 11, lineHeight: 1.5 }}>{benefit.desc}</p>
                </div>
              ))}
            </div>
          </TrCard>
        ...
        <div className="rounded-2xl p-4" style={{ background: c.surface2 }}>
          <div className="flex gap-3">
            ...
            <p style={{ color: c.text3, fontSize: 11, lineHeight: 1.6 }}>
              Cross-chain positions require separate wallet connections for each network. Bridge
              fees apply when moving assets between chains. Always verify contract addresses.
            </p>
          </div>
        </div>
      </PageContent>

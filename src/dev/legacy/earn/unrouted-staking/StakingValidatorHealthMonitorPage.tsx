...
export function StakingValidatorHealthMonitorPage() {
  ...
  const avgUptime = (VALIDATORS.reduce((sum, v) => sum + v.uptime, 0) / VALIDATORS.length).toFixed(
    2,
  );
      ...
      <PageContent>
        ...
        <TrCard className="p-4">
          <div className="grid grid-cols-3 gap-3">
            ...
            >
              ...
              <p style={{ color: '#10B981', fontSize: 20, fontWeight: 700 }}>{healthyCount}</p>
              <p style={{ color: c.text3, fontSize: 10 }}>Healthy</p>
            </div>
            <div
              className="text-center p-3 rounded-xl"
              style={{ background: warningCount > 0 ? 'rgba(245,158,11,0.08)' : c.surface2 }}
            >
              <AlertCircle
                size={20}
                color={warningCount > 0 ? '#F59E0B' : c.text3}
                className="mx-auto mb-2"
              />
              <p
                style={{
                  color: warningCount > 0 ? '#F59E0B' : c.text1,
                  fontSize: 20,
                  fontWeight: 700,
                }}
              >
            ...
            <div className="text-center p-3 rounded-xl" style={{ background: c.surface2 }}>
              ...
              <p style={{ color: c.text1, fontSize: 20, fontWeight: 700 }}>{avgUptime}%</p>
            ...
            {VALIDATORS.map((validator) => {
              ...
              return (
                <TrCard
                  ...
                  className="p-4"
                  onClick={() =>
                    setSelectedValidator(validator.id === selectedValidator ? null : validator.id)
                  }
                >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-1">
                          ...
                          <p style={{ color: c.text2, fontSize: 11 }}>{validator.uptime}% uptime</p>
                        </div>
                        <div
                          className="w-1 h-1 rounded-full"
                          style={{ background: c.borderSolid }}
                        />
                        <p style={{ color: c.text3, fontSize: 11 }}>{validator.apr}% APR</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <div className="rounded-lg p-2" style={{ background: c.surface2 }}>
                      ...
                      <p
                        style={{
                          color: validator.missedBlocks > 10 ? '#F59E0B' : c.text1,
                          fontSize: 12,
                          fontWeight: 700,
                        }}
                      >
                  ...
                  {selectedValidator === validator.id && (
                    <div className="mt-3 pt-3 border-t" style={{ borderColor: c.borderSolid }}>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <p style={{ color: c.text3, fontSize: 11 }}>{validator.lastBlock}</p>
                      </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6, marginBottom: 8 }}>
                  {warningCount} validator(s) showing degraded performance. Consider rebalancing
                  your stake to healthier validators.
                </p>
                <button
        ...
        <div className="rounded-2xl p-4" style={{ background: c.surface2 }}>
          <p style={{ color: c.text3, fontSize: 11, lineHeight: 1.6, textAlign: 'center' }}>
            Validator metrics updated every 5 minutes. Uptime calculated based on last 10,000
            blocks. Auto-rebalancing triggers when validator uptime drops below 99%.
          </p>
        </div>
      </PageContent>
    </PageLayout>

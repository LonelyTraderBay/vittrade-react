          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                Stake và nhận liquid token (stToken) có thể giao dịch ngay lập tức. Bạn vẫn nhận
                phần thưởng staking trong khi giữ thanh khoản 100%.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              <div className="flex gap-2">
                ...
                <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
                  <strong>Lưu ý:</strong> Liquid token có rủi ro smart contract và depegging (mất
                  peg so với asset gốc). Chỉ stake số lượng bạn có thể chấp nhận rủi ro.
                </p>
              </div>
            </div>
          </>
          ...
          <>
            <TrCard className="p-4">
              <div className="flex flex-col gap-4">
                <div>
                  <label
                    style={{ color: c.text2, fontSize: 13, display: 'block', marginBottom: 8 }}
                  >
                    Từ
                  </label>
                  <div className="flex gap-2">
                ...
                {swapAmount && (
                  <div className="rounded-2xl p-3" style={{ background: c.surface2 }}>
                    <BottomSheetRow
                      label="Exchange Rate"
                      value={`1 ${swapFrom} = ${stToken?.exchangeRate} ${swapTo}`}
                    />
            ...
            >
              <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
                💡 <strong>Gợi ý:</strong> Swap qua DEX aggregator (1inch, Paraswap) để có rate tốt
                nhất. Slippage có thể cao hơn trong thời điểm thị trường biến động.
              </p>
            </div>
          </>
        )}

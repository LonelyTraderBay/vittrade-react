...
import {
  ...
  MarketSentiment,
  FundingRateHistory,
} from '@/dev/legacy/trading/components/MarketIntelligence';
import {
  LiquidationHeatmap,
  RecentLiquidations,
  LiquidationStats,
} from '@/dev/legacy/trading/components/LiquidationAnalyticsComponents';
import {
...
} from '@/dev/legacy/trading/providers/MarketDataWSProvider';

      ...
      >
        ...
        <div className="overflow-y-auto flex-1 px-5 pb-6 flex flex-col gap-4">
          ...
          <div
            ...
            style={{ background: strategy.color + '11', border: `1px solid ${strategy.color}33` }}
          >
          ...
          <button onClick={() => setAgreed(!agreed)} className="flex items-start gap-2">
            <div
              ...
              style={{
                borderColor: agreed ? strategy.color : c.borderSolid,
            ...
            <span style={{ color: c.text2, fontSize: 12, lineHeight: 1.5, textAlign: 'left' }}>
              ...
              <span style={{ color: '#3B82F6' }}>điều khoản sử dụng Bot</span>
            </span>
          </button>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 14,
              background: agreed
                ? `linear-gradient(135deg, ${strategy.color} 0%, ${strategy.color}aa 100%)`
                : c.surface2,
...
export function TradingBotsDemoPage() {
  const c = useThemeColors();
    ...
    <PageLayout>
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-5 relative z-10">
          ...
          <div>
            <p style={{ color: '#FFFFFF', fontSize: 20, fontWeight: 800, letterSpacing: -0.3 }}>
        ...
        <div className="grid grid-cols-3 gap-3 relative z-10">
          {[
            ...
            >
              <p style={{ color: s.color, fontSize: 14, fontWeight: 700, fontFamily: 'monospace' }}>
                {s.value}
              </p>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          ...
                          style={{
                            background: bot.status === 'running' ? '#10B981' : '#F59E0B',
                            boxShadow: bot.status === 'running' ? '0 0 6px #10B981' : 'none',
                          }}
                        />
                        <span
                          style={{
        ...
        <div className="px-5 mt-4 flex flex-col gap-4">
          ...
          <TrCard className="p-4" accentBorder="rgba(59,130,246,0.2)">
            <div className="flex items-center gap-2 mb-3">
              ...
              <p style={{ color: '#3B82F6', fontSize: 13, fontWeight: 600 }}>
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <p style={{ color: '#F0F4FF', fontSize: 16, fontWeight: 700 }}>
                          {strategy.name}
                        </p>
                        <span
                          className="px-2 py-1 rounded-md text-xs font-bold"
                      ...
                      <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.4 }}>
          ...
          <TrCard className="p-4" accentBorder="rgba(245,158,11,0.2)">
            <div className="flex items-start gap-2">
              ...
              <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.5 }}>
                <span style={{ color: '#F59E0B', fontWeight: 600 }}>Lưu ý quan trọng:</span> Bot

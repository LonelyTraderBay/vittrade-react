...
import { ProviderGovernancePage } from '@/dev/legacy/trade/ProviderGovernancePage';
...
describe('ProviderGovernancePage', () => {
  ...
  it('should show strategy modification log with 24h notice requirement', () => {
    ...
    expect(screen.getByText(/notify all followers at least 24 hours before/i)).toBeInTheDocument();
  ...
  it('should list follower communications on the Communication tab', async () => {
    ...
    expect(screen.getByText('Strategy Change Notification: Swing → Scalping')).toBeInTheDocument();

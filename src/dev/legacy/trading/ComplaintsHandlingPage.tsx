...
export function ComplaintsHandlingPage() {
  ...
  return (
    <PageLayout>
      <Header title="Complaints Handling" subtitle="FCA Regulated Process" back />
        ...
        >
          ...
          <div>
            ...
            <p style={{ color: c.info, fontSize: 10, lineHeight: 1.4, opacity: 0.9 }}>
              You have the right to complain. We will investigate fairly and respond within 8 weeks.
              If dissatisfied, you can refer to the Financial Ombudsman Service.
            </p>
          </div>
        </div>
                  ...
                  {[
                    ...
                    <div key={item.step} className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p style={{ color: c.text3, fontSize: 10, marginTop: 1 }}>{item.time}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {MY_COMPLAINTS.map((complaint) => {
                ...
                return (
                  <TrCard
                    ...
                    hover
                    onClick={() =>
                      navigate(`${prefix}/trade/copy-trading/complaint-tracking/${complaint.id}`)
                    }
                  >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.4, marginTop: 1 }}>
                        If you're not satisfied, you can refer to the Financial Ombudsman Service
                        (free)
                      </p>
                    </div>
                  </div>
            ...
            <PageSection label="Financial Ombudsman Service">
              <TrCard className="p-4">
                <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5, marginBottom: 3 }}>
                  The Financial Ombudsman Service is a free, independent service that settles
                ...
                <div className="rounded-lg p-3 mb-3" style={{ background: c.surface2 }}>
                  ...
                  <p style={{ color: c.text1, fontSize: 11 }}>Phone: 0800 023 4567</p>

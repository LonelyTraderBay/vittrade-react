...
import { Settings, Bell, Shield, Mail, Eye, EyeOff, Info, Zap } from 'lucide-react';
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                style={{
                  background: settings.emailNotifications ? c.primaryAlpha08 : c.surface2,
              ...
              <button
                ...
                className="p-3 rounded-xl flex items-center gap-2 transition-all"
                style={{
                  background: settings.pushNotifications ? c.primaryAlpha08 : c.surface2,

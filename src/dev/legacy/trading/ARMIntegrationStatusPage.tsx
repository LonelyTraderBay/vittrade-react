...
const STATUS_CONFIG: Record<ConnectionStatus, { color: string; label: string; icon: LucideIcon }> =
  {
                ...
                <TrCard key={conn.id} className="p-4">
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {conn.isPrimary && (
                          <span
                            ...
                            style={{ background: c.primaryAlpha08, color: c.primary }}
                          >
                            PRIMARY
                          </span>
                        )}
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      style={{
                        background: testing === conn.id ? c.surface2 : c.primaryAlpha08,

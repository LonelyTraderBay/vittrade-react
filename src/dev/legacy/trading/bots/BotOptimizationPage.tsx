            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                  Grid Count: <strong>{bestResult.param1}</strong>, Grid Range:{' '}
                  <strong>{bestResult.param2}%</strong> → Sharpe Ratio:{' '}
                  <strong>{bestResult.sharpe}</strong>
                </p>
              </div>
            </div>
          </div>
                ...
                <ScatterChart>
                  <XAxis
                    ...
                    label={{
                      ...
                      offset: -5,
                      style: { fontSize: 10, fill: c.text3 },
                    }}
                  />
                  <YAxis
                    key="y-axis"
                  ...
                  <Scatter key="scatter" name="Parameter Sets" data={OPTIMIZATION_RESULTS}>
                    {OPTIMIZATION_RESULTS.map((entry, index) => (
                      <Cell
                        key={`cell-${index}`}
                        fill={
                          entry.id === bestResult.id
                            ? '#10B981'
                            : entry.id === selectedResult
                              ? c.primary
                              : c.text3
                        }
                        opacity={
                          entry.id === bestResult.id || entry.id === selectedResult ? 1 : 0.3
                        }
                      />
                    ))}
                  </Scatter>
              ...
              <div className="flex items-center gap-4 mt-3 justify-center">
                ...
                <div className="flex items-center gap-2">
                  <div
                    ...
                    style={{ background: c.text3, opacity: 0.3 }}
                  />
              ...
              <div className="space-y-2">
                {OPTIMIZATION_RESULTS.map((result, idx) => (
                  <button
                    ...
                    style={{
                      background: result.id === selectedResult ? `${c.primaryAlpha08}` : c.surface2,
              ...
              {[
                {
                  ...
                  desc: 'Best risk-adjusted returns',
                  selected: true,
                },
                {
                  id: 'returns',
                  label: 'Maximize Total Returns',
                  desc: 'Highest absolute profit',
                  selected: false,
                },
                {
                  id: 'drawdown',
                ...
                <div
                  ...
                  style={{
                    background: opt.selected ? `${c.primaryAlpha08}` : c.surface2,
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <p
                      style={{
                        color: opt.selected ? c.primary : c.text1,
                        fontSize: 13,
                        fontWeight: 600,
                      }}
                    >

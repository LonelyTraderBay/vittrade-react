          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.6 }}>
                You must read and accept these terms before using Trading Bots. Scroll to the bottom
          ...
          >
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ color: c.text2, fontSize: 13, lineHeight: 1.7, marginBottom: 12 }}>
                By using our Trading Bots service ("Service"), you agree to be bound by these Terms
                of Service ("Terms"). If you do not agree to these Terms, you must not use the
                Service.
              </p>
              <p style={{ color: c.text2, fontSize: 13, lineHeight: 1.7 }}>
                These Terms constitute a legally binding agreement between you and the Company. Your
                use of automated trading algorithms is subject to additional regulatory requirements
                which you acknowledge and accept.
              </p>
            </div>
              ...
              >
                <div className="flex gap-2">
                  ...
                  <p style={{ color: '#EF4444', fontSize: 12, lineHeight: 1.6 }}>
                    <strong>CRITICAL WARNING:</strong> Trading Bots do NOT guarantee profits. Past
                    performance does not predict future results. You may lose some or all of your
                    invested capital.
                  </p>
                </div>
              </div>
              <p style={{ color: c.text2, fontSize: 13, lineHeight: 1.7 }}>
                Automated trading carries significant risk. Market conditions, volatility,
                liquidity, technical failures, and other factors can result in substantial losses.
                You should only invest capital you can afford to lose entirely.
              </p>
            </div>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              >
                <li>
                  <strong>Market Risk:</strong> Cryptocurrency markets are highly volatile and can
                  move against your positions.
                </li>
                <li>
                  <strong>Liquidity Risk:</strong> Insufficient market liquidity may prevent bot
                  execution at desired prices.
                </li>
                <li>
                  <strong>Slippage Risk:</strong> Actual execution prices may differ significantly
                  from expected prices.
                </li>
                <li>
                  <strong>Technical Risk:</strong> System failures, bugs, or network issues may
                  cause unexpected bot behavior.
                </li>
                <li>
                  <strong>Leverage Risk:</strong> Strategies like Martingale can amplify losses
                  beyond initial investment.
                </li>
                <li>
                  <strong>Regulatory Risk:</strong> Changes in regulations may affect your ability
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <ul style={{ color: c.text2, fontSize: 13, lineHeight: 1.8, paddingLeft: 20 }}>
                ...
                <li>
                  Maintaining sufficient account balance to cover trading fees and margin
                  requirements
                </li>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ color: c.text2, fontSize: 13, lineHeight: 1.7 }}>
                Our maximum liability is limited to the fees you paid for the Service in the 12
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ color: c.text2, fontSize: 13, lineHeight: 1.7 }}>
                ...
                or without notice. We may disable bots, change strategies, or impose new
                restrictions as necessary to comply with regulations or protect user interests. You
                may terminate your use of the Service at any time by stopping all bots and closing
                your account.
              </p>
            </div>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ color: c.text2, fontSize: 13, lineHeight: 1.7 }}>
                ...
                Organization]. You waive your right to participate in class action lawsuits. This
                agreement is governed by the laws of [Jurisdiction].
              </p>
            </div>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ color: c.text2, fontSize: 13, lineHeight: 1.7 }}>
                Trading Bots may be classified as complex financial products under MiFID II (EU),
                requiring appropriateness assessment. By accepting these Terms, you confirm that you
                have completed the suitability questionnaire and understand the risks involved.
                Certain jurisdictions may prohibit automated trading - you are responsible for
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ color: c.text2, fontSize: 13, lineHeight: 1.7 }}>
                We collect and process trading data, bot performance metrics, and account
                information to provide the Service. This data may be used for analytics, risk
                monitoring, and service improvement. We do not sell your personal data to third
            ...
            <div className="border-t pt-4" style={{ borderColor: c.borderSolid }}>
              <p style={{ color: c.text3, fontSize: 12, textAlign: 'center' }}>— End of Terms —</p>
            </div>
          </div>
        </TrCard>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p style={{ color: c.text3, fontSize: 12, lineHeight: 1.5 }}>
                By checking this box, you acknowledge that you understand the risks of automated
                trading and accept the terms outlined above.
              </p>
            </div>
          </button>
        </PageSection>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: c.text3, fontSize: 12, lineHeight: 1.6 }}>
                These terms comply with MiFID II (EU), SEC regulations (US), FCA guidelines (UK),
                and other applicable financial regulations. Acceptance is recorded and auditable.
              </p>
            </div>
          </div>
        </div>

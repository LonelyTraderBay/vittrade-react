    ...
    <PageLayout variant="flush">
      ...
      <PageContent grow>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p style={{ color: c.text1, fontSize: 13, lineHeight: 1.6 }}>
                This will immediately stop all running bots and cancel pending orders. Use this only
                in emergency situations (market crash, technical issues, unauthorized activity).
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-2">
            {[
              ...
              >
                ...
                <p style={{ color: reason === r.id ? '#EF4444' : c.text1, fontSize: 13 }}>
                  {r.label}
                </p>
              </button>
            ))}
        ...
        <PageSection label="Additional Actions">
          ...
          >
            <div
              className="w-6 h-6 rounded-md border-2 flex items-center justify-center shrink-0 mt-1"
              style={{
            ...
            <div className="flex-1">
              ...
              <p style={{ color: c.text3, fontSize: 12, lineHeight: 1.5 }}>
                ⚠️ WARNING: This will sell all holdings at market price. Only use if you need to
                exit immediately. May incur slippage.
              </p>
            </div>
          </button>
        </PageSection>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.5 }}>
                All running bots will stop immediately. Pending orders will be cancelled. This
                action cannot be undone. I take full responsibility for this decision.
              </p>
            </div>
          </button>
        </PageSection>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p style={{ color: c.text3, fontSize: 12, lineHeight: 1.6 }}>
                Our security team will be automatically notified of this emergency stop for review
                and assistance. You'll receive a confirmation email within 5 minutes.
              </p>
            </div>
          </div>
        </div>

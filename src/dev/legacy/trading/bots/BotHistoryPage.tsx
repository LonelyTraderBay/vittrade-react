...
export function BotHistoryPage() {
  ...
  return (
    <PageLayout>
      <Header title="Trade History" back action={{ icon: Download, onClick: handleExport }} />
      ...
      <PageContent>
            ...
            <div className="flex flex-col gap-2">
              {filteredTrades.map((trade) => (
                <TrCard key={trade.id} className="p-4">
                  ...
                  >
                    <p style={{ color: c.text3, fontSize: 10 }}>{trade.timestamp}</p>
                    <span
                      className="px-2 py-1 rounded-md text-xs font-bold"
        ...
        <div className="rounded-2xl p-4" style={{ background: c.surface2 }}>
          ...
          <p style={{ color: c.text3, fontSize: 12, lineHeight: 1.6, marginBottom: 8 }}>
            Download your complete trade history for tax reporting, accounting, or analysis.
            Available formats: CSV, PDF, Excel.
          </p>
          <button

...
import { AlertTriangle, TrendingUp, Activity, Target, CheckCircle, XCircle } from 'lucide-react';
...
import { fmtNum } from '@/shared/lib/formatNumber';
import {
  LineChart,
  Line,
  XAxis,
...
export function SlippageMonitoringPage() {
  ...
  return (
    <PageLayout>
      <Header title="Slippage Monitoring" subtitle="Real-time Tracking · Alerts" back />

...
export function BestExecutionReportsPage() {
  ...
  const handleExportPDF = (reportId: string) => {
    actionToast.info(`PDF export for ${reportId} is not connected to a report service yet.`);
  };

  const handlePublishReport = () => {
    actionToast.info('Report publishing is a demo action and is not connected to a regulator.');
  };

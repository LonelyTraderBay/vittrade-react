          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex-1">
              ...
              <p style={{ color: c.text3, fontSize: 11, lineHeight: 1.4 }}>
                The Financial Ombudsman Service (FOS) is a free service that settles complaints
          ...
          <TrCard className="p-4">
            <div className="space-y-3">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p style={{ color: c.text1, fontSize: 12, fontWeight: 600 }}>After 8 Weeks</p>
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle size={16} color="#10B981" className="shrink-0 mt-0.5" />
                <div>
                  <p style={{ color: c.text1, fontSize: 12, fontWeight: 600 }}>Not Satisfied</p>
                  <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.4, marginTop: 1 }}>
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle size={16} color="#10B981" className="shrink-0 mt-0.5" />
                <div>
                  <p style={{ color: c.text1, fontSize: 12, fontWeight: 600 }}>Within 6 Months</p>
                  <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.4, marginTop: 1 }}>
            ...
            {[
              {
                ...
                desc: 'Contact FOS with your complaint details',
              },
              ...
              { step: 3, title: 'Investigation', desc: 'Independent investigation of the facts' },
              {
                step: 4,
                title: 'Decision',
                desc: 'FOS makes a binding decision (for us, not you)',
              },
            ].map((item) => (

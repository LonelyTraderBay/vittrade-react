...
const STATUS_CONFIG: Record<ReportStatus, { color: string; label: string; icon: LucideIcon }> = {
...
export function TransactionReportingPage() {
  ...
  const handleRetry = (_reportId: string) => {
    // In production: call API to retry submission
  };

  const handleViewXML = (_reportId: string) => {

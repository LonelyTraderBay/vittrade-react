...
import { AITradingSignals, type AISignal } from '@/dev/legacy/trading/components/AITradingSignals';
import {
  PortfolioRiskAnalyzer,
  type RiskMetrics,
} from '@/dev/legacy/trading/components/PortfolioRiskAnalyzer';
import {
  TradeJournal,
  type TradeEntry,
  type JournalStats,
} from '@/dev/legacy/trading/components/TradeJournal';

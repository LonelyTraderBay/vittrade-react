...
export function ProviderApplicationPage() {
  ...
  const canProceedFromRequirements =
    formData.hasKYC && formData.tradingMonths >= 6 && formData.minCapital >= 10000;
  const canProceedFromDisclosure = formData.agreedToDisclosure && formData.agreedToFiduciary;
  ...
  return (
    <PageLayout variant="flush">
      <Header title="Đăng ký Provider" back breadcrumb={false} />
      ...
      <PageContent grow padding="default" gap="relaxed">
          ...
          {['intro', 'requirements', 'disclosure', 'fees', 'review'].map((s, i) => (
            <React.Fragment key={s}>
              <div
                ...
                style={{
                  background:
                    ['intro', 'requirements', 'disclosure', 'fees', 'review'].indexOf(step) >= i
                      ? c.primary
                      : c.border,
                }}
              />
          ...
          <div className="space-y-4">
            <div className="text-center py-6">
              <div
                ...
                style={{ background: c.primaryAlpha12 }}
              >
                ...
                {[
                  {
                    ...
                    desc: 'Nhận 10-30% từ lợi nhuận của copiers',
                  },
                  {
                    icon: Users,
                    title: 'Xây dựng danh tiếng',
                    desc: 'Trở thành trader được công nhận',
                  },
                  {
                    icon: TrendingUp,
                    title: 'Không giới hạn thu nhập',
                    desc: 'Thu nhập tăng theo số người copy',
                  },
                ].map((item) => {
            ...
            <div
              ...
              style={{ background: c.warningBg, border: `2px solid ${c.warningBorder}` }}
            >
        ...
        {step === 'requirements' && (
          <div className="space-y-4">
            <h3 style={{ color: c.text1, fontSize: 16, fontWeight: 700 }}>Kiểm tra điều kiện</h3>
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, tradingMonths: parseInt(e.target.value) || 0 })
                }
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, minCapital: parseInt(e.target.value) || 0 })
                }
                className="w-full px-4 py-3 rounded-xl"
                style={{
                  background: c.surface2,
            ...
            {!canProceedFromRequirements && (
              <div className="p-3 rounded-xl" style={{ background: c.sellAlpha10 }}>
                <p style={{ color: c.error, fontSize: 11, textAlign: 'center', lineHeight: 1.5 }}>
                  Bạn chưa đáp ứng tất cả các yêu cầu. Hoàn thành KYC, trading history, và vốn tối
                  thiểu để tiếp tục.
                </p>
              </div>
            )}
        ...
        {step === 'disclosure' && (
          <div className="space-y-4">
            <h3 style={{ color: c.text1, fontSize: 16, fontWeight: 700 }}>Nghĩa vụ công khai</h3>
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <p style={{ color: c.primary, fontSize: 11, lineHeight: 1.5 }}>
                  Là provider, bạn phải công khai đầy đủ thông tin để copiers đưa ra quyết định sáng
                  suốt.
                </p>
              </div>
            </div>
            ...
            <button
              onClick={() =>
                setFormData({ ...formData, agreedToDisclosure: !formData.agreedToDisclosure })
              }
              className="w-full p-3 rounded-xl text-left flex items-start gap-3 transition-all"
              style={{
                background: formData.agreedToDisclosure ? c.primaryAlpha08 : c.surface2,
            ...
            >
              ...
              <p style={{ color: c.text1, fontSize: 11, lineHeight: 1.5 }}>
                Tôi cam kết công khai tất cả thông tin trên và cập nhật liên tục. Vi phạm sẽ dẫn đến
                đình chỉ và truy cứu pháp lý.
              </p>
            </button>

            <button
              onClick={() =>
                setFormData({ ...formData, agreedToFiduciary: !formData.agreedToFiduciary })
              }
              className="w-full p-3 rounded-xl text-left flex items-start gap-3 transition-all"
              style={{
                background: formData.agreedToFiduciary ? c.primaryAlpha08 : c.surface2,
            ...
            >
              ...
              <p style={{ color: c.text1, fontSize: 11, lineHeight: 1.5 }}>
                Tôi hiểu rằng hành động của tôi ảnh hưởng trực tiếp đến tài sản của copiers. Tôi cam
                kết hành động vì lợi ích tốt nhất của họ (fiduciary duty).
              </p>
            </button>
          </div>
        )}
        {step === 'fees' && (
          <div className="space-y-4">
            <h3 style={{ color: c.text1, fontSize: 16, fontWeight: 700 }}>Cấu trúc phí</h3>
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, performanceFee: parseInt(e.target.value) || 0 })
                }
                className="w-full px-4 py-3 rounded-xl"
                style={{
                  background: c.surface2,
              ...
              <div className="mt-3 p-2 rounded-lg" style={{ background: c.surface2 }}>
                <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.4 }}>
                  Ví dụ: Copier lời $100 → bạn nhận $
                  {((100 * formData.performanceFee) / 100).toFixed(0)}
                </p>
              </div>
            </div>
        ...
        {step === 'review' && (
          <div className="space-y-4">
            <h3 style={{ color: c.text1, fontSize: 16, fontWeight: 700 }}>Xem lại đơn đăng ký</h3>
            ...
            <button
              type="button"
              aria-pressed={formData.agreedToTerms}
              onClick={() => setFormData({ ...formData, agreedToTerms: !formData.agreedToTerms })}
              className="w-full p-3 rounded-xl text-left flex items-start gap-3 transition-all"
              style={{
                background: formData.agreedToTerms ? c.primaryAlpha08 : c.surface2,
            ...
            >
              ...
              <p style={{ color: c.text1, fontSize: 11, lineHeight: 1.5 }}>
                ...
                <span className="underline" style={{ color: c.primary }}>
                  Điều khoản Provider
                </span>
                ,
                <span className="underline ml-1" style={{ color: c.primary }}>
                  Code of Conduct
                </span>
                , và
                <span className="underline ml-1" style={{ color: c.primary }}>
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <p style={{ color: c.primary, fontSize: 10, lineHeight: 1.5 }}>
                  Sau khi gửi, chúng tôi sẽ xem xét đơn trong 2-3 ngày làm việc. Bạn sẽ nhận email
                  thông báo kết quả.
                </p>
              </div>
            </div>

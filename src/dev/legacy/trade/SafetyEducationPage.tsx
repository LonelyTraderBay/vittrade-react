      ...
      <PageContent gap="relaxed">
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    ...
                    style={{
                      transform: expandedScam === scam.id ? 'rotate(180deg)' : 'rotate(0deg)',
                    }}
                  />
                </button>
                ...
                {expandedScam === scam.id && (
                  <div className="px-4 pb-4" style={{ borderTop: `1px solid ${c.border}` }}>
                    <div className="pt-4 space-y-3">
                      <div>
                        <p
                          style={{ color: c.text2, fontSize: 11, fontWeight: 600, marginBottom: 6 }}
                        >
                          Ví dụ:
                        </p>
        ...
        {activeTab === 'redflags' && (
          <div className="space-y-4">
            <p style={{ color: c.text2, fontSize: 12, lineHeight: 1.5, marginBottom: 8 }}>
              Checklist để đánh giá provider trước khi copy. Nếu có ≥2 red flags nghiêm trọng, KHÔNG
              nên copy.
            </p>
                ...
                {RED_FLAGS.filter((f) => f.severity === 'critical').map((flag) => (
                  ...
                  >
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <p
                        style={{ color: '#991B1B', fontSize: 11, fontWeight: 600, lineHeight: 1.4 }}
                      >
                        {flag.flag}
                      </p>
                    </div>
                ...
                {RED_FLAGS.filter((f) => f.severity === 'warning').map((flag) => (
                  ...
                  >
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <p
                        style={{ color: '#92400E', fontSize: 11, fontWeight: 600, lineHeight: 1.4 }}
                      >
                        {flag.flag}
                      </p>
                    </div>
                ...
                {RED_FLAGS.filter((f) => f.severity === 'caution').map((flag) => (
                  ...
                  >
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <p
                        style={{ color: '#1E3A8A', fontSize: 11, fontWeight: 600, lineHeight: 1.4 }}
                      >
                        {flag.flag}
                      </p>
                    </div>
          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <p style={{ color: c.primary, fontSize: 11, lineHeight: 1.5 }}>
                  Verification là cơ chế bảo vệ user. Provider verified đã qua kiểm tra KYC và
                  performance audit.
                </p>
              </div>
            </div>
            ...
            <div className="p-3 rounded-xl" style={{ background: c.warningBg }}>
              <p
                style={{ color: c.warningText, fontSize: 10, lineHeight: 1.5, textAlign: 'center' }}
              >
                <strong>Lưu ý:</strong> Verification chỉ xác nhận identity và quá khứ. KHÔNG đảm bảo
                provider sẽ tiếp tục thành công trong tương lai.
              </p>
            </div>
          </div>
        )}
        ...
        {activeTab === 'report' && (
          <div className="space-y-4">
            ...
            >
              <div className="flex items-start gap-2">
                <Flag size={14} color={c.error} className="shrink-0 mt-0.5" />
                <div>
                  ...
                  <ul className="space-y-1">
                    {[
                      ...
                      <li
                        key={i}
                        style={{ color: c.error, fontSize: 10, lineHeight: 1.4, paddingLeft: 12 }}
                      >
                        • {reason}
                      </li>
                    ))}
            ...
            <div className="p-3 rounded-xl" style={{ background: c.surface2 }}>
              <p style={{ color: c.text3, fontSize: 9, lineHeight: 1.5, textAlign: 'center' }}>
                Báo cáo của bạn sẽ được review trong 24-48h. Nếu report hợp lệ, provider sẽ bị đình
                chỉ và investigation. Reports giả mạo có thể dẫn đến tài khoản của bạn bị khóa.
              </p>
            </div>
          </div>
        )}

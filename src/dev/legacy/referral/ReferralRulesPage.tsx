...
import { φ, φRadius, φSpace, φIcon } from '@/shared/lib/golden';
import {
  REFERRAL_TIERS,
  REFERRAL_FAQ,
  getReferralStats,
        ...
        <PageContent gap="default">
          ...
          <div>
            ...
            <TrCard overflow>
              ...
              >
                <span style={{ color: c.text3, fontSize: φ.xs, fontWeight: 600, width: 80 }}>
                  Hạng
                </span>
                <span
                  style={{
              ...
              {REFERRAL_TIERS.map((tier, i) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      borderBottom:
                        i < REFERRAL_TIERS.length - 1 ? `1px solid ${c.divider}` : 'none',
                  ...
                  >
                    <div className="flex items-center gap-2" style={{ width: 80 }}>
                      ...
                      <div>
                        <p
                          style={{
                            color: isCurrent ? tier.color : c.text1,
                            fontSize: φ.sm,
                        ...
                        <p
                          style={{
                            color: isCurrent ? tier.color : c.text3,
                            fontSize: 9,
                            fontWeight: 500,
                            opacity: isCurrent ? 0.8 : 0.7,
                          }}
                        >
                          {tier.nameEn}
                        </p>
                        {isCurrent && (
                          <span style={{ color: tier.color, fontSize: 9, fontWeight: 600 }}>
                            Hiện tại
                          </span>
                        )}
                      </div>
              ...
              <TrCard className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p
                      style={{ color: c.text1, fontSize: φ.body, fontWeight: 700, marginBottom: 4 }}
                    >
                      Thưởng KYC cố định
                    </p>
                    <p style={{ color: c.text2, fontSize: φ.sm, lineHeight: 1.5 }}>
                      Khi bạn bè hoàn tất xác minh danh tính (KYC),{' '}
                      <span style={{ fontWeight: 600, color: '#8B5CF6' }}>cả bạn và bạn bè</span>{' '}
                      đều nhận thưởng cố định bằng USDT. Mức thưởng tùy theo hạng của bạn (
                      {fmtUsd(REFERRAL_TIERS[0].kycBonus)} –{' '}
                      {fmtUsd(REFERRAL_TIERS[REFERRAL_TIERS.length - 1].kycBonus)}).
                    </p>
                    <div
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p style={{ color: c.text2, fontSize: φ.sm, lineHeight: 1.5 }}>
                      ...
                      phí giao dịch (Spot, P2P, Convert) của bạn bè được giới thiệu. Hoa hồng được
                      cộng real-time và{' '}
                      <span style={{ fontWeight: 600, color: '#10B981' }}>
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <div key={i} className="flex gap-2.5">
                    ...
                    >
                      <span style={{ color: c.text3, fontSize: φ.xs, fontWeight: 700 }}>
                        {i + 1}
                      </span>
                    </div>
                ...
                return (
                  <TrCard key={i} className="overflow-hidden">
                    ...
                    >
                      ...
                      <span style={{ color: c.text1, fontSize: φ.sm, fontWeight: 600, flex: 1 }}>
                        {faq.q}
                      </span>
                      {isOpen ? (
            ...
            <TrCard className="p-4" accentBorder="rgba(245,158,11,0.15)">
              <div className="flex items-start gap-2.5">
                ...
                <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.6 }}>
                  ...
                  VitTrade không cam kết lợi nhuận từ giao dịch. Thưởng giới thiệu chỉ dựa trên phí
                  giao dịch, không liên quan đến kết quả đầu tư.
                </p>
              </div>
            </TrCard>
          </div>

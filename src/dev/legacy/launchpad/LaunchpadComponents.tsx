...
import type { LaunchProject, Subscription, FilterCriteria } from '@/dev/mocks/launchpad-fixtures';
import {
  truncateAddress,
  getVipTier,
  VIP_TIERS,
...
type SummaryRow = { label: string; value: string; highlight?: boolean; mono?: boolean };
        ...
        <div className="flex flex-col gap-2.5">
          {(
            ...
            <div key={r.label} className="flex justify-between">
              ...
              <span
                style={{
                  color: r.highlight ? '#10B981' : c.text1,
                  fontSize: 12,
        ...
        <div className="flex flex-col gap-2.5">
          {(
            [
              ...
              {
                label: 'Hoàn lại',
                value: `${fmtAmount(sub.refundAmount, 2)} USDT`,
                highlight: true,
              },
            ] as SummaryRow[]
          ).map((r) => (
            <div key={r.label} className="flex justify-between">
              ...
              <span
                style={{
                  color: r.highlight ? '#3B82F6' : c.text1,
                  fontSize: 12,
                  fontWeight: r.highlight ? 700 : 500,
                  fontFamily: 'monospace',
                }}
      ...
      {step === 'input' ? (
        <>
          ...
          {tier.level > 0 && amountNum > 0 && canProceed && (
            <VipAllocationCard userVipLevel={user.vipLevel} baseTokens={tokensReceived} />
          )}
            ...
            <div className="flex flex-col gap-3">
              {(
                [
                  ...
                  {
                    label: 'Giá token',
                    value: `$${project.price} ${project.priceUnit}`,
                    mono: true,
                  },
                  {
                    label: 'Số tiền',
                ...
                <div key={row.label} className="flex justify-between items-start">
                  ...
                  <span
                    style={{
                      color: row.highlight ? c.text1 : c.text2,
                      fontSize: 12,

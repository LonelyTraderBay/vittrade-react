...
import { TrendingUp, TrendingDown, BarChart3, Users, AlertCircle, Rocket } from 'lucide-react';
import {
  HISTORICAL_PROJECTS,
      ...
      <PageContent gap="default">
        ...
        >
          ...
          <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
            Hiệu suất quá khu không đảm bảo kết quả tương lai. Dữ liệu chỉ mang tính tham khảo. ROI
            được tính từ giá launch đến giá hiện tại hoặc ATH, chưa trừ phí và slippage. Nghiên cứu
            kỹ trước khi tham gia bất kỳ dự án nào.
          </p>
        </div>
            ...
            <BarChart data={HISTORICAL_PROJECTS.sort((a, b) => b.roiATH - a.roiATH)}>
              ...
              <Bar key="bar-roi" dataKey="roiATH" radius={[6, 6, 0, 0]}>
                {HISTORICAL_PROJECTS.sort((a, b) => b.roiATH - a.roiATH).map((p, i) => (
                  <Cell
                    key={`overview-roi-bar-${i}`}
                    fill={p.roiATH >= 0 ? '#10B981' : '#EF4444'}
                    opacity={0.8}
                  />
                ))}
              </Bar>
    ...
    <TrCard hover className="p-4">
      ...
      <div className="grid grid-cols-3 gap-2 mb-3">
        ...
        <div className="rounded-xl p-2" style={{ background: c.surface2 }}>
          ...
          <p style={{ color: athColor, fontSize: 12, fontWeight: 700, fontFamily: 'monospace' }}>
            ${project.athPrice}
          </p>
        </div>
        <div className="rounded-xl p-2" style={{ background: c.surface2 }}>
          <p style={{ color: c.text3, fontSize: 9 }}>Hiện tại</p>
          <p style={{ color: roiColor, fontSize: 12, fontWeight: 700, fontFamily: 'monospace' }}>
      ...
      <div className="flex gap-3">
        <div
          ...
          style={{ background: `${athColor}08`, border: `1px solid ${athColor}20` }}
        >
      ...
      >
        ...
        <span
          ...
          style={{
            background:
              project.status === 'trading' ? 'rgba(16,185,129,0.1)' : 'rgba(139,148,179,0.1)',
    ...
    <div className="flex flex-col gap-4">
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={PERFORMANCE_CHART_DATA}>
              ...
              <Area
                ...
                stroke="#10B981"
                strokeWidth={2.5}
                fill="url(#chart-tab-perf-roi-gradient)"
                dot={{ r: 3, fill: '#10B981', stroke: isDark ? '#1a1a2e' : '#fff', strokeWidth: 2 }}
              />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      ...
      <TrCard variant="inner" className="p-3">
        <p style={{ color: c.text3, fontSize: 11, lineHeight: 1.5 }}>
          Số liệu chỉ mang tính tham khảo. ROI ATH là mức cao nhất đạt được — không phải tất cả
          người dùng đều bán được ở giá ATH. Giá hiện tại có thể thay đổi bất kỳ lúc nào.
        </p>
      </TrCard>
    </div>
  );

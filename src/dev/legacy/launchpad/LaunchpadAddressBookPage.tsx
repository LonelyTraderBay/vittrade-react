...
export function LaunchpadAddressBookPage() {
  ...
  const handleAddAddress = (
    addr: Omit<WalletAddress, 'id' | 'createdAt' | 'usageCount' | 'verified'>,
  ) => {
  ...
  return (
    <PageLayout>
      {/* Add sheet */}
      {showAddSheet && (
        <AddAddressSheet onAdd={handleAddAddress} onClose={() => setShowAddSheet(false)} />
      )}
      ...
      <PageContent gap="default">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span style={{ color: c.text1, fontSize: 11, fontWeight: 600 }}>
              {addresses.filter((a) => a.isFavorite).length}
            </span>
          ...
          >
            ...
            <span style={{ color: c.text1, fontSize: 11, fontWeight: 600 }}>
              {addresses.filter((a) => a.verified).length}
            </span>
        ...
        {filtered.length === 0 && (
          <TrCard className="p-8 text-center">
            ...
            <p style={{ color: c.text3, fontSize: 11, marginTop: 4 }}>
              Thu thay doi bo loc hoac them dia chi moi
            </p>
          </TrCard>
        )}
        ...
        >
          ...
          <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
            So dia chi duoc luu tren thiet bi. Luon kiem tra lai dia chi truoc khi thuc hien giao
            dich. Khong chia se dia chi voi nguoi la.
          </p>
        </div>
      ...
      <div className="w-full p-3.5 text-left cursor-pointer" onClick={onToggle}>
        <div className="flex items-start gap-3">
          ...
          <div
            ...
            style={{
              background: address.chainColor + '15',
              border: `1.5px solid ${address.chainColor}25`,
            }}
          >
            <span style={{ color: address.chainColor, fontSize: 14, fontWeight: 800 }}>
              {address.chainIcon}
            </span>
          </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 mb-0.5">
              ...
              {address.verified && <ShieldCheck size={12} color="#10B981" />}
            </div>
            ...
            <div className="flex items-center gap-1 mt-1.5">
              <span
                ...
                style={{
                  background: address.chainColor + '12',
                  color: address.chainColor,
                  fontSize: 8,
                  fontWeight: 600,
                }}
              >
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <button
              onClick={(e) => {
                e.stopPropagation();
                onCopy(address.address, address.id);
              }}
              className="p-1"
            >
        ...
        <div className="px-3.5 pb-3.5" style={{ borderTop: `1px solid ${c.border}` }}>
          ...
          <div className="flex flex-col gap-0 mb-3">
            {[
              ...
              ...(address.lastUsed
                ? [{ label: 'Lan dung gan nhat', value: address.lastUsed }]
                : []),
...
function AddAddressSheet({
  ...
  const isValid =
    label.trim() && address.trim() && address.startsWith('0x') && address.length >= 42;
        ...
        <div className="px-5 pb-6 flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5 mt-1">
              {BRIDGE_NETWORKS.map((net) => (
                ...
                >
                  <span style={{ color: net.color, fontSize: 10, fontWeight: 700 }}>
                    {net.icon}
                  </span>
                  <span
                    style={{
                      color: chain === net.name ? net.color : c.text2,
                      fontSize: 11,
                      fontWeight: chain === net.name ? 600 : 400,
                    }}
                  >
                    {net.name}
                  </span>
          ...
          >
            ...
            <p style={{ color: c.text2, fontSize: 10, lineHeight: 1.5 }}>
              Luon kiem tra dia chi truoc khi them. Gui tien den sai dia chi co the khong khoi phuc
              duoc.
            </p>
          </div>
        ...
        <div className="px-5 pb-6 flex flex-col gap-4">
          ...
          <div className="rounded-xl p-3" style={{ background: c.surface2 }}>
            <div className="flex items-center gap-2">
              ...
              >
                <span style={{ color: address.chainColor, fontSize: 10, fontWeight: 700 }}>
                  {address.chainIcon}
                </span>
              </div>
              <div>

...
export function LaunchpadWebhooksPage() {
  ...
  const toggleStatus = (id: string) => {
    const updated = subs.map((s) => {
      ...
      return {
        ...s,
        status: (s.status === 'active' ? 'paused' : 'active') as WebhookSubscription['status'],
      };
    });
    setSubs(updated);
      ...
      <div className="px-5 pt-2 pb-1">
        <div className="grid grid-cols-4 gap-2">
          {[
            ...
            >
              <p style={{ color: s.color, fontSize: 16, fontWeight: 800, fontFamily: 'monospace' }}>
                {s.value}
              </p>
      ...
      <PageContent gap="default">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-0.5">
                              ...
                              <span
                                className="flex items-center gap-0.5 px-1.5 py-px rounded shrink-0"
                                style={{
                            ...
                            <div className="flex items-center gap-2">
                              <span
                                ...
                                style={{
                                  background: sub.chainColor + '12',
                                  color: sub.chainColor,
                                  fontSize: 9,
                                  fontWeight: 600,
                                }}
                              >
                              ...
                              {sub.eventTypes.map((et) => {
                                ...
                                return (
                                  <span
                                    ...
                                    style={{
                                      background: (evtCfg?.color || '#8B95B3') + '12',
                                      color: evtCfg?.color || c.text2,
                                      fontSize: 10,
                                      fontWeight: 600,
                                    }}
                                  >
                          ...
                          <div className="flex flex-col gap-0 mb-2">
                            {[
                              { label: 'URL', value: sub.webhookUrl, copyable: sub.webhookUrl },
                              {
                                label: 'Contract',
                                value:
                                  sub.contractAddress.slice(0, 10) +
                                  '...' +
                                  sub.contractAddress.slice(-4),
                                copyable: sub.contractAddress,
                              },
                              {
                                label: 'Retry',
                                value: `${sub.retryPolicy} (max ${sub.maxRetries})`,
                              },
                              { label: 'Created', value: sub.createdAt },
                              ...(sub.lastTriggered
                                ? [{ label: 'Last triggered', value: sub.lastTriggered }]
                                : []),
                              ...(sub.lastError
                                ? [{ label: 'Last error', value: sub.lastError }]
                                : []),
                            ].map((row) => (
                              <div
                                key={row.label}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {d.statusCode && (
                            <span
                              style={{
                                color: d.statusCode < 300 ? '#10B981' : '#EF4444',
                                fontSize: 10,
        ...
        >
          ...
          <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
            Webhooks gui HTTP POST den URL cua ban moi khi event xay ra tren blockchain. Dam bao
            endpoint co the xu ly payload va tra ve 2xx status code.
          </p>
        </div>

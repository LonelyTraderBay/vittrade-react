...
import { SUB_STATUS_LABELS, type Subscription } from '@/dev/mocks/launchpad-fixtures';
...
export function LaunchpadReceiptPage() {
  ...
  const sub = (location.state as { subscription?: Subscription } | null)?.subscription;
  ...
  const receiptRows: ReceiptDetailRow[] = [

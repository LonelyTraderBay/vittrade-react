...
import {
  ...
  ClaimTokensSheet,
  RefundConfirmSheet,
} from '@/dev/legacy/launchpad/LaunchpadComponents';
      ...
      <PageContent gap="default">
        ...
        <div className="flex items-start gap-2 px-1">
          ...
          <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.5 }}>
            Phân bổ thực tế phụ thuộc vào tổng số đăng ký. Token mở khóa theo lịch vesting của từng
            dự án.
          </p>
        </div>
  ...
  return (
    <TrCard hover>
      <button
        ...
        onClick={() =>
          navigate(`${prefix}/launchpad/receipt/${sub.id}`, { state: { subscription: sub } })
        }
      >
        {/* Header */}
        ...
        <div className="grid grid-cols-2 gap-2 mb-3">
          ...
          <div className="rounded-xl p-2.5" style={{ background: c.surface2 }}>
            ...
            <p style={{ color: c.text1, fontSize: 13, fontWeight: 700, fontFamily: 'monospace' }}>
              {sub.tokensAllocated > 0 ? fmtAmount(sub.tokensAllocated, 0) : '—'}{' '}
              {sub.projectSymbol}
            </p>
          </div>
        </div>
        ...
        {sub.allocationRatio > 0 && sub.allocationRatio < 1 && (
          <div className="flex items-center gap-2 mb-2">
            ...
            <span style={{ color: '#F59E0B', fontSize: 11 }}>
              Phân bổ {Math.round(sub.allocationRatio * 100)}% — Hoàn lại: $
          ...
          <div className="mb-2">
            <div className="flex justify-between mb-1">
              ...
              <span style={{ color: c.text1, fontSize: 11, fontWeight: 600 }}>
                {fmtAmount(sub.tokensClaimed, 0)} / {fmtAmount(sub.tokensAllocated, 0)}{' '}
                {sub.projectSymbol}
              </span>
            </div>
            <div

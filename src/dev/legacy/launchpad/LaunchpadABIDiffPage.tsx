  ...
  return (
    <PageLayout>
      ...
      <PageContent gap="default">
          ...
          {(
            ...
            return (
              ...
              >
                ...
                <p
                  style={{ color: c.text1, fontSize: 16, fontWeight: 800, fontFamily: 'monospace' }}
                >
                  {item.count}
                </p>
        ...
        <TrCard className="p-4">
          ...
          <div className="flex flex-col gap-0">
            {[
              {
                label: 'Contract',
                value: truncateAddress(diff.contractAddress),
                mono: true,
                copyable: diff.contractAddress,
              },
              ...
              {
                label: 'Tx Hash',
                value: truncateAddress(diff.upgradeTxHash),
                mono: true,
                copyable: diff.upgradeTxHash,
              },
              {
                label: 'Functions',
                value: `${diff.totalFunctions.old} → ${diff.totalFunctions.new}`,
              },
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => setShowFunctionsOnly(!showFunctionsOnly)}
          ...
          <span style={{ color: c.text3, fontSize: 10 }}>{filteredEntries.length} entries</span>
        </div>
        ...
        >
          ...
          <p style={{ color: c.text2, fontSize: 11, lineHeight: 1.5 }}>
            Day la so sanh ABI tu dong. Can kiem tra source code thuc te de hieu day du anh huong
            cua cac thay doi. Lien he doi bao mat neu phat hien rui ro cao.
          </p>
        </div>
...
function DiffEntryCard({
  ...
  return (
    <TrCard className="overflow-hidden" style={{ borderLeft: `3px solid ${changeCfg.color}` }}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5">
              <span
                className="px-1.5 py-px rounded"
                style={{
                  background: changeCfg.bg,
                  color: changeCfg.color,
                  fontSize: 8,
                  fontWeight: 700,
                }}
              >
              ...
              {entry.riskLevel !== 'none' && (
                <span
                  className="flex items-center gap-0.5 px-1.5 py-px rounded"
                  style={{
      ...
      {expanded && (
        <div className="px-3 pb-3" style={{ borderTop: `1px solid ${c.border}` }}>
          ...
          {entry.oldSignature && (
            <div className="mt-2 mb-1">
              ...
              <div
                ...
                style={{
                  background: entry.changeType === 'removed' ? 'rgba(239,68,68,0.06)' : c.surface2,
                }}
              >
                <code
                  style={{
          ...
          {entry.newSignature && (
            <div className="mb-2">
              ...
              <div
                className="rounded-lg px-2.5 py-1.5"
                style={{
                  background: entry.changeType === 'added' ? 'rgba(16,185,129,0.06)' : c.surface2,
                }}
              >
                <code
                  style={{
          ...
          <div className="flex flex-col gap-0">
            {entry.oldVisibility && (
              ...
              >
                ...
                <span style={{ color: c.text1, fontSize: 10, fontFamily: 'monospace' }}>
                  {entry.oldVisibility}
                  {entry.newVisibility && entry.oldVisibility !== entry.newVisibility
                    ? ` → ${entry.newVisibility}`
                    : ''}
                </span>
              </div>
            ...
            {entry.oldStateMutability && (
              ...
              >
                ...
                <span style={{ color: c.text1, fontSize: 10, fontFamily: 'monospace' }}>
                  {entry.oldStateMutability}
                  {entry.newStateMutability && entry.oldStateMutability !== entry.newStateMutability
          ...
          {entry.riskNote && (
            <div
              className="rounded-xl p-2.5 mt-2 flex items-start gap-2"

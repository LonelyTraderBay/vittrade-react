...
import { NotificationBadge } from '@/dev/legacy/arena/components/ArenaEnhancements';
import { ArenaOfflineBanner } from '@/dev/legacy/arena/components/ArenaNiceToHave';
import { φ, φRadius, φIcon } from '@/shared/lib/golden';

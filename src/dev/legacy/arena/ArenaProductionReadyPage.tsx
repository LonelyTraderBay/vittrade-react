...
const CANONICAL_SCREENS: ScreenEntry[] = [
  {
    ...
    notes:
      'Gọn hơn v4: bớt quick chips (3 thay vì 5), giữ hero + templates + modes + rooms + creators',
  },
  {
    ...
    notes:
      'PublishEligibilityPanel rõ hơn, GovernanceHintBanner ở mỗi step, RuleClarityCard ở Review',
  },
  {
    ...
    notes:
      'Trust-first: tab mặc định là "Luật chơi", Governance+RuleClarity trước tabs, Safety Snapshot trước CTA',
  },
  {
  ...
  },
  {
    ...
    notes:
      'Full audit trail: 7 filter chips, search, balance summary, tappable rows → entry detail',
  },
  {
    name: 'MyArenaPage',
    route: '/profile/arena',
...
const SUPPORTING_SCREENS: ScreenEntry[] = [
  {
    ...
    notes: 'Points hub: check-in, tasks, history → ledger link',
  },
  {
    ...
    notes: 'Chi tiết giao dịch điểm: amount hero, details, balance, refId',
  },
  {
    name: 'ArenaJoinPage',
    route: '/arena/join/:id',
    ...
    version: 'v2',
    states: ['default', 'loading', 'error'],
    notes: 'Preview trước join: checkboxes, fee breakdown, policy link',
  },
  {
  ...
  {
    name: 'ArenaModeDetailPage',
    route: '/arena/mode/:id',
    status: 'live',
    version: 'v1',
    states: ['default', 'empty'],
    notes: 'Mode detail: rules, format, creator, clones',
  },
  {
    name: 'ArenaLeaderboardPage',
    route: '/arena/leaderboard',
    status: 'live',
    version: 'v1',
    states: ['default', 'loading', 'empty'],
    notes: 'Top creators + players',
  },
  {
    name: 'ArenaTrustBreakdownPage',
    route: '/arena/trust/:id',
    status: 'live',
    version: 'v1',
    states: ['default'],
    notes: 'Full trust metrics detail',
  },
  {
    name: 'ArenaBlockedUsersPage',
    route: '/arena/blocked',
    status: 'live',
    version: 'v1',
    states: ['default', 'empty'],
    notes: 'Blocked users list: unblock + view profile CTA',
  },
  {
    name: 'MyArenaReportsPage',
    route: '/arena/my-reports',
    status: 'live',
    version: 'v1',
    states: ['default', 'loading', 'empty'],
    notes: '6 filter chips, report list, skeleton loading',
  },
  {
    name: 'ArenaReportCasePage',
    route: '/arena/report/:caseId',
    status: 'live',
    version: 'v1',
    states: ['default', 'empty'],
    notes: 'Case detail: AppealBanner, CaseActionCard, timeline',
  },
  {
  ...
  },
  {
    ...
    version: 'v1',
    states: ['default'],
    notes: 'Flow visualization — dev/QA only, not user-facing',
  },
  {
    name: 'ArenaProductionReadyPage',
    route: '/arena/production-ready',
    status: 'qa_only',
    version: 'v1',
    states: ['default'],
    notes: 'This page — handoff dashboard',
  },
];
...
const E2E_FLOWS: E2EFlow[] = [
  {
    ...
    steps: [
      { label: 'ArenaHome', route: '/arena', description: 'Tap "Tạo challenge"' },
      {
        label: 'ArenaStudio',
        route: '/arena/studio',
        description: 'Template → Cấu trúc → Luật → Kết quả → Points → Review',
      },
      {
        label: 'Publish',
        route: '/arena/studio',
        description: 'PublishEligibility check → Submit',
      },
      {
  ...
  },
  {
    ...
    steps: [
      { label: 'ArenaHome', route: '/arena', description: 'Browse rooms/modes/challenges' },
      {
        label: 'ChallengeDetail',
        route: '/arena/challenge/:id',
        description: 'Xem rules, trust, participants',
      },
      {
        label: 'JoinPage',
        route: '/arena/join/:id',
        description: 'Preview: entry pts, checkboxes, fee',
      },
      {
        label: 'ChallengeDetail',
        route: '/arena/challenge/:id',
        description: 'Joined → wait for start',
      },
      {
        label: 'Resolution',
        route: '/arena/resolution',
        description: 'Submit evidence, confirm result',
      },
  ...
  },
  {
    ...
    steps: [
      { label: 'ChallengeDetail', route: '/arena/challenge/:id', description: 'Tap "Báo cáo"' },
      {
        label: 'ReportDialog',
        route: '/arena/challenge/:id',
        description: 'Select reason, submit',
      },
      {
    ...
    steps: [
      {
        label: 'ChallengeDetail',
        route: '/arena/challenge/:id',
        description: 'CTA: "Chốt kết quả"',
      },
      {
        label: 'ResolutionCenter',
        route: '/arena/resolution',
        description: 'Choose method, submit evidence',
      },
      {
        label: 'ResultProposal',
        route: '/arena/resolution',
        description: 'Confirm winner/loser/draw/void',
      },
  ...
  },
  {
    ...
    steps: [
      ...
      {
        label: 'LinkedChallenge',
        route: '/arena/challenge/:id',
        description: 'Navigate to linked challenge',
      },
    ],
  },
];
...
const COMPONENT_REGISTRY: ComponentEntry[] = [
  {
    ...
    type: 'chip',
    description:
      '11 challenge states: open, live, full, pending_result, resolved, canceled, hidden, error, under_review, reported, offline',
  },
  {
    name: 'FormatChip',
    file: 'ArenaChips.tsx',
    type: 'chip',
    description: '4 formats: 1v1, 1vN, NvN, open_lobby',
  },
  {
    name: 'TrustBadge',
    file: 'ArenaChips.tsx',
    type: 'chip',
    description: 'points_only | verified | community',
  },
  {
    name: 'ReportDialog',
    file: 'ArenaModeration.tsx',
    type: 'dialog',
    description: 'Report modal: 6 reason options + text input',
  },
  {
    name: 'BlockUserDialog',
    file: 'ArenaModeration.tsx',
    type: 'dialog',
    description: 'Block confirmation modal with user info',
  },
  {
    name: 'ReportCaseStatusChip',
    file: 'ArenaModerationCases.tsx',
    type: 'chip',
    description: '6 statuses: pending, investigating, resolved, dismissed, appealed, escalated',
  },
  {
    name: 'AppealBanner',
    file: 'ArenaModerationCases.tsx',
    type: 'card',
    description: 'Case appeal banner with appeal CTA',
  },
  {
    name: 'CaseActionCard',
    file: 'ArenaModerationCases.tsx',
    type: 'card',
    description: 'Actions available for a report case',
  },
  {
    name: 'BlockedUserRow',
    file: 'ArenaModerationCases.tsx',
    type: 'card',
    description: 'Blocked user list item with unblock CTA',
  },
  {
    name: 'SafetySnapshotCard',
    file: 'ArenaSafetyTrust.tsx',
    type: 'card',
    description: 'Challenge safety summary: resolution, evidence, privacy, trust',
  },
  {
    name: 'TrustBreakdownSheet',
    file: 'ArenaSafetyTrust.tsx',
    type: 'sheet',
    description:
      '5 trust metrics detail: fair_play, completion, dispute, report_upheld, reliability',
  },
  {
    name: 'ResultReceiptSheet',
    file: 'ArenaResultReceipt.tsx',
    type: 'sheet',
    description: 'Settlement receipt: result hero, participants, pool, ledger refs',
  },
  {
    name: 'ParticipantGovernanceCard',
    file: 'ArenaStudioGovernance.tsx',
    type: 'card',
    description: 'Resolution method, evidence, void rule, privacy for participants',
  },
  {
    name: 'RuleClarityCard',
    file: 'ArenaStudioGovernance.tsx',
    type: 'card',
    description: 'Clarity score gauge (0–100) based on rule completeness',
  },
  {
    name: 'PublishEligibilityPanel',
    file: 'ArenaStudioGovernance.tsx',
    type: 'card',
    description: '6 eligibility checks before publishing challenge',
  },
  {
    name: 'ResolutionRiskMatrix',
    file: 'ArenaStudioGovernance.tsx',
    type: 'card',
    description: 'Risk assessment for resolution method choice',
  },
  {
    name: 'ModerationTimelineRow',
    file: 'ArenaGovernance.tsx',
    type: 'card',
    description: 'Timeline step: done/pending dot + label + date',
  },
  {
    name: 'ArenaPageFooter',
    file: 'ArenaPageFooter.tsx',
    type: 'shared',
    description: 'Community rules, safety links, disclaimer',
  },
  {
    name: 'PredictionContextCard',
    file: 'ArenaPredictionBridges.tsx',
    type: 'card',
    description: '07D bridge: prediction market context in challenge detail',
  },
];
    ...
    items: [
      {
        code: 'auto',
        label: 'Tự động',
        description: 'Kết quả từ nguồn dữ liệu bên ngoài (API, quiz engine)',
      },
      {
        code: 'mutual_confirm',
  ...
  },
  {
    ...
    items: [
      { code: 'pending', label: 'Đang chờ', description: 'Chưa có kết quả' },
      {
        ...
        description: 'Evidence đã gửi, chờ review',
      },
      { code: 'proposed', label: 'Đề xuất', description: 'Kết quả đã được đề xuất, chờ xác nhận' },
      {
        code: 'confirmed',
        label: 'Đã xác nhận',
        description: 'Kết quả được xác nhận, chờ phân phối',
      },
    ...
    items: [
      {
        code: 'points_only',
        label: 'Points only',
        description: 'Arena Points không phải tài sản tài chính',
      },
      { code: 'fair_play', label: 'Fair Play', description: 'Creator/player tuân thủ luật chơi' },
      {
        code: 'no_outside_trade',
        label: 'Không giao dịch ngoài',
        description: 'Warning không thỏa thuận ngoài nền tảng',
      },
      {
        code: 'void_policy',
        label: 'Chính sách void',
        description: 'Khi nào challenge bị void và hoàn điểm',
      },
      {
        code: 'dispute_process',
        label: 'Quy trình tranh chấp',
        description: 'Steps khi có tranh chấp',
      },
...
function StatusTag({ status }: { status: ScreenStatus }) {
  ...
  return (
    <span
      ...
      style={{ background: cfg.bg, color: cfg.color, fontSize: 9, fontWeight: 600 }}
    >
      {cfg.label}
    </span>
  );
          ...
          <TrCard className="p-3 flex items-start gap-2" accentBorder="rgba(59,130,246,0.3)">
            ...
            <div>
              ...
              <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5, marginTop: 2 }}>
                QA/Dev handoff dashboard. Trang này chỉ dành cho nội bộ — không hiển thị cho
                end-user.
              </p>
            </div>
          </TrCard>
        ...
        <div className="flex flex-col gap-4">
          ...
          {activeSection === 'A' && (
            <div className="contents">
              ...
              <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5, marginBottom: 8 }}>
                7 core screens đã được consolidate thành bản vFinal. Mỗi screen đã audit:
                trust-first, accessibility, states đầy đủ.
              </p>
              ...
              {CANONICAL_SCREENS.map((screen) => (
                <TrCard
                  ...
                  onClick={() => {
                    navigate(
                      `${prefix}${screen.route.replace(':challengeId', 'ch003').replace(':id', 'ch003')}`,
                    );
                    hapticSelection();
                  }}
                  ...
                  <div className="flex flex-wrap gap-1 mt-2">
                    {screen.states.map((st) => (
                      <span
                        ...
                        style={{ background: c.surface2, color: c.text2, fontSize: 9 }}
                      >
                        {st}
                      </span>
                    ))}
            ...
            <div className="contents">
              ...
              {CANONICAL_SCREENS.map((screen) => (
                <TrCard key={screen.name} className="p-3">
                  <p style={{ color: c.text1, fontSize: φ.xs, fontWeight: 700, marginBottom: 6 }}>
                    {screen.name}
                  </p>
                        ...
                        <div className="flex flex-col items-center shrink-0" style={{ width: 20 }}>
                          <div
                            ...
                            style={{
                              ...
                              background: i === 0 ? flow.color : 'transparent',
                            }}
                          />
                          {i < flow.steps.length - 1 && (
                            <div
                              className="w-0.5 flex-1"
                              style={{ background: hexToRgba(flow.color, 30) }}
                            />
                          )}
                        </div>
                        ...
                        <button
                          onClick={() => {
                            const route = step.route
                              .replace(':challengeId', 'ch003')
                              .replace(':id', 'ch003')
                              .replace(':caseId', 'rc001')
                              .replace(':entryId', 'le001');
          ...
          {activeSection === 'D' && (
            <div className="contents">
              ...
              <TrCard className="p-4 mb-2">
                <div className="grid grid-cols-4 gap-2 text-center">
                  {(Object.keys(STATUS_COLORS) as ScreenStatus[]).map((status) => {
                    const cfg = STATUS_COLORS[status];
                    const count = [...CANONICAL_SCREENS, ...SUPPORTING_SCREENS].filter(
                      (s) => s.status === status,
                    ).length;
                    return (
                      <div key={status}>
              ...
              {/* Full registry */}
              {(Object.keys(STATUS_COLORS) as ScreenStatus[]).map((status) => {
                const screens = [...CANONICAL_SCREENS, ...SUPPORTING_SCREENS].filter(
                  (s) => s.status === status,
                );
                    ...
                    <TrCard overflow>
                      {screens.map((screen, i) => (
                        <div
                          ...
                          style={{
                            borderBottom:
                              i < screens.length - 1 ? `1px solid ${c.divider}` : 'none',
                            minHeight: 48,
                          }}
                        >
                          <div className="flex-1 min-w-0">
                            ...
                            <p style={{ color: c.text3, fontSize: 9, fontFamily: 'monospace' }}>
                              {screen.route}
                            </p>
                          </div>
          ...
          {activeSection === 'E' && (
            <div className="contents">
              ...
              <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5, marginBottom: 8 }}>
                4 handoff boards: Route Registry, Component Registry, Trust & Governance Rules,
                Points Ledger / Resolution Dictionary.
              </p>
                ...
                <div className="flex flex-col gap-1.5">
                  {[...CANONICAL_SCREENS, ...SUPPORTING_SCREENS].map((s) => (
                    <div key={s.name} className="flex items-center gap-2" style={{ minHeight: 28 }}>
                      ...
                      <span
                        style={{ color: '#3B82F6', fontSize: 9, fontFamily: 'monospace', flex: 1 }}
                        className="truncate"
                      >
                        {s.route}
                      </span>
              ...
              <TrCard className="p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p style={{ color: c.text1, fontSize: φ.sm, fontWeight: 700 }}>
                    2. Component Registry ({COMPONENT_REGISTRY.length})
                  </p>
                </div>
                    ...
                    return (
                      ...
                      >
                        <span
                          ...
                          style={{
                            background: hexToRgba(typeColors[comp.type], 12),
                        ...
                        <div className="flex-1 min-w-0">
                          <p style={{ color: c.text1, fontSize: 10, fontWeight: 600 }}>
                            {comp.name}
                          </p>
                ...
                <div className="flex flex-col gap-2">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-2" style={{ minHeight: 24 }}>
                      ...
                      <span style={{ color: c.text2, fontSize: φ.xs, lineHeight: 1.5 }}>
                        {item}
                      </span>
                    </div>
                  ))}
          ...
          <TrCard className="p-3 flex items-start gap-2">
            ...
            <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.5 }}>
              Trang này chỉ dành cho internal handoff. Không deploy lên production build. Open Arena
              = points-only, không phải tài sản tài chính.
            </p>
          </TrCard>
        </div>
      </PageContent>

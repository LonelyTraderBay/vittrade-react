...
import { SHARED_TOPICS, type SharedTopicId } from '@/dev/mocks/arena-prediction-topics';
import { PredictionContextCard } from '@/dev/legacy/arena/ArenaPredictionBridges';
import {
  UnifiedTopicChip,
  type TopicChipState,
  ...
  DualModuleStatCard,
  BridgeSourceBar,
} from '@/dev/legacy/arena/ArenaPredictionFoundation';
          ...
          <TrCard className="p-3 flex items-start gap-2" accentBorder="rgba(99,102,241,0.3)">
            ...
            <div>
              ...
              <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5, marginTop: 2 }}>
                Nền tảng kết nối an toàn giữa Open Arena và Prediction Markets. Khóa boundary trước
                khi nối flow.
              </p>
            </div>
          </TrCard>
        ...
        <div className="flex flex-col gap-4">
          ...
          {activeSection === '1' && (
            <div className="contents">
              ...
              <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5, marginBottom: 8 }}>
                6 nguyên tắc bắt buộc khi kết nối Arena ↔ Prediction Markets. Vi phạm = reject trong
                code review.
              </p>
                  ...
                  <TrCard key={p.num} className="p-4">
                    <div className="flex items-start gap-3">
                      <div
                        ...
                        style={{
                          background: hexToRgba(p.color, 12),
                          border: `1px solid ${hexToRgba(p.color, 20)}`,
                        }}
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5 }}>{p.desc}</p>
                      </div>
                    </div>
                  </TrCard>
                );
          ...
          {activeSection === '2' && (
            <div className="contents">
              ...
              />
              <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5, marginBottom: 8 }}>
                8 topics dùng chung cho cả Arena và Prediction Markets. Bridge chỉ qua topic — không
                qua value.
              </p>
              ...
              <TrCard className="p-4">
                ...
                {selectedTopic && (
                  <p style={{ color: c.text2, fontSize: φ.xs, marginTop: 8 }}>
                    Selected:{' '}
                    <strong>{SHARED_TOPICS.find((t) => t.id === selectedTopic)?.label}</strong>
                  </p>
                )}
              </TrCard>
              ...
              <TrCard className="p-4">
                ...
                {(['default', 'selected', 'compact', 'disabled'] as TopicChipState[]).map(
                  (state) => (
                    <div key={state} className="flex items-center gap-3 mb-2">
                      <span
                        style={{ color: c.text3, fontSize: 9, fontFamily: 'monospace', width: 60 }}
                      >
                        {state}
                      </span>
          ...
          {activeSection === '3' && (
            <div className="contents">
              ...
              />
              <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5, marginBottom: 8 }}>
                3 component types: Banner (6 variants), Badge (6 variants), InfoRow. Bắt buộc khi
                cross-module.
              </p>
            ...
            <div className="contents">
              ...
              <TrCard className="p-4">
                ...
                <p style={{ color: c.text3, fontSize: 9, lineHeight: 1.4, marginBottom: 8 }}>
                  Dùng trong Arena pages. Hiển thị bối cảnh thị trường prediction — không phải
                  trading UI.
                </p>
          ...
          {activeSection === '5' && (
            <div className="contents">
              ...
              <TrCard className="p-4" accentBorder="rgba(16,185,129,0.2)">
                ...
                <p style={{ color: c.text3, fontSize: 9, lineHeight: 1.4, marginBottom: 8 }}>
                  Hiển thị bối cảnh thị trường prediction bên trong challenge detail. Có badge
                  "Market context only" và microcopy disclaimer rõ ràng.
                </p>
              ...
              <TrCard className="p-4" accentBorder="rgba(16,185,129,0.2)">
                ...
                <p style={{ color: c.text3, fontSize: 9, lineHeight: 1.4, marginBottom: 8 }}>
                  Hiển thị room Arena liên quan cùng topic. Có badge "Arena Points only" và
                  microcopy "không liên quan wallet".
                </p>
              ...
              <TrCard className="p-4" accentBorder="rgba(16,185,129,0.2)">
                ...
                <p style={{ color: c.text3, fontSize: 9, lineHeight: 1.4, marginBottom: 8 }}>
                  2 block tách biệt với boundary separator. Số liệu KHÔNG gộp. Mỗi block có badge
                  riêng.
                </p>
              ...
              <TrCard className="p-4" accentBorder="rgba(239,68,68,0.3)">
                ...
                <p style={{ color: c.text3, fontSize: 9, lineHeight: 1.4, marginBottom: 8 }}>
                  Anti-pattern: gộp Arena Points và Prediction PnL vào 1 card tổng hợp. Tạo nhầm lẫn
                  giữa tiền thật và điểm xã hội.
                </p>
                ...
                >
                  <div className="px-3 py-2" style={{ background: 'rgba(239,68,68,0.05)' }}>
                    <p style={{ color: '#EF4444', fontSize: 9, fontWeight: 700 }}>
                      WRONG — MergedStatsCard
                    </p>
                  </div>
                  <div className="p-3" style={{ opacity: 0.5 }}>
                    <TrCard className="p-4">
                      <p
                        style={{ color: c.text1, fontSize: φ.sm, fontWeight: 700, marginBottom: 8 }}
                      >
                        Tổng tài sản
                      </p>
                ...
                <div className="mt-3 flex flex-col gap-1">
                  <BoundaryInfoRow
                    text="Không gộp Points + PnL vào cùng 1 card."
                    color="#EF4444"
                    icon={X}
                  />
                  <BoundaryInfoRow
                    text="Không hiển thị 'Tổng tài sản' gộp 2 module."
                    color="#EF4444"
                    icon={X}
                  />
                  <BoundaryInfoRow
                    text="Không so sánh Points = tiền thật."
                    color="#EF4444"
                    icon={X}
                  />
                </div>
          ...
          <TrCard className="p-3 flex items-start gap-2">
            ...
            <p style={{ color: c.text3, fontSize: 10, lineHeight: 1.5 }}>
              Foundation layer — boundary phải khóa trước khi nối flow. Open Arena = Points only.
              Prediction Markets = Real positions. Không bao giờ gộp.
            </p>
          </TrCard>
        </div>
      </PageContent>

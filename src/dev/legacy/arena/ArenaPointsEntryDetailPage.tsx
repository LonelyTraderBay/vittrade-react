...
import { getLedgerEntryById, LEDGER_TYPE_CONFIG, fmtPoints } from '@/dev/mocks/arena-fixtures';
    ...
    return (
      <PageLayout>
        ...
        <EmptyState
          ...
          subtitle="Giao dịch điểm không tồn tại"
        />
      </PageLayout>
    );
  }
      ...
      <PageContent gap="default">
            ...
            <div className="flex flex-col gap-3">
              ...
              {entry.linkedChallengeName && (
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => {
                      navigate(`${prefix}/arena/challenge/${entry.linkedChallengeId}`);
                      hapticSelection();
                    }}
              ...
              {entry.linkedModeName && (
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => {
                      navigate(`${prefix}/arena/mode/${entry.linkedModeId}`);
                      hapticSelection();
                    }}
                    className="flex items-center gap-1 active:opacity-70"
                    style={{ color: '#8B5CF6', fontSize: φ.xs, fontWeight: 600, minHeight: 28 }}
          ...
          <TrCard className="p-4">
            <div className="flex items-center justify-between gap-3">
              ...
              <div
                ...
                style={{
                  background: entry.amount >= 0 ? 'rgba(16,185,129,0.12)' : 'rgba(239,68,68,0.12)',
                }}
              >
                <span
                  style={{
        ...
        <TrCard className="p-3 flex items-start gap-2">
          ...
          <p style={{ color: c.text3, fontSize: φ.xs, lineHeight: 1.5 }}>
            Bản ghi này được hệ thống tạo tự động và không thể chỉnh sửa. Nếu bạn phát hiện sai sót,
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            onClick={() => {
              actionToast.success('Đã mở trang hỗ trợ');
              hapticSelection();
            }}

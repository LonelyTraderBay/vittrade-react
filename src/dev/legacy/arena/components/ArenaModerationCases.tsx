...
import type { ReportCaseStatus } from '@/dev/mocks/arena-fixtures';
import { ReportStatusChip } from '@/dev/legacy/arena/components/ArenaGovernance';
import { hexToRgba } from '@/shared/lib/string';

/* Re-export for naming consistency with spec */
export { ReportStatusChip as ReportCaseStatusChip } from '@/dev/legacy/arena/components/ArenaGovernance';

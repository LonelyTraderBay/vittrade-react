...
export function ArenaEmptyRooms({ onCta }: ArenaEmptyProps) {
  return (
    <EmptyState
      ...
      subtitle="Tạo challenge mới hoặc khám phá phòng đang mở"
      ctaLabel="Tạo challenge"
      onCta={onCta}
    />
  );
}
...
export function ArenaEmptyJoined({ onCta }: ArenaEmptyProps) {
  return (
    <EmptyState
      icon={Trophy}
      title="Chưa tham gia challenge nào"
      subtitle="Khám phá các challenge đang mở và bắt đầu chơi"
      ctaLabel="Khám phá"
      onCta={onCta}
    />
  );
...
export function ArenaEmptySavedModes({ onCta }: ArenaEmptyProps) {
  return (
    <EmptyState
      ...
      subtitle="Lưu các mode yêu thích để dùng nhanh sau này"
      ctaLabel="Khám phá modes"
      onCta={onCta}
    />
  );
}
...
export function ArenaEmptyDrafts({ onCta }: ArenaEmptyProps) {
  return (
    <EmptyState
      ...
      subtitle="Bản nháp challenge chưa hoàn thành sẽ hiển thị ở đây"
      ctaLabel="Tạo mới"
      onCta={onCta}
    />
  );
...
export function ArenaEmptyHistory() {
  return (
    <EmptyState
      ...
      subtitle="Hoàn thành challenge để xem lịch sử ở đây"
    />
  );
}
...
export function ArenaEmptySearch() {
  return (
    <EmptyState icon={Search} title="Không tìm thấy" subtitle="Thử từ khoá khác hoặc xoá bộ lọc" />
  );
}

...
export const TOKEN_UNLOCKS: TokenUnlock[] = [
  {
    ...
    unlockValueUsd: 120_445_000,
    unlockPctCirculating: 2.8,
    totalLocked: 3_240_000_000,
    totalLockedValueUsd: 4_212_000_000,
    vestingType: 'cliff',
    category: 'investor',
    impactLevel: 'high',
    currentPrice: 1.3,
    priceChange7d: -4.2,
    circulatingSupply: 3_340_000_000,
  ...
  },
  {
    ...
    daysUntil: 9,
    unlockAmount: 31_340_000,
    unlockValueUsd: 62_680_000,
    unlockPctCirculating: 1.9,
    totalLocked: 2_890_000_000,
    totalLockedValueUsd: 5_780_000_000,
    vestingType: 'linear',
    category: 'team',
    impactLevel: 'medium',
    currentPrice: 2.0,
    priceChange7d: -1.8,
    circulatingSupply: 1_640_000_000,
  ...
  },
  {
    ...
    daysUntil: 1,
    unlockAmount: 11_310_000,
    unlockValueUsd: 96_135_000,
    unlockPctCirculating: 2.4,
    totalLocked: 567_000_000,
    totalLockedValueUsd: 4_819_500_000,
    vestingType: 'linear',
    category: 'foundation',
    impactLevel: 'high',
    currentPrice: 8.5,
  ...
  },
  {
    ...
    daysUntil: 21,
    unlockAmount: 64_190_000,
    unlockValueUsd: 96_285_000,
    unlockPctCirculating: 2.6,
    totalLocked: 5_420_000_000,
    totalLockedValueUsd: 8_130_000_000,
    vestingType: 'cliff',
    category: 'investor',
    impactLevel: 'medium',
    currentPrice: 1.5,
    priceChange7d: 3.2,
    circulatingSupply: 2_480_000_000,
    totalSupply: 10_000_000_000,
    vestingSchedule: [
  ...
  },
  {
    ...
    daysUntil: 14,
    unlockAmount: 18_500_000,
    unlockValueUsd: 148_000_000,
    unlockPctCirculating: 8.2,
    totalLocked: 818_000_000,
    totalLockedValueUsd: 6_544_000_000,
    vestingType: 'cliff',
    category: 'investor',
    impactLevel: 'high',
    currentPrice: 8.0,
    priceChange7d: -8.5,
    circulatingSupply: 226_000_000,
    totalSupply: 1_044_000_000,
    vestingSchedule: [
  ...
  },
  {
    ...
    daysUntil: 35,
    unlockAmount: 127_000_000,
    unlockValueUsd: 88_900_000,
    unlockPctCirculating: 5.4,
    totalLocked: 7_280_000_000,
    totalLockedValueUsd: 5_096_000_000,
    vestingType: 'linear',
    category: 'team',
    impactLevel: 'medium',
    currentPrice: 0.7,
    priceChange7d: 1.2,
    circulatingSupply: 2_350_000_000,
    totalSupply: 10_000_000_000,
    vestingSchedule: [
...
export const VESTING_CATEGORY_CONFIG: Record<
  TokenUnlock['category'],
...
export const TRADING_SIGNALS: TradingSignal[] = [
  {
    ...
    providerFollowers: 12_400,
    pair: 'BTC/USDT',
    baseAsset: 'BTC',
    direction: 'long',
    entry: 66_800,
    targets: [68_500, 70_000, 72_000],
    stopLoss: 64_500,
    currentPrice: 67_543,
    status: 'active',
    pnlPct: 1.11,
  ...
  },
  {
    ...
    providerFollowers: 3_200,
    pair: 'BTC/USDT',
    baseAsset: 'BTC',
    direction: 'short',
    entry: 68_200,
    targets: [67_000, 66_200],
    stopLoss: 69_500,
    currentPrice: 67_543,
    status: 'active',
    pnlPct: 0.96,
...
export const SIGNAL_PROVIDER_TIERS: Record<
  TradingSignal['providerTier'],
...
const CORR_MATRIX_7D: number[][] = [
  [1.0, 0.92, 0.85, 0.88, 0.72, 0.68, 0.78, 0.74],
  [0.92, 1.0, 0.88, 0.82, 0.65, 0.71, 0.82, 0.79],
  [0.85, 0.88, 1.0, 0.76, 0.58, 0.62, 0.74, 0.69],
  [0.88, 0.82, 0.76, 1.0, 0.7, 0.65, 0.72, 0.67],
  [0.72, 0.65, 0.58, 0.7, 1.0, 0.78, 0.6, 0.55],
  [0.68, 0.71, 0.62, 0.65, 0.78, 1.0, 0.68, 0.72],
  [0.78, 0.82, 0.74, 0.72, 0.6, 0.68, 1.0, 0.8],
  [0.74, 0.79, 0.69, 0.67, 0.55, 0.72, 0.8, 1.0],
];

const CORR_MATRIX_30D: number[][] = [
  [1.0, 0.89, 0.82, 0.85, 0.68, 0.64, 0.75, 0.71],
  [0.89, 1.0, 0.84, 0.79, 0.62, 0.67, 0.79, 0.76],
  [0.82, 0.84, 1.0, 0.73, 0.55, 0.59, 0.71, 0.66],
  [0.85, 0.79, 0.73, 1.0, 0.67, 0.62, 0.69, 0.64],
  [0.68, 0.62, 0.55, 0.67, 1.0, 0.75, 0.57, 0.52],
  [0.64, 0.67, 0.59, 0.62, 0.75, 1.0, 0.65, 0.69],
  [0.75, 0.79, 0.71, 0.69, 0.57, 0.65, 1.0, 0.77],
  [0.71, 0.76, 0.66, 0.64, 0.52, 0.69, 0.77, 1.0],
];

const CORR_MATRIX_90D: number[][] = [
  [1.0, 0.86, 0.78, 0.82, 0.64, 0.6, 0.72, 0.68],
  [0.86, 1.0, 0.81, 0.76, 0.58, 0.63, 0.76, 0.73],
  [0.78, 0.81, 1.0, 0.7, 0.51, 0.55, 0.68, 0.63],
  [0.82, 0.76, 0.7, 1.0, 0.63, 0.58, 0.66, 0.61],
  [0.64, 0.58, 0.51, 0.63, 1.0, 0.72, 0.54, 0.49],
  [0.6, 0.63, 0.55, 0.58, 0.72, 1.0, 0.62, 0.66],
  [0.72, 0.76, 0.68, 0.66, 0.54, 0.62, 1.0, 0.74],
  [0.68, 0.73, 0.63, 0.61, 0.49, 0.66, 0.74, 1.0],
];

export function getCorrelationMatrix(timeframe: '7d' | '30d' | '90d'): number[][] {
  switch (timeframe) {
    case '7d':
      return CORR_MATRIX_7D;
    case '30d':
      return CORR_MATRIX_30D;
    case '90d':
      return CORR_MATRIX_90D;
  }
}

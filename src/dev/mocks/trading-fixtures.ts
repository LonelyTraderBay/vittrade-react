...
export const CRYPTO_PAIRS: CryptoPair[] = [
  {
    ...
    sparklineData: [
      65100, 65400, 65200, 65800, 66200, 65900, 66500, 67000, 66800, 67200, 67100, 67543,
    ],
    logoColor: '#F7931A',
    isFavorite: true,
    category: 'Layer 1',
  ...
  },
  {
    ...
    sparklineData: [0.438, 0.44, 0.442, 0.445, 0.448, 0.45, 0.452, 0.4521],
    logoColor: '#0033AD',
    isFavorite: false,
    category: 'Layer 1',
  },
  ...
  },
  {
    ...
    sparklineData: [0.85, 0.855, 0.862, 0.87, 0.875, 0.882, 0.89, 0.8976],
    logoColor: '#8247E5',
    isFavorite: false,
    category: 'Layer 2',
  },
  ...
  },
  {
    ...
    sparklineData: [15.1, 15.0, 14.85, 14.7, 14.55, 14.4, 14.3, 14.23],
    logoColor: '#2A5ADA',
    isFavorite: false,
    category: 'DeFi',
  },
...
export const P2P_ADS: P2PAd[] = [
  {
    ...
    remarks: 'Chuyển khoản nhanh trong 10 phút. Chỉ giao dịch với tài khoản đã KYC.',
    autoReply: 'Cảm ơn bạn đã tạo đơn! Vui lòng chuyển khoản theo thông tin bên dưới.',
    counterpartyRequirements: { minKycLevel: 1, minCompletedTrades: 0 },
  ...
  },
  {
    ...
    merchantLevel: 2,
    merchantVerified: true,
    merchantJoinDate: '2023-01-20',
    completionRate: 96.2,
    completedOrders: 567,
    totalVolume30d: 320000,
    price: 25380,
    currency: 'VND',
    priceType: 'floating',
    priceMargin: 0.12,
    ...
    remarks: 'Xác nhận trong 15 phút. Không nhận chuyển từ bên thứ 3.',
    counterpartyRequirements: { minCompletedTrades: 5, minRegisteredDays: 30 },
  ...
  },
  {
    ...
    merchantJoinDate: '2023-08-10',
    completionRate: 94.1,
    completedOrders: 234,
    totalVolume30d: 95000,
    price: 25400,
    currency: 'VND',
    priceType: 'fixed',
    minLimit: 200000,
  ...
  },
  {
    ...
    merchantLevel: 3,
    merchantVerified: true,
    merchantJoinDate: '2021-11-05',
    completionRate: 99.1,
    completedOrders: 3421,
    totalVolume30d: 2100000,
    price: 25280,
    currency: 'VND',
    priceType: 'fixed',
    minLimit: 2000000,
    ...
    isOnline: true,
    lastActive: 'Vừa xong',
    remarks: 'Top merchant VitTrade. Xác nhận siêu nhanh 24/7.',
    autoReply: 'Chào bạn! Tôi sẽ xác nhận ngay khi nhận tiền. Trung bình ~1 phút.',
    counterpartyRequirements: { minKycLevel: 2, minCompletedTrades: 10 },
    tradingHours: '24/7',
    createdAt: '2024-02-08 06:00:00',
    status: 'active',
    merchantRating: 4.9,
    merchantBadge: 'elite',
    viewerCount: 12,
  ...
  },
  {
    ...
    maxLimit: 50000000,
    available: 20000,
    paymentMethods: ['VietinBank', 'ZaloPay'],
    avgResponseTime: '3 phút',
    isOnline: true,
    lastActive: '5 phút trước',
    counterpartyRequirements: { minCompletedTrades: 3 },
    createdAt: '2024-02-11 09:00:00',
    status: 'active',
    merchantRating: 4.6,
    merchantBadge: 'pro',
    viewerCount: 5,
  ...
  },
  {
    ...
    merchantLevel: 3,
    merchantVerified: true,
    merchantJoinDate: '2022-01-10',
    completionRate: 99.5,
    completedOrders: 2156,
    totalVolume30d: 5200000,
    price: 1720000000,
    currency: 'VND',
    priceType: 'floating',
    priceMargin: 0.5,
    ...
    maxLimit: 500000000,
    available: 2.5,
    paymentMethods: ['Vietcombank', 'BIDV', 'Techcombank'],
    avgResponseTime: '2 phút',
    isOnline: true,
    lastActive: 'Vừa xong',
    remarks: 'Giao dịch BTC lớn. Escrow 100%. Xác nhận nhanh.',
    counterpartyRequirements: { minKycLevel: 2, minCompletedTrades: 20, minRegisteredDays: 60 },
    tradingHours: '24/7',
    createdAt: '2024-02-09 12:00:00',
    status: 'active',
    merchantRating: 4.9,
    merchantBadge: 'elite',
    viewerCount: 9,
  ...
  // ─── BNB Ads ───
  {
    ...
    merchantLevel: 2,
    merchantVerified: true,
    merchantJoinDate: '2023-02-10',
    completionRate: 97.8,
    completedOrders: 678,
    totalVolume30d: 420000,
    price: 15250000,
    currency: 'VND',
    priceType: 'fixed',
    minLimit: 1000000,
  ...
  },
  {
    ...
    maxLimit: 30000000,
    available: 20,
    paymentMethods: ['ZaloPay', 'Momo'],
    avgResponseTime: '10 phút',
    isOnline: false,
    lastActive: '1 giờ trước',
    createdAt: '2024-02-18 15:00:00',
    status: 'active',
    isNewMerchant: true,
    timeAgo: '1h trước',
  },
  // ─── SOL Ads ───
  {
    ...
    type: 'sell',
    asset: 'SOL',
    merchant: 'SolanaTrader_VN',
    merchantId: 'mc009',
    merchantLevel: 2,
    merchantVerified: true,
    merchantJoinDate: '2023-05-20',
    completionRate: 96.7,
    completedOrders: 445,
    totalVolume30d: 280000,
    price: 4850000,
    currency: 'VND',
    priceType: 'fixed',
    minLimit: 500000,
    maxLimit: 50000000,
    available: 120,
    paymentMethods: ['Techcombank', 'Momo', 'ZaloPay'],
  ...
  },
  {
    ...
    maxLimit: 80000000,
    available: 200,
    paymentMethods: ['VietinBank', 'Vietcombank'],
    avgResponseTime: '3 phút',
    isOnline: true,
    lastActive: '5 phút trước',
...
export const P2P_CHAT_MESSAGES: ChatMessage[] = [
  {
    id: 'cm1',
    sender: 'system',
    text: 'Đơn hàng #VT-P2P-20240221-001 đã được tạo. Vui lòng thanh toán trong 15 phút.',
    time: '11:00',
    type: 'system',
    isRead: true,
  },
...
export const P2P_DISPUTES: P2PDispute[] = [
  {
    ...
    supportMessages: [
      {
        sender: 'user',
        text: 'Tôi đã chuyển khoản xong nhưng seller không xác nhận. Đính kèm ảnh chụp giao dịch ngân hàng.',
        time: '08:50',
      },
      {
        sender: 'support',
        text: 'Chào bạn, chúng tôi đã nhận được khiếu nại. Đang liên hệ người bán để xác minh. Vui lòng chờ trong 24h.',
        time: '09:05',
      },
      {
        sender: 'support',
        text: 'Cập nhật: Người bán đã xác nhận nhận được tiền. Crypto sẽ được giải phóng trong 5 phút.',
        time: '10:30',
      },
    ],
  },
...
export const P2P_TRADING_LEVELS: P2PTradingLevel[] = [
  ...
  },
  {
    ...
    requirements: ['KYC Lv.2 (Selfie + Video)', '2FA đã bật', '50+ giao dịch hoàn tất'],
    color: '#8B5CF6',
  ...
  },
  {
    ...
    dailyLimit: 0,
    perOrderLimit: 0,
    requirements: ['KYC Lv.2', '2FA đã bật', 'Volume > 5 tỷ VND', '200+ giao dịch hoàn tất'],
    color: '#F59E0B',
...
export const P2P_AD_ANALYTICS: Record<string, P2PAdAnalytics> = {
  myad001: {
    ...
    ordersDisputed: 3,
    ordersCancelled: 12,
    totalVolume: 2_180_000_000,
    totalRevenue: 6_540_000,
    avgOrderValue: 7_956_204,
    avgResponseTime: 45,
  ...
  myad002: {
    ...
    avgOrderValue: 20_909_091,
    avgResponseTime: 52,
    avgCompletionTime: 9.1,
    conversionRate: 14.1,
    completionRate: 92.7,
    rating: 4.6,
    reviewsCount: 112,
...
export const P2P_MY_ADS: P2PAd[] = [
  {
    ...
    avgResponseTime: '5 phút',
    isOnline: true,
    remarks: 'Xác nhận nhanh trong giờ hành chính.',
  ...
  },
  {
    ...
    avgResponseTime: '5 phút',
    isOnline: true,
    counterpartyRequirements: { minKycLevel: 1, minCompletedTrades: 5 },
...
export const P2P_BLACKLIST: P2PBlacklistEntry[] = [
  ...
  },
  {
    ...
    username: 'SlowPay_VN',
    reason: 'unresponsive',
    reasonText: 'Không phản hồi tin nhắn sau khi tạo đơn, để đơn hết hạn 3 lần liên tiếp.',
  ...
  },
  {
    ...
    username: 'GhostBuyer',
    reason: 'other',
    reasonText: 'Tạo đơn liên tục rồi hủy, gây phiền hà và khóa crypto trong escrow.',
...
export const WITHDRAW_NETWORKS: Record<string, WithdrawNetwork[]> = {
  ...
  BTC: [{ id: 'btc', name: 'Bitcoin (BTC)', fee: 0.0005, minWithdraw: 0.001, maxWithdraw: 10 }],
  ETH: [{ id: 'erc20', name: 'ERC20 (Ethereum)', fee: 0.003, minWithdraw: 0.01, maxWithdraw: 100 }],
  BNB: [
  ...
  XRP: [
    {
      ...
      requiresMemo: true,
      memoLabel: 'Destination Tag',
      memoPlaceholder: 'Nhập Destination Tag (bắt buộc)',
    },
  ],
};
...
export const NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    ...
    message:
      'Bạn nhận 50 pts từ check-in hàng ngày và 120 pts từ khối lượng giao dịch. Tổng: +170 pts.',
    time: '5 giờ trước',
    isRead: true,
    icon: '⚡',
    iconColor: '#8B5CF6',
...
export const SUPPORT_TICKETS: SupportTicket[] = [
  {
    ...
    messages: [
      ...
      },
      {
        id: 'msg002',
        sender: 'support',
        text: 'Xin chào! Chúng tôi đang kiểm tra giao dịch của bạn. Vui lòng cung cấp mã giao dịch (TxID).',
        time: '08:15',
      },
    ],
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 'msg004',
        sender: 'support',
        text: 'Vui lòng thử reset mật khẩu qua email hoặc tắt 2FA nếu bạn mất thiết bị.',
        time: '16:30',
      },
      {
        id: 'msg005',
...
export const NEWS_ARTICLES: NewsArticle[] = [
  {
    ...
    content:
      'Chào mừng sự kiện đặc biệt! Từ ngày 23/02 đến 29/02, VitTrade miễn phí 100% phí giao dịch (maker + taker) cho cặp BTC/USDT. Đây là cơ hội tuyệt vời để các trader tối ưu lợi nhuận.\n\nĐiều kiện:\n- Áp dụng cho tất cả người dùng\n- Không giới hạn khối lượng giao dịch\n- Có hiệu lực từ 23/02 00:00 UTC+7\n\nHãy tận dụng cơ hội này!',
...
export const HELP_ARTICLES: HelpArticle[] = [
  {
    ...
    summary: 'Hướng dẫn đăng ký tài khoản từ A-Z, bao gồm xác minh email và thiết lập bảo mật.',
    views: 15420,
  },
  {
    id: 'h002',
    ...
    summary: 'Các bước nạp USDT, BTC, ETH vào tài khoản VitTrade một cách an toàn.',
    views: 12300,
  },
  {
    id: 'h003',
    ...
    summary: 'So sánh chi tiết giữa lệnh giới hạn và lệnh thị trường, khi nào nên dùng loại nào.',
    views: 23100,
  },
  {
    id: 'h004',
    ...
    summary: 'Hướng dẫn thiết lập cắt lỗ và chốt lời tự động để quản lý rủi ro.',
    views: 18900,
  },
  {
    id: 'h005',
    ...
    summary: 'Các nguyên nhân phổ biến khiến lệnh rút tiền chưa được xử lý và cách khắc phục.',
    views: 31200,
  },
  {
    id: 'h006',
  ...
  },
  {
    ...
    summary: 'Chi tiết phí maker/taker theo cấp VIP và cách giảm phí giao dịch.',
    views: 19400,
  },
];
...
export const REWARD_TASKS: RewardTask[] = [
  {
    ...
    description: 'Đăng nhập mỗi ngày để nhận thưởng',
    reward: '0.5 USDT',
    rewardType: 'token',
    progress: 1,
    maxProgress: 1,
  ...
  {
    id: 'task002',
    title: 'Giao dịch lần đầu',
    description: 'Thực hiện giao dịch đầu tiên trên VitTrade',
    reward: '5 USDT',
    rewardType: 'voucher',
    progress: 1,
    maxProgress: 1,
  ...
  {
    id: 'task003',
    title: 'Giao dịch 5 lệnh',
    description: 'Hoàn thành 5 lệnh giao dịch trong ngày',
    reward: '2 USDT',
    rewardType: 'token',
    progress: 3,
    maxProgress: 5,
  ...
  },
  {
    ...
    description: 'Nạp tối thiểu $100 vào tài khoản',
    reward: '10 USDT',
    rewardType: 'voucher',
    progress: 1,
    maxProgress: 1,
  ...
  },
  {
    id: 'task005',
    title: 'Mời bạn bè',
    description: 'Mời 3 bạn bè đăng ký VitTrade tuần này',
    reward: '15 USDT',
    rewardType: 'token',
    progress: 1,
    maxProgress: 3,
  ...
  },
  {
    id: 'task006',
    title: 'Bật 2FA',
    description: 'Kích hoạt xác thực 2 lớp cho tài khoản',
    reward: 'Badge Bảo mật',
    rewardType: 'badge',
    progress: 1,
    maxProgress: 1,
    status: 'claimed',
  ...
  },
  {
    id: 'task007',
    title: 'KYC Level 2',
    description: 'Hoàn tất xác minh danh tính cấp 2',
    reward: '20 USDT',
    rewardType: 'voucher',
    progress: 1,
    maxProgress: 1,
  ...
  },
  {
    ...
    description: 'Đạt khối lượng giao dịch $10,000 trong tuần',
    reward: 'Giảm 50% phí 7 ngày',
  ...
  {
    id: 'task010',
    title: 'Giao dịch P2P đầu tiên',
    description: 'Hoàn thành 1 giao dịch P2P',
    reward: '3 USDT',
    rewardType: 'voucher',
    progress: 1,
    maxProgress: 1,
...
export const SUB_ACCOUNTS: SubAccount[] = [
  ...
  },
  {
    ...
    balance: 32500.0,
    pnl30d: 8920.0,
    permissions: ['spot_trade', 'margin_trade', 'futures_trade', 'transfer', 'withdraw', 'read'],

...
export function generateOrderBook(chance: number): {
  bids: OrderBookEntry[];
  asks: OrderBookEntry[];
} {
  ...
  'pred-1': [
    {
      ...
      user: 'CryptoWhale',
      avatar: '🐋',
      text: 'BTC has strong momentum. The halving effect is kicking in. $150K is very possible.',
      time: '2h ago',
      likes: 42,
      position: 'Yes',
    },
    {
      ...
      user: 'BearishBob',
      avatar: '🐻',
      text: 'Too optimistic. Macro headwinds will cap the rally around $120K.',
      time: '5h ago',
      likes: 18,
      position: 'No',
    },
    {
      ...
      user: 'DeFiDegen',
      avatar: '🦊',
      text: 'Bought more Yes shares at $0.32. Risk/reward is insane here.',
      time: '8h ago',
      likes: 31,
      position: 'Yes',
    },
    {
      ...
      user: 'TechTrader',
      avatar: '📊',
      text: 'Volume spike suggests smart money is accumulating Yes positions.',
      time: '12h ago',
      likes: 27,
    },
    {
      ...
      user: 'HODLer',
      avatar: '💎',
      text: 'Long term bullish. Just a matter of time.',
      time: '1d ago',
      likes: 15,
      position: 'Yes',
    },
  ...
  'pred-2': [
    {
      ...
      user: 'RegWatch',
      avatar: '⚖️',
      text: 'SEC has been signaling approval. This is almost a done deal.',
      time: '3h ago',
      likes: 56,
      position: 'Yes',
    },
    {
      ...
      user: 'ETHMaxi',
      avatar: '🔷',
      text: 'ETH ETF will unlock massive institutional demand.',
      time: '6h ago',
      likes: 33,
      position: 'Yes',
    },
    {
      ...
      user: 'Skeptic99',
      avatar: '🤔',
      text: "Regulatory delays are common. Don't count your chickens.",
      time: '14h ago',
      likes: 11,
      position: 'No',
    },
  ...
  return [
    {
      ...
      user: 'Analyst_1',
      avatar: '📈',
      text: 'Interesting market. Watching closely for more data before taking a position.',
      time: '4h ago',
      likes: 8,
    },
    {
      ...
      user: 'MarketMaker',
      avatar: '🏦',
      text: 'Liquidity is improving. Good time to enter.',
      time: '1d ago',
      likes: 12,
    },
    {
      ...
      user: 'Predictor',
      avatar: '🎯',
      text: 'My model gives this a slightly higher probability than current market pricing.',
      time: '2d ago',
      likes: 5,
      position: 'Yes',
    },
...
export function getEventRules(event: PredictionEvent): EventRules {
  return {
    ...
    resolutionSource:
      event.category === 'Live Crypto'
        ? 'CoinGecko & CoinMarketCap (average)'
        : event.category === 'Politics'
          ? 'Official government data / Reuters'
          : event.category === 'Sports'
            ...
            : event.category === 'Finance'
              ...
              : event.category === 'AI'
                ...
                : event.category === 'Tech'
                  ? 'Official product launches / press releases'
...
export const PREDICTION_ORDER_STATUS_CONFIG: Record<
...
export const PREDICTION_ORDER_RECEIPTS: PredictionOrderReceipt[] = [
  {
    id: 'po-1',
    eventId: 'pred-1',
    eventTitle: 'BTC > $100K by March 2026?',
    outcome: 'Yes',
    side: 'buy',
    orderType: 'limit',
    shares: 200,
    ...
    timeline: [
      { label: 'Lệnh đã gửi', date: '27/02 08:00', done: true },
      { label: 'Tiếp nhận', date: '', done: false },
      { label: 'Khớp lệnh', date: '', done: false },
    ],
  },
  {
    id: 'po-2',
    eventId: 'pred-2',
    eventTitle: 'ETH Flips BTC Market Cap in 2026?',
    outcome: 'No',
    side: 'buy',
    orderType: 'limit',
    shares: 150,
    ...
    timeline: [
      { label: 'Lệnh đã gửi', date: '26/02 15:30', done: true },
      { label: 'Tiếp nhận', date: '26/02 15:30', done: true },
      { label: 'Khớp một phần (50/150)', date: '26/02 18:45', done: true },
      { label: 'Chờ khớp thêm', date: '', done: false },
    ],
  },
  {
    id: 'po-3',
    eventId: 'pred-7',
    eventTitle: 'Fed Rate Cut in March FOMC?',
    outcome: 'Yes',
    side: 'sell',
    orderType: 'limit',
    shares: 100,
    ...
    timeline: [
      { label: 'Lệnh đã gửi', date: '27/02 10:00', done: true },
      { label: 'Tiếp nhận', date: '', done: false },
      { label: 'Khớp lệnh', date: '', done: false },
    ],
  },
  {
    ...
    timeline: [
      { label: 'Lệnh đã gửi', date: '25/02 14:00', done: true },
      { label: 'Tiếp nhận', date: '25/02 14:00', done: true },
      { label: 'Đã khớp toàn bộ', date: '25/02 14:01', done: true },
    ],
  },
  {
    id: 'po-5',
    eventId: 'pred-5',
    eventTitle: 'Apple Vision Pro 2 Released Q1 2026?',
    outcome: 'No',
    side: 'buy',
    orderType: 'market',
    shares: 100,
    ...
    timeline: [
      { label: 'Lệnh đã gửi', date: '24/02 09:30', done: true },
      { label: 'Tiếp nhận', date: '24/02 09:30', done: true },
      { label: 'Đã khớp toàn bộ', date: '24/02 09:31', done: true },
    ],
  },
  {
    id: 'po-6',
    eventId: 'pred-3',
    eventTitle: 'Democrats Win Senate Majority in 2026?',
    outcome: 'Yes',
    side: 'buy',
    orderType: 'limit',
    shares: 80,
    ...
    timeline: [
      { label: 'Lệnh đã gửi', date: '23/02 12:00', done: true },
      { label: 'Tiếp nhận', date: '23/02 12:01', done: true },
      { label: 'Đã hủy bởi bạn', date: '24/02 08:00', done: true },
    ],
  },
];
